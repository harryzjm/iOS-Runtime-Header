...
- (struct NSDirectionalEdgeInsets)ib_decodeDirectionalEdgeInsetsForKey:(id)arg1;
- (void)ib_encodeDirectionalEdgeInsets:(struct NSDirectionalEdgeInsets)arg1 forKey:(id)arg2;
- (_Bool)ib_containsDirectionalEdgeInsetsForKey:(id)arg1;
@end
