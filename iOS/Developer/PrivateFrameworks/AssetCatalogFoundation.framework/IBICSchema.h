...
@class IBICIdiom, IBICMipmapLevel, IBICPlatform, IBICRole, IBMutableIdentityDictionary, NSMutableArray, NSMutableDictionary, NSMutableSet;
...
@interface IBICSchema : NSObject
{
    ...
    IBMutableIdentityDictionary *_suggestionSetRequiredSimDeviceTypeIdentifiers;
...
- (void)registerSystemCatalogColors:(id)arg1 forPlatform:(id)arg2;
- (id)systemCatalogColorWithName:(id)arg1 forPlatform:(id)arg2;
- (id)systemCatalogColorsForPlatform:(id)arg1;
...
- (id)suggestionSetGroupsForDisplayInSection:(id)arg1 withAvailableSimDeviceTypeIdentifiers:(id)arg2;
...
- (_Bool)shouldWriteStandaloneFileForAlternateAppIconSlot:(id)arg1;
- (void)registerSlotFilterForStandaloneAlternateAppIconFiles:(id)arg1;
