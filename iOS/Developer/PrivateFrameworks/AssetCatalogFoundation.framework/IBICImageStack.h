...
+ (long long)maximumNumberOfLayers;
+ (long long)minimumNumberOfLayers;
- (void).cxx_destruct;
...
- (id)cloneAndConsolidateForExportForcingIdiom:(id)arg1 forPlatform:(id)arg2 matchingVariant:(id)arg3;
- (_Bool)providesBookmarkTitleForChild:(id)arg1;
- (void)populateIssues:(id)arg1 context:(id)arg2;
- (void)populateBackgroundLayerIssues:(id)arg1 context:(id)arg2;
- (id)requiredSize;
