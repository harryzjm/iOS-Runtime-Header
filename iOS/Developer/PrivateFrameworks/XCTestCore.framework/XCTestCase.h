...
@interface XCTestCase <XCTWaiterDelegate, XCTActivity, XCTestCaseUIAutomationDelegate, XCTestCastMethodNamesUIAutomationDelegate, XCTestCaseDiscoveryUIAutomationDelegate>
{
...
- (void)waitForExpectations:(id)arg1 enforceOrder:(_Bool)arg2;
