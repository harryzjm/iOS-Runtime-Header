...
@property _Bool isTopCheckpoint; // @synthesize isTopCheckpoint=_isTopCheckpoint;
@property _Bool isCheckpoint; // @synthesize isCheckpoint=_isCheckpoint;
