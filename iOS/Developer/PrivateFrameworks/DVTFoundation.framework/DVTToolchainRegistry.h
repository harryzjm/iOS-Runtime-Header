...
+ (_Bool)registerToolchain:(id)arg1 identsToToolchains:(id)arg2 aliasesToToolchains:(id)arg3 appleApprovedPaths:(id)arg4 error:(id *)arg5;
+ (id)defaultRegistry;
- (void).cxx_destruct;
...
- (_Bool)isBuiltInToolchain:(id)arg1;
- (_Bool)verifyToolchain:(id)arg1 error:(id *)arg2;
