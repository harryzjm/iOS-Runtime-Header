...
@interface DVTPlugInManager : NSObject
{
    ...
    _Bool _shouldClearPlugInCaches;
...
+ (_Bool)enumerateExtensionDataForPluginAtPath:(id)arg1 error:(id *)arg2 withBlock:(CDUnknownBlockType)arg3;
+ (_Bool)ib_enumerateExtensionDataForPluginAtPath:(id)arg1 error:(id *)arg2 withBlock:(CDUnknownBlockType)arg3;
...
- (_Bool)_savePlugInCacheWithScanRecords:(id)arg1 error:(id *)arg2;
- (_Bool)_removePlugInCacheAndReturnError:(id *)arg1;
- (_Bool)_loadPlugInCache:(id *)arg1;
- (_Bool)_cacheCoversPlugInsWithScanRecords:(id)arg1;
...
- (_Bool)initializePlugIns:(id *)arg1;
- (void)_checkNonApplePlugIns;
- (_Bool)_allowNonApplePlugInsFromDescriptors:(id)arg1 error:(id *)arg2;
...
@property _Bool hasScannedForPlugIns; // @dynamic hasScannedForPlugIns;
