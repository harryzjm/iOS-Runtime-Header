...
{
    _Bool _includeGameCenterInPortalRequests;
    _Bool _requiresProxiedDevicesToBeRegistered;
    _Bool _requiresPortalAppGroups;
    _Bool _deprecatedRequiresLocalGameCenterEntitlement;
...
@property(readonly) _Bool deprecatedRequiresLocalGameCenterEntitlement; // @synthesize deprecatedRequiresLocalGameCenterEntitlement=_deprecatedRequiresLocalGameCenterEntitlement;
...
@property(readonly) _Bool includeGameCenterInPortalRequests; // @synthesize includeGameCenterInPortalRequests=_includeGameCenterInPortalRequests;
