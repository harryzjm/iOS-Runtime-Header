...
- (void)setCurvesInputValues:(id)arg1 ignoringIdentity:(_Bool)arg2 includingOptimizations:(_Bool)arg3 withAdditionalInfoPromise:(CDUnknownBlockType)arg4;
...
- (void)setValue:(id)arg1 forProperty:(id)arg2 ofFilter:(id)arg3 isCompositingFilter:(_Bool)arg4;
@end
