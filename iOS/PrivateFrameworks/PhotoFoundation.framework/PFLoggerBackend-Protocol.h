...
- (void)logFromCodeLocation:(CDStruct_98c8119d)arg1 facility:(NSString *)arg2 subsystem:(NSString *)arg3 level:(int)arg4 message:(NSString *)arg5 format:(NSString *)arg6 args:(char *)arg7;
@end
