...
@class NCBannerPresentationTransitionDelegate, NCNotificationPreviewInteractionManager, NCNotificationViewController, NSDate, NSHashTable, NSString, UITapGestureRecognizer, UIView, UIViewController;

@interface NCNotificationShortLookViewController <NCNotificationViewControllerObserving, NCNotificationPreviewInteractionManagerDelegate, NCBannerPresentationTransitioningDelegateObserver, NCLongLookPresentationControllerDelegate>
{
