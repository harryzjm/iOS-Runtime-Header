...
- (void)createRecalibrateEstimatesRequestRecordForSampleType:(id)arg1 effectiveDate:(id)arg2 handler:(CDUnknownBlockType)arg3;
- (void)handleObjectAuthorizationRequestsWithPromptHandler:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;
- (void)enqueueObjectAuthorizationRequestWithContext:(id)arg1 promptIfNeeded:(_Bool)arg2 authorizationNeededHandler:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
