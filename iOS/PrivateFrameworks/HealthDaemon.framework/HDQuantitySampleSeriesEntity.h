...
+ (_Bool)primitiveRemoveDatums:(id)arg1 HFDKey:(long long)arg2 deleteFromSQLite:(_Bool)arg3 transaction:(id)arg4 error:(id *)arg5;
+ (_Bool)deleteSeriesFromHFDWithKey:(long long)arg1 database:(id)arg2 error:(id *)arg3;
+ (_Bool)deleteSeriesFromSQLiteWithKey:(long long)arg1 database:(id)arg2 error:(id *)arg3;
...
+ (_Bool)primitiveInsertValues:(id)arg1 seriesVersion:(long long)arg2 HFDKey:(long long)arg3 insertToSQLite:(_Bool)arg4 database:(id)arg5 error:(id *)arg6;
...
- (id)seriesSourceWithDatabase:(id)arg1 error:(id *)arg2;
