...
- (_Bool)_insertExternalSyncMetadata:(id)arg1 forObjectID:(id)arg2 localSourceID:(id)arg3 externalSyncObjectCode:(long long)arg4 objectDeleted:(_Bool)arg5 error:(id *)arg6;
- (id)_ignoredInsertedMetadataKeys;
- (_Bool)_insertMetadata:(id)arg1 forObjectID:(id)arg2 database:(id)arg3 error:(id *)arg4;
- (_Bool)insertMetadata:(id)arg1 forObjectID:(id)arg2 localSourceID:(id)arg3 externalSyncObjectCode:(long long)arg4 objectDeleted:(_Bool)arg5 error:(id *)arg6;
