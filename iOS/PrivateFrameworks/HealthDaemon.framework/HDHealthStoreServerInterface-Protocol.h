...
- (void)remote_unregisterKeepAliveWithIdentifier:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
- (void)remote_registerKeepAliveWithIdentifier:(NSString *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)remote_discardWorkoutRoute:(HKWorkoutRoute *)arg1 completion:(void (^)(_Bool, NSError *))arg2;
...
- (void)remote_saveWorkoutRouteData:(NSArray *)arg1 withRoute:(HKWorkoutRoute *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
...
- (void)remote_setAuthorizationStatuses:(NSDictionary *)arg1 forBundleIdentifier:(NSString *)arg2 completion:(void (^)(_Bool, NSError *))arg3;
