...
- (id)localGeneralPasteboardWithAuthenticationBlock:(CDUnknownBlockType)arg1 dataOwnerBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;
- (id)pasteboardWithName:(id)arg1 createIfNeeded:(_Bool)arg2 authenticationBlock:(CDUnknownBlockType)arg3 dataOwnerBlock:(CDUnknownBlockType)arg4 error:(id *)arg5;
...
- (void)requestItemFromPasteboardWithName:(id)arg1 UUID:(id)arg2 authenticationMessage:(id)arg3 itemIndex:(unsigned long long)arg4 typeIdentifier:(id)arg5 dataOwner:(long long)arg6 completionBlock:(CDUnknownBlockType)arg7;
- (void)savePasteboard:(id)arg1 dataProviderEndpoint:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)localGeneralPasteboardWithAuthenticationBlock:(CDUnknownBlockType)arg1 dataOwnerBlock:(CDUnknownBlockType)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)pasteboardWithName:(id)arg1 createIfNeeded:(_Bool)arg2 authenticationBlock:(CDUnknownBlockType)arg3 dataOwnerBlock:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;
