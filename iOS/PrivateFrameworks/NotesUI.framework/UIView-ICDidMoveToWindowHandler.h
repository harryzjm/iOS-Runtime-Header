...
- (void)ic_addDidMoveToWindowHandler:(CDUnknownBlockType)arg1;
- (id)ic_animator;
- (id)ic_renderImageView;
- (id)ic_renderImage;
- (void)ic_addConstraintsToFillSuperview;
- (void)ic_addAnchorsToFillSuperviewLayoutMargins;
- (void)ic_addAnchorsToFillSuperviewWithLeadingPadding:(double)arg1 trailingPadding:(double)arg2 topPadding:(double)arg3 bottomPadding:(double)arg4 usesSafeAreaLayoutGuideHorizontally:(_Bool)arg5 usesSafeAreaLayoutGuideVertically:(_Bool)arg6;
- (void)ic_addAnchorsToFillSuperviewWithPaddingFromDirectionalEdgeInsets:(struct NSDirectionalEdgeInsets)arg1 usesSafeAreaLayoutGuideHorizontally:(_Bool)arg2 usesSafeAreaLayoutGuideVertically:(_Bool)arg3;
- (void)ic_addAnchorsToFillSuperviewWithPaddingFromDirectionalEdgeInsets:(struct NSDirectionalEdgeInsets)arg1;
...
- (void)ic_applyShadowWithRadius:(double)arg1 opacity:(double)arg2 offset:(struct CGSize)arg3 shadowPathIsBounds:(_Bool)arg4;
