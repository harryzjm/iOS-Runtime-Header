...
- (id)predictionFromInput_mask:(id)arg1 sequence_output:(id)arg2 error:(id *)arg3;
- (void)predictionFromFeatures:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)predictionFromFeatures:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
