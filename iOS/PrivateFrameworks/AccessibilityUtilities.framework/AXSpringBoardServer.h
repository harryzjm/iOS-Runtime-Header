...
- (_Bool)isNonExclusiveSystemUIFocusableIncludingPIPWindow:(_Bool)arg1 includingNonDismissableElements:(_Bool)arg2;
...
- (_Bool)isStatusBarNativeFocusableIncludingNonDismissableElements:(_Bool)arg1;
