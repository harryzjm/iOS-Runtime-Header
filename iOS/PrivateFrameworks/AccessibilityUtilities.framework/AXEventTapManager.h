...
- (id)installEventTap:(CDUnknownBlockType)arg1 identifier:(id)arg2 type:(int)arg3 skipDeviceMatching:(_Bool)arg4 wantsDigitizerEvents:(_Bool)arg5 wantsKeyboardEvents:(_Bool)arg6 wantsATVRemoteEvents:(_Bool)arg7 wantsLisaEvents:(_Bool)arg8 wantsMouseEvents:(_Bool)arg9 wantsAccessibilityEvents:(_Bool)arg10 matchingServiceHandler:(CDUnknownBlockType)arg11;
- (id)installEventTap:(CDUnknownBlockType)arg1 identifier:(id)arg2 type:(int)arg3 skipDeviceMatching:(_Bool)arg4 wantsDigitizerEvents:(_Bool)arg5 wantsKeyboardEvents:(_Bool)arg6 wantsATVRemoteEvents:(_Bool)arg7 wantsLisaEvents:(_Bool)arg8 wantsMouseEvents:(_Bool)arg9 wantsAccessibilityEvents:(_Bool)arg10;
- (id)installEventTap:(CDUnknownBlockType)arg1 identifier:(id)arg2 type:(int)arg3;
- (void)_installSystemEventTap:(id)arg1;
- (void)_installHIDFilter:(id)arg1 skipDeviceMatching:(_Bool)arg2 wantsDigitizerEvents:(_Bool)arg3 wantsKeyboardEvents:(_Bool)arg4 wantsATVRemoteEvents:(_Bool)arg5 wantsLisaEvents:(_Bool)arg6 wantsMouseEvents:(_Bool)arg7 wantsAccessibilityEvents:(_Bool)arg8;
- (id)_hidFilterListForPair:(id)arg1 wantsDigitizerEvents:(_Bool)arg2 wantsKeyboardEvents:(_Bool)arg3 wantsATVRemoteEvents:(_Bool)arg4 wantsLisaEvents:(_Bool)arg5 wantsMouseEvents:(_Bool)arg6 wantsAccessibilityEvents:(_Bool)arg7;
- (void)_installEventTap:(id)arg1 skipDeviceMatching:(_Bool)arg2 wantsDigitizerEvents:(_Bool)arg3 wantsKeyboardEvents:(_Bool)arg4 wantsATVRemoteEvents:(_Bool)arg5 wantsLisaEvents:(_Bool)arg6 wantsMouseEvents:(_Bool)arg7 wantsAccessibilityEvents:(_Bool)arg8;
