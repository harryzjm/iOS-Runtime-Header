...
@interface VKMapView : CALayer
{
    ...
    struct unique_ptr<md::MapEngine, std::default_delete<md::MapEngine>> _mapEngine;
    _Bool _didFinishSnapshotting;
    int _flyoverMode;
    MDARController *_arController;
    GEOPOICategoryFilter *_pointsOfInterestFilter;
    _Bool _compressedBuildingsEnabled;
...
- (void)muninJunctionDidChange:(const void *)arg1 currentRoad:(const void *)arg2 localize:(_Bool)arg3;
...
- (id)rapMarkerAtPoint:(struct CGPoint)arg1;
...
- (id)initShouldRasterize:(_Bool)arg1 inBackground:(_Bool)arg2 contentScale:(double)arg3 auditToken:(id)arg4 mapViewPurpose:(long long)arg5;
...
- (void)_applyMapDisplayStyle:(CDStruct_80aa614a)arg1 animated:(_Bool)arg2 duration:(double)arg3;
...
- (void)setModernMapEnabled:(_Bool)arg1;
...
- (void)enableMapDisplayStyleDebugOverride:(CDStruct_80aa614a)arg1;
...
- (void)setEmphasis:(unsigned char)arg1 animated:(_Bool)arg2;
...
- (unordered_map_49c2a10b)clientStyleAttributes;
