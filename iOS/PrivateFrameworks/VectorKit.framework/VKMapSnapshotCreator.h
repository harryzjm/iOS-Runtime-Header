...
@interface VKMapSnapshotCreator : NSObject <MapEngineDelegate, VKNotificationObserverDelegate>
{
    ...
    struct vector<CGImage *, std::allocator<CGImage *>> _images;
    struct vector<__IOSurface *, std::allocator<__IOSurface *>> _ioSurfaces;
    struct Stopwatch _timer;
...
- (void)softDealloc;
- (void)dealloc;
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 homeQueue:(id)arg3 signpostId:(unsigned long long)arg4 mapType:(int)arg5 mapDisplayStyles:(CDStruct_80aa614a *)arg6 mapDisplayStylesCount:(unsigned long long)arg7 auditToken:(id)arg8;
