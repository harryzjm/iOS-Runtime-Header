...
@class LPCaptionBarAccessoryView, LPCaptionBarPresentationProperties, LPCaptionBarStyle, LPComponentView, LPImageView, LPVerticalTextStackView, LPiTunesPlayButtonView, LPiTunesPlaybackInformation, NSString, UIView;
