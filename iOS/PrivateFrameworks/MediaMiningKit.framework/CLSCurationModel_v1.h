...
- (_Bool)imageAssetIsJunkForMemoriesFromSceneAndJunkClassifications:(id)arg1 forKeyAsset:(_Bool)arg2 forMemories:(_Bool)arg3;
...
- (_Bool)avoidIfPossibleForMemoryKeyAssetWithAsset:(id)arg1;
