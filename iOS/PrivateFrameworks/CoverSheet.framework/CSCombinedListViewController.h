...
@interface CSCombinedListViewController <CSNotificationAdjunctListViewControllerDelegate, SBFMotionGestureObserver, NCNotificationStructuredListContentObserver, CSStatusBarBackgroundIntersecting, PTSettingsKeyObserver, CSHomeGestureParticipating, CSDNDBedtimeControllerObserver, DNDStateUpdateListener, CSDNDBedtimeGreetingDelegate, CSApplicationInformationObserving, NCNotificationStructuredListViewControllerDelegate, SBUICoronaAnimationControllerParticipant, _UIGestureStudyInteractionDelegate, CSProximitySensorProviderObserver, CSNotificationDestination, CSDateViewScrolling, CSAppearanceProviding>
{
    ...
    _Bool _showingFocusActivityView;
    ...
    id <CSScrollablePageViewControllerProtocol> _scrollablePage;
...
- (void)_setHasUserInteraction:(_Bool)arg1 forReason:(id)arg2;
...
- (void)_updateProudLockForHidden:(_Bool)arg1 scrollOffset:(double)arg2;
...
- (void)notificationStructuredListViewController:(id)arg1 setSystemScheduledDeliveryEnabled:(_Bool)arg2 scheduledDeliveryTimes:(id)arg3;
- (void)notificationStructuredListViewController:(id)arg1 setScheduledDelivery:(_Bool)arg2 forSectionIdentifier:(id)arg3;
- (void)notificationStructuredListViewController:(id)arg1 setAllowsDirectMessages:(_Bool)arg2 forSectionIdentifier:(id)arg3;
- (void)notificationStructuredListViewController:(id)arg1 setAllowsTimeSensitive:(_Bool)arg2 forSectionIdentifier:(id)arg3;
- (void)notificationStructuredListViewController:(id)arg1 setAllowsCriticalAlerts:(_Bool)arg2 forSectionIdentifier:(id)arg3;
- (void)notificationStructuredListViewController:(id)arg1 setMuted:(_Bool)arg2 untilDate:(id)arg3 forSectionIdentifier:(id)arg4 threadIdentifier:(id)arg5;
...
- (_Bool)_hasExperiencedSignificantScrollingOnScrollView:(id)arg1;
- (void)_updateHidingQuickActionsForSignificantScrolling:(_Bool)arg1;
