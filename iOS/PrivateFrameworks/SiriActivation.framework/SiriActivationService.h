...
- (_Bool)_shouldEyesFreeCancelScreenWakeForRequestOptions:(id)arg1;
...
- (void)activationRequestFromDirectActionEventWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (_Bool)_shouldRejectActivationWithButtonIdentifier:(long long)arg1 activationAssertions:(id)arg2;
