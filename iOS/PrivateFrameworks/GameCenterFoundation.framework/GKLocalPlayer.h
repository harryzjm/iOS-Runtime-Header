...
@interface GKLocalPlayer <NSCoding, NSSecureCoding, GKSavedGameListener>
{
    ...
    _Bool _isShowingFriendRequestUI;
...
+ (void)loadHighlightsDataWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void).cxx_destruct;
...
- (oneway void)rejectFriendRequestWithIdentifier:(id)arg1 handler:(CDUnknownBlockType)arg2;
- (void)acceptFriendRequestWithIdentifier:(id)arg1 sendPush:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;
