...
#import <CorePommes/CPTopHitSearchQueryShim.h>

#import <Email/EMTopHitSearchQueryable-Protocol.h>

@class NSArray, NSString;

@interface CPTopHitSearchQueryShim (TopHitSearchQueryable) <EMTopHitSearchQueryable>
