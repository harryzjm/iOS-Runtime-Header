...
- (id)initWithTitle:(id)arg1 primaryColors:(id)arg2 extendedColors:(id)arg3 identifier:(id)arg4 alwaysShowExtended:(_Bool)arg5 colorCategory:(long long)arg6 destination:(long long)arg7 pairing:(id)arg8 options:(id)arg9;
- (id)initWithTitle:(id)arg1 primaryColors:(id)arg2 extendedColors:(id)arg3 alwaysShowExtended:(_Bool)arg4 colorCategory:(long long)arg5 destination:(long long)arg6 pairing:(id)arg7 options:(id)arg8;
