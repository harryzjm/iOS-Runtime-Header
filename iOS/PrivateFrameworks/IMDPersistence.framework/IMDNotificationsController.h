...
+ (_Bool)isSpamFilteringOn;
+ (_Bool)isUnknownSenderFilteringOn;
...
- (id)_synthesizedMessagingNotificationContentWithContent:(id)arg1 chatDictionary:(id)arg2 messageDictionary:(id)arg3 isUrgentMessage:(_Bool)arg4;
...
- (_Bool)_shouldRepostNotification:(id)arg1 withAlreadyPostedNotification:(id)arg2;
...
- (id)allTokens;
- (_Bool)_isUnknownSenders:(id)arg1;
- (_Bool)_shouldPostNotificationForChat:(id)arg1 messageDictionary:(id)arg2;
- (_Bool)_chatHasCategoryMuted:(id)arg1 isFromContact:(_Bool)arg2;
...
- (unsigned long long)_getMessagesSpokenAllowlistLevel:(_Bool *)arg1;
...
- (_Bool)_handleIsSpokenMessageAllowlisted:(struct _IMDHandleRecordStruct *)arg1 chat:(id)arg2 message:(id)arg3;
