...
@interface WFEditableLibraryViewController <UIGestureRecognizerDelegate, UICollectionViewDragDelegate, UICollectionViewDropDelegate, WFEditableLibraryResultsControllerDelegate>
{
