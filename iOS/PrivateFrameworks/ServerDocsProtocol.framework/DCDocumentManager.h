...
#import <ServerDocsProtocol/DCConnectivityTrackerDelegate-Protocol.h>
#import <ServerDocsProtocol/DCDocumentManager-Protocol.h>

@class DCConnectivityTracker, DCService, NSDictionary, NSMutableDictionary, SDFDispatchQueue;
