...
{
    _Bool _wasConsumedForAppPrediction;
    NSString *_text;
...
@property(nonatomic) _Bool wasConsumedForAppPrediction; // @synthesize wasConsumedForAppPrediction=_wasConsumedForAppPrediction;
