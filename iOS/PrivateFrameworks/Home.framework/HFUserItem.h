...
- (id)setDismissAccessoryFirmwareUpdateOnboarding:(_Bool)arg1;
- (_Bool)hasDismissedAccessoryFirmwareUpdateOnboarding;
- (id)setDismissAccessCodeOnboarding:(_Bool)arg1;
- (_Bool)hasDismissedAccessCodeOnboarding;
- (id)setDismissWalletKeyExpressModeOnboarding:(_Bool)arg1 forWalletKeyUUID:(id)arg2;
- (id)hasDismissedWalletKeyExpressModeOnboardingOnThisDevice;
- (_Bool)_hasDismissedWalletKeyExpressModeOnboarding;
