...
- (void)dispatchWalletKeyDeviceStateObserverMessage:(CDUnknownBlockType)arg1 sender:(id)arg2;
...
- (void)dispatchSiriEndpointObserverMessage:(CDUnknownBlockType)arg1 sender:(id)arg2;
