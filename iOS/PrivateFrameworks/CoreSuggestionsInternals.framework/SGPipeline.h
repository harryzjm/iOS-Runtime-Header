...
- (void)dissectAndStoreEntity:(id)arg1 inContext:(id)arg2 destinationStore:(id)arg3 isReprocessing:(_Bool)arg4;
...
- (id)storeOperation:(id)arg1 spotlightBundleIdentifier:(id)arg2 spotlightUniqueIdentifier:(id)arg3 spotlightDomainIdentifier:(id)arg4 withStore:(id)arg5 dependencies:(id)arg6 isReprocessing:(_Bool)arg7 originalEnrichmentCount:(unsigned long long)arg8;
...
- (id)storeOperation:(id)arg1 withStore:(id)arg2 dependencies:(id)arg3 isReprocessing:(_Bool)arg4 originalEnrichmentCount:(unsigned long long)arg5;
