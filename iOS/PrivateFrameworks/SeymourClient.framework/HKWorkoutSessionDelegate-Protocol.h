...
@class HKWorkoutConfiguration, HKWorkoutEvent, HKWorkoutSession, NSData, NSDate, NSError;
...
- (void)workoutSession:(HKWorkoutSession *)arg1 didReceiveDataFromRemoteDevice:(NSData *)arg2;
