...
@class NSData, NSError, NSMutableDictionary, NSString, NSURL;
...
@optional
- (void)requestSilentMAIDAuthenticationWithAuthenticationResults:(NSMutableDictionary *)arg1 personaID:(NSString *)arg2 completionHandler:(void (^)(NSMutableDictionary *, _Bool, NSError *))arg3;
...
- (void)requestMAIDSignInWithAuthenticationResults:(NSMutableDictionary *)arg1 personaID:(NSString *)arg2 completionHandler:(void (^)(_Bool, _Bool, NSError *))arg3;
