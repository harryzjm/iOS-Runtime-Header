...
- (void)_forceWindowSceneEvent:(_Bool)arg1;
...
- (id)playerPublisher;
- (void)_handleIsDisplayingClosedCaptionsDidChange:(_Bool)arg1 player:(id)arg2;
- (void)_handlePlayerCurrentItemDidChangeForPlayer:(id)arg1;
- (void)_handleNonForcedSubtitleDisplayDidChange:(_Bool)arg1 player:(id)arg2;
