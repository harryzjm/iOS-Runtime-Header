...
@class NSArray, WBBrowserState, WBTab, WBTabGroup, WBWindowState;
...
- (void)moveTab:(WBTab *)arg1 toTabGroup:(WBTabGroup *)arg2 afterTab:(WBTab *)arg3 completionHandler:(void (^)(_Bool, NSError *))arg4;
