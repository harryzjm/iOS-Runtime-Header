...
@interface SBFolder : NSObject <SBFolderObserver, SBTreeNode, SBIconIndexNode, SBIconIndexMutableListObserver, SBIconListModelObserver, SBIconListModelDelegate, BSDescriptionProviding>
{
    ...
    _Bool _listsAllowRotatedLayout;
    _Bool _containsNonDefaultSizedIcon;
    _Bool _containsVisibleNonDefaultSizedIcon;
    struct SBHIconGridSize _listGridSize;
    struct SBHIconGridSize _listWithNonDefaultSizedIconsGridSize;
...
- (_Bool)iconListModel:(id)arg1 isGridLayoutValid:(id)arg2;
...
- (id)changeGridSizeOfList:(id)arg1 toGridSize:(struct SBHIconGridSize)arg2 options:(unsigned long long)arg3;
- (id)changeGridSizeOfListAtIndex:(unsigned long long)arg1 toGridSize:(struct SBHIconGridSize)arg2 options:(unsigned long long)arg3;
...
- (id)indexPathsForIconsWithOptions:(unsigned long long)arg1 passingTest:(CDUnknownBlockType)arg2;
...
- (_Bool)containsWidgetWithExtensionBundleIdentifier:(id)arg1;
...
- (id)gridPathForFirstFreeSlotOfRangeOfSizeClass:(unsigned long long)arg1 startingAtList:(id)arg2 avoidingFirstList:(_Bool)arg3 searchForwards:(_Bool)arg4 listGridCellInfoOptions:(unsigned long long)arg5;
- (id)gridPathForLastFreeSlotStartingAtList:(id)arg1 avoidingFirstList:(_Bool)arg2 listGridCellInfoOptions:(unsigned long long)arg3;
- (id)gridPathForLastFreeSlotAvoidingFirstList:(_Bool)arg1 listGridCellInfoOptions:(unsigned long long)arg2;
- (id)gridPathForFirstFreeSlotStartingAtList:(id)arg1 avoidingFirstList:(_Bool)arg2 listGridCellInfoOptions:(unsigned long long)arg3;
- (id)gridPathForFirstFreeSlotOfRangeOfSizeClass:(unsigned long long)arg1 avoidingFirstList:(_Bool)arg2 listGridCellInfoOptions:(unsigned long long)arg3;
- (id)gridPathForFirstFreeSlotAvoidingFirstList:(_Bool)arg1 listGridCellInfoOptions:(unsigned long long)arg2;
- (void)enumerateListsForSearchingForFirstFreeSlotStartingAtList:(id)arg1 avoidingFirstList:(_Bool)arg2 searchForwards:(_Bool)arg3 block:(CDUnknownBlockType)arg4;
- (id)sortedGridPaths:(id)arg1;
- (id)sortedAndBucketedGridPaths:(id)arg1;
- (id)validatedGridPathForInsertionGridPath:(id)arg1 avoidingFirstList:(_Bool)arg2;
...
- (_Bool)replaceIcon:(id)arg1 withIcon:(id)arg2 options:(unsigned long long)arg3;
- (_Bool)replaceIcon:(id)arg1 withIcon:(id)arg2;
...
- (void)removeAllLists;
- (void)enumerateVisibleListsUsingBlock:(CDUnknownBlockType)arg1;
...
- (_Bool)isExtraListIndex:(unsigned long long)arg1;
...
- (void)_willRemoveList:(id)arg1 atIndex:(unsigned long long)arg2 informObservers:(_Bool)arg3;
...
- (void)compactOverflowListsWithoutMovingIconsPassingTest:(CDUnknownBlockType)arg1 removeEmptyLists:(_Bool)arg2;
- (void)compactOverflowListsWithoutMovingIconsPassingTest:(CDUnknownBlockType)arg1;
- (void)compactOverflowListsAndRemoveEmptyLists:(_Bool)arg1;
