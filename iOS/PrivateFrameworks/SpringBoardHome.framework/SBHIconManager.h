...
@class ATXDefaultWidgetSuggesterClient, BSEventQueue, CHSAvocadoDescriptorProvider, NSArray, NSCountedSet, NSHashTable, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSSet, NSString, NSTimer, SBFParallaxSettings, SBFloatingDockViewController, SBFolder, SBFolderController, SBFolderIcon, SBFolderIconImageCache, SBHFocusMode, SBHHomeScreenSettings, SBHHomeScreenUsageMonitor, SBHIconImageCache, SBHIconModel, SBHLibraryViewController, SBHMultiplexingManager, SBHPeopleWidgetPersonDetailInteraction, SBHRootFolderSettings, SBHWidgetIntroductionSettings, SBHWidgetMetricsProvider, SBHomeScreenDefaults, SBHomeScreenIconTransitionAnimator, SBIcon, SBIconDragManager, SBIconLabelImageCache, SBIconListView, SBIconPageIndicatorImageSetCache, SBIconPreviousLocationTracker, SBIconView, SBReusableViewMap, SBRootFolder, SBRootFolderController, SBSearchGesture, SBWorkspaceInteractionContext, UIImpactFeedbackGenerator, UIViewController, _UILegibilitySettings;
...
@interface SBHIconManager : NSObject <UIPopoverPresentationControllerDelegate, SBReusableViewMapDelegate, SBRootFolderPageStateObserver, SBNestingViewControllerDelegate, SBHIconModelDelegate, PTSettingsKeyObserver, SBRootFolderDelegate, SBIconViewObserver, SBHWidgetStackViewControllerDataSource, SBHWidgetStackViewControllerDelegate, SBHMultiplexingWrapperViewControllerDelegate, SBLeafIconObserver, CHUISAvocadoHostViewControllerDelegate, SBHWidgetMetricsProviderDelegate, CHSAvocadoDescriptorProviderObserver, SBHMultiplexingManagerDelegate, SBIconDragManagerDelegate, SBHTodayViewControllerObserver, SBHModalInteractionDelegate, SBFolderObserver, SBIconViewDelegate, SBIconViewQuerying, SBHomeScreenIconTransitionAnimatorDelegate, SBIconViewProviding, SBRootFolderControllerDelegate, SBIconLocationPresenting, SBHLibraryViewControllerObserver>
{
    ...
    _Bool _canPresentOverscrollLibraryForPageTransition;
    _Bool _canUndoWidgetIntroductionWidgets;
    _Bool _stopUpdatingDefaultWidgetsBumpedIconRecord;
    _Bool _isVerticalWidgetIntroduction;
    _Bool _forceShowWidgetIntroduction;
    ...
    NSMutableArray *_activeProactiveSuggestedIcons;
...
@property(retain, nonatomic) NSMutableArray *activeProactiveSuggestedIcons; // @synthesize activeProactiveSuggestedIcons=_activeProactiveSuggestedIcons;
...
@property(nonatomic) _Bool canUndoWidgetIntroductionWidgets; // @synthesize canUndoWidgetIntroductionWidgets=_canUndoWidgetIntroductionWidgets;
...
- (void)updatePronouncedContainerViewVisibility:(_Bool)arg1 vertical:(_Bool)arg2;
- (void)undoDefaultTVWidget;
- (void)undoDefaultWidgets;
- (void)resetDefaultWidgetsUndoInfo;
- (_Bool)addDefaultSecondPageWidgetsToHomeScreen:(_Bool)arg1;
- (_Bool)addDefaultFirstPageWidgetsToHomeScreen:(_Bool)arg1;
- (void)displayPronouncedContainerViewVisibility:(_Bool)arg1 isVertical:(_Bool)arg2;
...
- (id)defaultSecondPageWidgetIcons;
- (void)prototypeSetDefaultSecondPageWidgetIcons;
- (id)defaultFirstPageWidgetIcons;
...
- (void)todayViewController:(id)arg1 occlusionDidChange:(_Bool)arg2;
- (void)todayViewController:(id)arg1 occlusionWillChange:(_Bool)arg2;
...
- (void)_updateOverscrollModalLibraryForScrollToPresented:(_Bool)arg1;
...
- (_Bool)rootFolder:(id)arg1 isGridLayoutValid:(id)arg2 forIconList:(id)arg3 inFolder:(id)arg4;
...
- (_Bool)iconModel:(id)arg1 shouldRemoveIcon:(id)arg2;
...
- (_Bool)iconModel:(id)arg1 listsAllowRotatedLayoutForFolderClass:(Class)arg2;
...
- (struct SBHIconGridSize)iconModel:(id)arg1 listWithNonDefaultSizedIconsGridSizeForFolderClass:(Class)arg2;
...
- (_Bool)rootFolderControllerDidSetPrototypeSettingEditAsUndo:(id)arg1;
...
- (void)rootFolderController:(id)arg1 handleInsertionForWidgetIcon:(id)arg2 withReferenceIconView:(id)arg3 fromPresenter:(id)arg4 dismissViewControllerHandler:(CDUnknownBlockType)arg5;
...
- (void)rootFolderController:(id)arg1 wantsToAdjustLeadingCustomContentForEdgeBounceForScrollOffset:(struct CGPoint)arg2;
...
- (_Bool)_determineIfAvocadoHostViewControllerIsVisible:(id)arg1 withinStackViewController:(id)arg2;
- (_Bool)_determineIfAvocadoHostViewControllerIsVisible:(id)arg1;
...
- (_Bool)widgetViewControllerShouldTransitionSceneToBackground:(id)arg1;
...
- (id)_archivedIntentForDataSource:(id)arg1 inIcon:(id)arg2 loadingIfNecessary:(_Bool)arg3;
...
- (_Bool)presentHomeScreenIconsAnimated:(_Bool)arg1;
- (_Bool)dismissSpotlightOrLeadingCustomViewAnimated:(_Bool)arg1;
...
- (void)presentLeadingCustomViewWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)addIcons:(id)arg1 intoFolderIcon:(id)arg2 openFolderOnFinish:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (_Bool)iconDragManager:(id)arg1 shouldDuplicateIconsInDragSession:(id)arg2;
...
- (_Bool)isAnimatingFolderIconTransitionForIconDragManager:(id)arg1;
- (_Bool)allowsNestedFoldersForIconDragManager:(id)arg1;
...
- (_Bool)iconDragManager:(id)arg1 canAcceptDropInSession:(id)arg2 inIconListView:(id)arg3;
- (_Bool)iconDragManager:(id)arg1 canAddDragItemsToSession:(id)arg2 fromIconView:(id)arg3;
- (_Bool)iconDragManager:(id)arg1 canBeginDragForIconView:(id)arg2;
...
- (_Bool)iconDragManagerCanBeginIconDrags:(id)arg1;
- (void)cancelAllDrags;
...
- (void)addDebugIconOfSizeClass:(unsigned long long)arg1 toPage:(unsigned long long)arg2 coordinate:(struct SBIconCoordinate)arg3 orientation:(long long)arg4;
- (void)addDebugIconOfSizeClass:(unsigned long long)arg1 toPage:(unsigned long long)arg2 coordinate:(struct SBIconCoordinate)arg3;
...
- (_Bool)shouldRootFolderControllerBeOccluded;
...
- (_Bool)_shouldLibraryOverlayAllowSwipeToDismissGesture;
...
- (void)replaceApplicationPlaceholderWithApplication:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
