...
@interface SBHAddWidgetSheetViewControllerBase : UIViewController
{
    ...
    struct SBHWidgetFilteringParameters _allowedWidgets;
}
...
- (id)initWithListLayoutProvider:(id)arg1 iconViewProvider:(id)arg2 allowedWidgets:(struct SBHWidgetFilteringParameters)arg3 appCellIconImageCache:(id)arg4;
