...
- (void)layoutSubviews;
- (id)initWithDevice:(id)arg1 dial:(unsigned long long)arg2 style:(unsigned long long)arg3 colorPalette:(id)arg4 date:(id)arg5 useSmallFont:(_Bool)arg6 circularLogoImage:(id)arg7;
