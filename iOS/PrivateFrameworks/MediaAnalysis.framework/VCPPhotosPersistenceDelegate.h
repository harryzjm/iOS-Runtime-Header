...
- (_Bool)removeAutoAssignedFacesFromVerifiedPersonsAndPrepareForPersonBuilding:(id)arg1 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;
...
- (void)buildPersonWithFaceClusterer:(id)arg1 keyFaceUpdateBlock:(CDUnknownBlockType)arg2 context:(id)arg3 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg4;
- (void)_buildPersonsFromUpdatedFaceGroups:(id)arg1 faceClusterer:(id)arg2 keyFaceUpdateBlock:(CDUnknownBlockType)arg3 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg4 context:(id)arg5;
- (void)_dedupeFaceCropsForFaceGroups:(id)arg1 withCancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2;
- (void)_checkRejectedFaceCropsForFaceGroups:(id)arg1 withCancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2;
...
- (_Bool)_completePersonBuildingWithPersonsToUpdate:(id)arg1 facesToRemoveByPerson:(id)arg2 facesToAddByPerson:(id)arg3 updateFaceGroup:(id)arg4 newMergeCandidatePairs:(id)arg5 newInvalidMergeCandidatePairs:(id)arg6 faceInFaceGroupByCSN:(id)arg7 personCache:(id)arg8 keyFaceUpdateBlock:(CDUnknownBlockType)arg9 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg10 context:(id)arg11 error:(id *)arg12;
...
- (id)_updatedFaceGroupByFGLocalIdentifierFromClusterCSNsWithCancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg1 fetchLimit:(unsigned long long)arg2;
- (_Bool)cleanupMergeCandidatesWithMinimumFaceGroupSize:(unsigned long long)arg1 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;
- (_Bool)_cleanupMergeCandidatesForVerifiedPersons:(id)arg1 minimumFaceGroupSize:(unsigned long long)arg2 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg3 error:(id *)arg4;
...
- (id)_representativenessByFaceCSNFromFaces:(id)arg1 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2;
- (id)bestRepresentativeFaceForPerson:(id)arg1 qualityMeasureByFace:(id)arg2 candidateFaces:(id)arg3 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg4;
- (id)bestRepresentativeFaceForPerson:(id)arg1 qualityMeasureByFace:(id)arg2 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg3;
- (_Bool)updateKeyFacesOfPersonsWithLocalIdentifiers:(id)arg1 forceUpdate:(_Bool)arg2 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg3 error:(id *)arg4;
- (_Bool)deleteEmptyGroupsAndReturnError:(id *)arg1;
- (_Bool)resetLibraryClustersWithCancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg1 error:(id *)arg2;
- (_Bool)persistChangesToAlgorithmicFaceGroups:(id)arg1 faceCSNByLocalIdentifierForNewlyClusteredFaces:(id)arg2 faceCSNsOfUnclusteredFaces:(id)arg3 localIdentifiersOfUnclusteredFaces:(id)arg4 persistenceCompletionBlock:(CDUnknownBlockType)arg5 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg6 error:(id *)arg7;
- (id)_localIdentifiersOfUnverifiedPersonsAssociatedWithFaceGroups:(id)arg1 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2;
...
- (_Bool)cleanupGroupedFacesWithClusterSequenceNumberSetToZero:(CDUnknownBlockType)arg1 error:(id *)arg2;
- (_Bool)cleanupUngroupedFacesWithNonZeroClusterSequenceNumbers:(CDUnknownBlockType)arg1 error:(id *)arg2;
- (_Bool)_resetFaceClusterSequenceNumberOfFacesInFetchResult:(id)arg1 inPhotoLibrary:(id)arg2 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg3 error:(id *)arg4;
...
- (_Bool)_ungroupFaceClusterSequenceNumbers:(id)arg1 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;
- (_Bool)ungroupFaceClusterSequenceNumbers:(id)arg1 batchSizeForUnclusteringFaces:(unsigned long long)arg2 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg3 error:(id *)arg4;
- (void)_categorizeGroupedFacesInFetchResult:(id)arg1 intoFaceLocalIdentifiersByFaceGroup:(id)arg2 ungroupedFaceLocalIdentifiers:(id *)arg3 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg4 photoLibrary:(id)arg5;
- (id)invalidFaceClusterSequenceNumbersInClusterSequenceNumbers:(id)arg1 cancelOrExtendTimeoutBlock:(CDUnknownBlockType)arg2 error:(id *)arg3;
