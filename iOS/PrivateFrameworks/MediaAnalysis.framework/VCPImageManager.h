...
+ (_Bool)allowFastPathDecodeWithUniformType:(id)arg1 pixelWidth:(unsigned long long)arg2 andPixelHeight:(unsigned long long)arg3;
...
- (struct __CVBuffer *)pixelBufferWithFormat:(int)arg1 fromImageURL:(id)arg2 flushCache:(_Bool)arg3 orientation:(unsigned int *)arg4;
...
- (struct __CVBuffer *)pixelBufferWithFormat:(int)arg1 andMaxDimension:(unsigned long long)arg2 fromData:(id)arg3 withUniformTypeIdentifier:(id)arg4 flushCache:(_Bool)arg5 orientation:(unsigned int *)arg6;
...
- (int)acceleratedDecodeImageData:(id)arg1 pixelFormat:(int)arg2 maxDimension:(unsigned long long)arg3 pixelBuffer:(struct __CVBuffer **)arg4 orientation:(unsigned int *)arg5 flushCache:(_Bool)arg6;
