...
- (id)initWithAnalysisTypes:(unsigned long long)arg1 transform:(struct CGAffineTransform)arg2 timeRange:(CDStruct_e83c9415)arg3 isLivePhoto:(_Bool)arg4 frameStats:(id)arg5 hadFlash:(_Bool)arg6 hadZoom:(_Bool)arg7 keyFrameResults:(id)arg8 isTimelapse:(_Bool)arg9 preferredTimeRange:(CDStruct_e83c9415)arg10 asset:(id)arg11;
