...
- (_Bool)cancelMessageWithOptions:(id)arg1 identifier:(id *)arg2 error:(id *)arg3;
...
- (void)connection:(id)arg1 didCancelMessageWithSuccess:(_Bool)arg2 error:(id)arg3 identifier:(id)arg4;
