...
@class NSString, PKPaymentAutoReloadSetupController, UIViewController;

@protocol PKPaymentAutoReloadSetupControllerDelegate <NSObject>
- (void)autoReloadSetupControllerDidCompleteWithAmount:(NSString *)arg1 threshold:(NSString *)arg2;
