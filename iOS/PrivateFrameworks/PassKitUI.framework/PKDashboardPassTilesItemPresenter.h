...
@interface PKDashboardPassTilesItemPresenter : NSObject <PKPassTileGroupViewDelegate, PKDashboardItemPresenter>
{
    ...
    id <PKDashboardPassTilesItemPresenterDelegate> _delegate;
}

- (void).cxx_destruct;
@property(retain, nonatomic) id <PKDashboardPassTilesItemPresenterDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)_configureCell:(id)arg1 forItem:(id)arg2 inCollectionView:(id)arg3 forIndexPath:(id)arg4 animated:(_Bool)arg5;
