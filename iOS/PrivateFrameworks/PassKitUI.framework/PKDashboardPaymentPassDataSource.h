...
- (_Bool)_isCreditPass;
- (void)_fetchAMPEnrollmentIconIfNeeded:(CDUnknownBlockType)arg1;
...
- (void)_messageForUnusableIdentityPassWithCompletion:(CDUnknownBlockType)arg1;
