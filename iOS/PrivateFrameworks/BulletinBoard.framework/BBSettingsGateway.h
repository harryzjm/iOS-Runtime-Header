...
+ (id)clientInterface;
- (void).cxx_destruct;
- (void)getEffectiveGlobalScheduledDeliveryShowNextSummarySettingWithCompletion:(CDUnknownBlockType)arg1;
