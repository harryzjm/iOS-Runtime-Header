...
- (void)dismissTimerWithIdentifier:(id)arg1 fromClient:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
- (void)removeTimer:(id)arg1 fromClient:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
- (void)updateTimer:(id)arg1 fromClient:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
- (void)addTimer:(id)arg1 fromClient:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
- (void)timersForAccessories:(id)arg1 fromClient:(id)arg2 callback:(CDUnknownBlockType)arg3;
- (void)timersforAccessoryUniqueIdentifier:(id)arg1 fromClient:(id)arg2 withCallback:(CDUnknownBlockType)arg3;
...
- (id)removeTimer:(id)arg1 client:(id)arg2;
- (id)removeTimer:(id)arg1;
- (id)updateTimer:(id)arg1 client:(id)arg2;
- (id)updateTimer:(id)arg1;
- (id)addTimer:(id)arg1 client:(id)arg2;
- (id)addTimer:(id)arg1;
- (id)timers;
