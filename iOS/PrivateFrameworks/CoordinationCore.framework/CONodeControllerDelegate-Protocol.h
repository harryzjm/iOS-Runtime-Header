...
@class COConstituent, COElectionInfo, COMeshCommand, COMeshRequest, CONodeController, COOnDemandNodeCreationRequest, NSError;
...
- (void)nodeController:(CONodeController *)arg1 didReceiveOnDemandNodeCreationRequest:(COOnDemandNodeCreationRequest *)arg2;
