...
- (oneway void)updateObfuscatedIdentifierWithCompletion:(void (^)(NSError *))arg1;
...
- (oneway void)notificationBeaconForSubscriptionId:(NSUUID *)arg1 completion:(void (^)(SPBeacon *, SPBeaconGroup *))arg2;
