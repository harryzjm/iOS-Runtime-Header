...
- (BOOL)durationSinceLastTransitHistoryRoute:(CDUnknownBlockType)arg1;
- (BOOL)userHasFavoriteTransitPOIsWithHandler:(CDUnknownBlockType)arg1;
- (BOOL)userHasFavoriteTransitLinesWithHandler:(CDUnknownBlockType)arg1;
