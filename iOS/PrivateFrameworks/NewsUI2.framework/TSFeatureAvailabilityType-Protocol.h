...
@property(nonatomic, readonly) _Bool betterTopicFeeds;
@property(nonatomic, readonly) _Bool shortcutsEnabled;
@property(nonatomic, readonly) _Bool puzzlesEnabled;
@property(nonatomic, readonly) _Bool shouldGroupSportsHighlights;
@property(nonatomic, readonly) _Bool sportsEventPagesEnabled;
