...
+ (id)trackedFacesWithTime:(CDStruct_1b6d18a9)arg1 faceTrackingDictionary:(id)arg2 input:(id)arg3;
...
- (id)initWithTime:(CDStruct_1b6d18a9)arg1 faceTrackingDictionary:(id)arg2 input:(id)arg3;
