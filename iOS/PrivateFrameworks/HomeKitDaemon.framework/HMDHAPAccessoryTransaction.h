...
+ (id)properties;
+ (id)cd_getMKFHAPAccessoryFromAccessoryUUID:(id)arg1;
+ (id)cd_getMKFHAPAccessoryFromAccessory:(id)arg1;
+ (id)cd_getMKFServiceFromAccessoryUUID:(id)arg1 serviceInstanceId:(id)arg2;
