...
- (id)initWithSetupStartTime:(unsigned long long)arg1 setupEndTime:(unsigned long long)arg2 settingsCreationTime:(unsigned long long)arg3 pairingIdentityCreationTime:(unsigned long long)arg4 accessoryAddProcessedTime:(unsigned long long)arg5 coreDataFirstCloudImportCompleteTime:(unsigned long long)arg6 siriReadinessTime:(unsigned long long)arg7;
