...
- (id)firstCloudKitImportFutureForAppleMediaAccessorySensorManager:(id)arg1;
- (id)residentSyncClientDidSyncFutureForAppleMediaAccessorySensorManager:(id)arg1;
...
- (_Bool)isMatchingCachedEventPublicPairingIdentity:(id)arg1;
- (id)cachedEventPairingIdentity;
- (id)pairingIdentityTopic;
- (void)forwardAccessoryPublicPairingIdentity:(id)arg1;
...
- (void)_handleAudioAnalysisBulletinBoardCommit:(id)arg1;
- (id)logIdentifier;
...
- (void)_scanForSoftwareUpdateRepeatedlyAndInstallUpdate:(_Bool)arg1;
- (void)handleSoftwareUpdateV2ScanRepeatedlyAndApplyMessage:(id)arg1;
