...
@interface HMDBiomeEventManager : HMFObject
{
    ...
    CDUnknownBlockType _prunableStreamFactory;
...
- (id)init;
- (id)initWithNotificationCenter:(id)arg1 actionSetStream:(id)arg2 mediaAccessoryStream:(id)arg3 accessoryStream:(id)arg4 prunableStreamFactory:(CDUnknownBlockType)arg5 workQueue:(id)arg6;
