...
@interface HMDHome : HMFObject <HMDBulletinIdentifiers, HMDHomeResidentMessagingContext, HMDAppleMediaAccessoriesStateManagerFactory, HMDAppleMediaAccessoriesStateManagerDataSource, HMDPrimaryResidentMessageRouterFactory, HMDAccessorySettingsLocalMessageHandlerFactory, HMDUnifiedLanguageValueListSettingDataProviderDataSource, HMDSiriEndpointProfileMessageHandlerFactory, HMDPrimaryResidentMessageRouterMetricsDispatcherFactory, HMDAccessorySettingsMessengerFactory, HMDAppleMediaAccessoriesStateManagerMetricsDispatcherFactory, HMDPrimaryResidentMessageRouterDataSource, HMDSiriEndpointProfilesMessengerFactory, HMDAccessorySettingsLocalMessageHandlerDataSource, HMDUnifiedLanguageValueListSettingDataProviderFactory, HMDResidentDeviceManagerDelegate, HMDHomeMediaSystemHandlerDelegate, HMDRemoteEventRouterClientDataSource, HMDRemoteEventRouterServerDataSource, HMDDevicePreferenceDataSource, HMFLogging, HMDAccessoryBrowserDelegate, HMDHomeMessageReceiver, HMDRelayManagerDelegate, HMFTimerDelegate, HMFDumpState, HMDUserManagementOperationDelegate, HMDCoordinationStateManagerProviding, HMDMediaActionRouterDataSource, NSSecureCoding, HMDBackingStoreObjectProtocol>
{
    ...
    HMDRemoteEventRouterClient *_remoteEventRouterClient;
    ...
    HMDApplicationDataPlugIn *_applicationData;
    HMDAppleAccountSettings *_accountSettings;
    HMDBonjourBrowserHelper *_bonjourBrowser;
    HMDAssistantWatchAuthenticationDataSource *_siriWatchAuthenticationDataSource;
}
...
- (void).cxx_destruct;
@property(readonly) HMDAssistantWatchAuthenticationDataSource *siriWatchAuthenticationDataSource; // @synthesize siriWatchAuthenticationDataSource=_siriWatchAuthenticationDataSource;
@property(readonly, nonatomic) HMDBonjourBrowserHelper *bonjourBrowser; // @synthesize bonjourBrowser=_bonjourBrowser;
@property(readonly) HMDAppleAccountSettings *accountSettings; // @synthesize accountSettings=_accountSettings;
@property(retain) HMDApplicationDataPlugIn *applicationData; // @synthesize applicationData=_applicationData;
...
@property _Bool isUpdatedToROAR; // @synthesize isUpdatedToROAR=_isUpdatedToROAR;
...
@property(retain, nonatomic) HMDRemoteEventRouterClient *remoteEventRouterClient; // @synthesize remoteEventRouterClient=_remoteEventRouterClient;
...
- (void)handleHK2MigrationRequest:(id)arg1;
- (id)routerServerUserAccessControlProvider:(id)arg1;
- (id)routerServerResidentManager:(id)arg1;
- (id)routerClientResidentManager:(id)arg1;
...
- (id)routerClientPrimaryResidentMessageDestination:(id)arg1 serverIdentifier:(out id *)arg2;
...
- (_Bool)_isRetrievalInProgressForAccessory:(id)arg1 linkType:(long long)arg2;
...
- (void)_queryThreadNetworkIDWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)handleUpdatePrimaryNotification:(id)arg1;
...
- (_Bool)_isReadRequestAllowForCharacteristic:(id)arg1 message:(id)arg2 error:(id *)arg3;
...
- (void)_sendWriteRequestToAccessory:(id)arg1 requestMessage:(id)arg2 source:(unsigned long long)arg3 failedAccessories:(id)arg4 responseTuples:(id)arg5 activity:(id)arg6 waitGroup:(id)arg7 unreachableWaitGroup:(id)arg8;
- (void)_sendReadRequestToAccessory:(id)arg1 requestMessage:(id)arg2 source:(unsigned long long)arg3 pendingResponses:(id)arg4 slowFailedAccessories:(id)arg5 fastFailedAccessories:(id)arg6 unreachableWaitGroup:(id)arg7 waitGroup:(id)arg8 activity:(id)arg9;
...
- (void)_postInternalNotificationForChangedCharacterisitics:(id)arg1 modifiedCharacteristics:(id)arg2 changedByThisDevice:(_Bool)arg3 residentShouldNotifyPeers:(_Bool)arg4 message:(id)arg5 broadcast:(_Bool)arg6;
...
- (void)__handleAcceptedOutgoingInvitationResponse:(id)arg1 destinationAddress:(id)arg2 publicKey:(id)arg3 username:(id)arg4 sourceMergeID:(id)arg5 presenceAuthStatus:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;
...
- (void)_handleUpdateRequestForHomeInvitation:(id)arg1 controllerPublicKey:(id)arg2 controllerUsername:(id)arg3 invitationState:(long long)arg4 presenceAuthStatus:(id)arg5 preferredUserID:(id)arg6 fromHandle:(id)arg7 sourceMergeID:(id)arg8 fromAddress:(id)arg9 message:(id)arg10 messageResponseHandler:(CDUnknownBlockType)arg11;
...
- (void)__sendOutgoingInvitations:(id)arg1;
...
- (id)userWithPairingIdentity:(id)arg1 mergeID:(id)arg2;
...
- (_Bool)_neverHadAnyHAPAccessory;
...
- (void)notifyOfRemovedAccessory:(id)arg1 isRemovingCurrentAppleMediaAccessory:(_Bool)arg2 source:(unsigned long long)arg3;
...
- (void)suspendedStateChangedForAccessory:(id)arg1 suspededState:(unsigned long long)arg2;
...
- (void)_subscribeForHomeAppleMediaNotificationsOnDirectTransports:(_Bool)arg1;
...
- (void)dealloc;
- (void)unconfigure;
- (id)initWithName:(id)arg1 uuid:(id)arg2 defaultRoomUUID:(id)arg3 owner:(id)arg4 homeManager:(id)arg5 presenceAuth:(id)arg6 metricsDispatcherFactory:(id)arg7 currentUserFactory:(CDUnknownBlockType)arg8 residentDeviceManagerFactory:(CDUnknownBlockType)arg9 locationHandlerFactory:(CDUnknownBlockType)arg10 hapMetadata:(id)arg11 siriWatchAuthenticationDataSource:(id)arg12 deviceLockStateDataSource:(id)arg13;
...
- (id)createAccessorySettingsMessengerWithMessageTargetUUID:(id)arg1 messageDispatcher:(id)arg2 messageRouter:(id)arg3 messageHandler:(id)arg4;
