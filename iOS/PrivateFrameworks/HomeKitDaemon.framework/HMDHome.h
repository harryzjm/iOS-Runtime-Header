...
- (void)_enableResidentReachabilityNotification:(_Bool)arg1 forAccessories:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)enableResidentReachabilityNotification:(_Bool)arg1 forAccessories:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
