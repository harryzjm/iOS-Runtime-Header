...
- (void)_executeAppleMediaAccessoryPowerActions:(id)arg1 source:(unsigned long long)arg2 clientName:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (id)_executeAppleMediaAccessoryPowerActions:(id)arg1 message:(id)arg2;
...
- (void)_updateAppleMediaAccessoryPowerAction:(id)arg1 forMessage:(id)arg2;
...
- (void)_handleAddAppleMediaAccessoryPowerActionTransaction:(id)arg1 message:(id)arg2;
...
- (id)_addAppleMediaAccessoryPowerActionModelWithUUID:(id)arg1 message:(id)arg2;
...
- (void)auditActionsForAccessory:(id)arg1 transaction:(id)arg2;
