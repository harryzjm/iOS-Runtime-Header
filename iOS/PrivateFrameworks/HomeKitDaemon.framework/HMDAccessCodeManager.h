...
- (id)_addNewAccessCode:(id)arg1 toAccessoriesWithUUIDs:(id)arg2 withRetries:(_Bool)arg3;
...
- (id)_removeAccessCode:(id)arg1 forUser:(id)arg2;
- (id)_removeAccessCode:(id)arg1 forUserWithUUID:(id)arg2;
- (void)_setAccessCodeForUserForMessage:(id)arg1;
- (id)_removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure:(id)arg1;
