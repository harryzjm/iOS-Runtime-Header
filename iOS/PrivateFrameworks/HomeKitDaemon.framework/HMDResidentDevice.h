...
- (_Bool)_updateMessageAddress:(id)arg1;
...
- (_Bool)isDeviceEquivalentToDeviceAddress:(id)arg1;
...
- (id)initWithDevice:(id)arg1 home:(id)arg2 name:(id)arg3 rawCapabilities:(id)arg4 messageAddress:(id)arg5;
