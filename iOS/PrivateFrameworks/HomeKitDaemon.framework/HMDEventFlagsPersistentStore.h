...
{
    NSString *_eventFlagsStorePath;
    NSString *_eventFlagsStoreKey;
}
...
- (void)archiveEventFlagsValues:(id)arg1 withDefinedEventFlagPeriods:(id)arg2;
- (id)initWithDataStorePath:(id)arg1 dataStoreKey:(id)arg2;
