...
@interface HMDHAPAccessory
{
    ...
    NSMutableSet *_serviceImpactZones;
    ...
    NSString *_lastLockOperationEventRequestIdentifier;
...
- (void)addServiceImpactZone:(id)arg1;
- (void)removeServiceImpactZone:(id)arg1;
@property(readonly, copy, nonatomic) NSSet *serviceImpactZones;
...
- (void)_handleUpdateCharacteristicAuthorizationDataMessageForNonOwnerUser:(id)arg1;
- (void)_handleUpdateCharacteristicAuthorizationDataMessageForOwnerUser:(id)arg1;
...
- (id)runtimeState;
- (void)_handleAccessoryUpdateReachability:(_Bool)arg1 linkType:(long long)arg2;
...
- (id)saveSupportsMatterWalletKey:(id)arg1;
...
- (id)saveSupportsMatterAccessCode:(id)arg1;
...
- (void)_updateCharacteristicsFromService:(id)arg1 context:(id)arg2;
- (void)migrateCharacteristicsForHAPAccessoryIfNeeded;
- (id)_hh2HandleUpdatedServicesForProfilesAndControllers:(id)arg1;
- (_Bool)_hh2ShouldFilterAccessoryProfile:(id)arg1;
...
- (void)encodeServiceImpactZonesWithCoder:(id)arg1;
- (_Bool)_handleUpdatedServicesForServiceImpactZone:(id)arg1;
...
- (void)_handleUpdatedCameraDerivedPropertiesModelValuesForAccessoryModel:(id)arg1;
- (void)_handleUpdatedCameraSettingsModelValuesForAccessoryModel:(id)arg1;
- (void)handleUpdatedCameraProfileSettingsForAccessoryModel:(id)arg1;
...
- (void)updateSupportsMatterAccessCodeForAttributeReport:(id)arg1;
- (void)updateSupportsMatterWalletKeyForAttributeReport:(id)arg1;
- (void)handleAttributeReport:(id)arg1;
- (void)handleCharacteristicEventReportMessage:(id)arg1;
- (void)handleEventReport:(id)arg1;
