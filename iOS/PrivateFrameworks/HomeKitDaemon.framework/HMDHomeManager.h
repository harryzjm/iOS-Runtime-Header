...
@class HMDAWDLogEventObserver, HMDAccessoryBrowser, HMDAccessorySetupManager, HMDAccountRegistry, HMDAppleAccessoryPairingController, HMDApplicationData, HMDApplicationDataPlugIn, HMDAssistantGather, HMDBackingStore, HMDBiomeEventManager, HMDBiomeLogEventObserver, HMDCHIPDataSource, HMDCameraRecordingLoadBalancer, HMDClientConnection, HMDCloudAccount, HMDCloudDataSyncStateFilter, HMDCloudManager, HMDCloudManagerDataSource, HMDCompanionManager, HMDCompositeSettingsControllerManager, HMDCoreDuetLogEventObserver, HMDDevice, HMDDuetEventManager, HMDDuetPredictionSubscriber, HMDFMFHandler, HMDHK2FrameworkSwitch, HMDHomeManagerObjectChangeHandler, HMDHomeManagerObjectLookup, HMDIdentityRegistry, HMDKeyTransferAgent, HMDLocation, HMDMemoryUtilizationTracker, HMDMessageDispatcher, HMDMessageFilterChain, HMDMetricsManager, HMDMicroLocationLogEventObserver, HMDMicroLocationManager, HMDMobileAssetManager, HMDMultiUserSettingsMetricsEventDispatcher, HMDMultiUserStatusController, HMDNameValidator, HMDPairedSync, HMDPowerManager, HMDResidentMesh, HMDSiriEndpointOnboardingManager, HMDSiriEndpointSettingsSyncManager, HMDSoftwareUpdateManager, HMDSyncOperationManager, HMDUserCloudShareManager, HMDWatchManager, HMDXPCEventRouterServer, HMELastEventStore, HMEMemoryEventBus, HMFActivity, HMFBoolean, HMFDumpCategory, HMFTimer, NSArray, NSDate, NSMapTable, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSUUID;
...
@interface HMDHomeManager : HMFObject <HMDSiriEndpointProfileMessageHandlerDataSource, HMDSiriEndpointOnboardingManagerDataSource, HMDMultiUserSettingsMetricsEventDispatcherDataSource, HMDCloudManagerDelegate, HMDDeviceSetupSessionDelegate, HMDCompositeSettingsControllerManagerDataSource, HMDSiriEndpointSettingsSyncManagerDataSource, HMEMemoryEventBusDelegate, HMDDuetPredictionSubscriberDataSource, HMDMicroLocationLogEventObserverDataSource, HMDMobileAssetManagerDelegate, HMDMultiUserStatusControllerDelegate, HMDSyncOperationManagerDataSource, HMDBiomeMigrationManagerDataSource, HMDBiomeLogEventObserverDataSource, HMFMessageReceiver, HMFLogging, HMDAccessoryBrowserManagerDelegate, HMFTimerDelegate, HAPFragmentationStreamDelegate, HMDPairedSyncDelegate, HMDUserManagementOperationDelegate, HMDBackingStoreObjectProtocol>
{
    ...
    HMEMemoryEventBus *_registrationForwardingEventRouter;
    ...
    HMDHK2FrameworkSwitch *_hk2FrameworkSwitch;
...
@property(retain, nonatomic) HMDHK2FrameworkSwitch *hk2FrameworkSwitch; // @synthesize hk2FrameworkSwitch=_hk2FrameworkSwitch;
...
- (void)syncWalletKeyPassSerialNumbersToWatchWithDeviceId:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_loadMessageDispatcher:(id)arg1 accessoryBrowser:(id)arg2 messageFilterChain:(id)arg3 homeData:(id)arg4 localDataDecryptionFailed:(_Bool)arg5 identityRegistry:(id)arg6 accountRegistry:(id)arg7 uncommittedTransactions:(id)arg8 reloadData:(_Bool)arg9;
...
- (id)remoteAccessControlEnforcerForHomeUUID:(id)arg1;
- (id)remoteSubscriptionProviderForHomeUUID:(id)arg1;
...
- (void)saveToPersistentStoreForHK2MigrationWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)refreshHomeDataAndArchiveLocallyWithCompletionHandler:(CDUnknownBlockType)arg1;
- (id)writeMigrationRecordFromMessage:(id)arg1;
- (void)startHK2MigrationFromRequest:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)handleHK2MigrationRequest:(id)arg1;
- (void)sendMigrationRequestToResident:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)_handleUpgradeToHomeKit2Framework:(id)arg1;
- (void)waitForHK2SentinelZoneToBeRemoved;
- (void)_registerForFrameworkSwitch;
- (void)initializeHK2FrameworkSwitch;
