...
@interface RMConfigurationSubscriberEventStream
{
    ...
    id <RMConfigurationSubscriberEventStreamDelegate> _delegate;
...
@property(nonatomic) __weak id <RMConfigurationSubscriberEventStreamDelegate> delegate; // @synthesize delegate=_delegate;
