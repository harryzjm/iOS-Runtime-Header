...
- (void)setCrashReporterInfoForMappedFileRegion:(struct _VMURegionNode *)arg1 mappedRegionStartAddress:(unsigned long long)arg2 mappedSize:(unsigned long long)arg3 reason:(id)arg4;
- (_Bool)addressIsInDataSegment:(unsigned long long)arg1;
- (struct _VMURegionNode *)validateAddressRangeForSwiftRemoteMirror:(struct _VMURange)arg1 allowUnusedSplitLibs:(_Bool)arg2;
