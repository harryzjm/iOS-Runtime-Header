...
- (void)deleteLocalAndRemoteEventsWithReason:(unsigned long long)arg1 usingPredicateBlock:(CDUnknownBlockType)arg2;
- (void)deleteLocalAndRemoteEventsWithPredicateBlock:(CDUnknownBlockType)arg1;
- (void)deleteEventsWithPredicate:(CDUnknownBlockType)arg1;
- (id)source;
- (id)publisher;
