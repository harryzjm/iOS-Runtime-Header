...
- (void)sendSynchronously:(_Bool)arg1 request:(id)arg2 retry:(_Bool)arg3 reply:(CDUnknownBlockType)arg4;
...
- (void)holdPlugins:(id)arg1 extensionPointName:(id)arg2 platforms:(id)arg3 flags:(unsigned long long)arg4 reply:(CDUnknownBlockType)arg5;
