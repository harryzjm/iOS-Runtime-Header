...
- (void)listController:(id)arg1 updateSectionContentInsetAnimated:(_Bool)arg2 isRegularWidth:(_Bool)arg3 contentInsetInitialized:(_Bool)arg4 contentInsetInitializedApplicator:(CDUnknownBlockType)arg5;
...
- (void)customizeTableView:(id)arg1 inContainerView:(id)arg2 hostedInSetupController:(_Bool)arg3 forListController:(id)arg4;
