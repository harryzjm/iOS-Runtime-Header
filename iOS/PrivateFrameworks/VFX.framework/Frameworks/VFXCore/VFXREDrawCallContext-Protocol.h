...
@property(nonatomic, readonly) _Bool isDrawingBlur;
@property(nonatomic, readonly) _Bool isDrawingDepthOnly;
...
@optional
@property(nonatomic, readonly) id <VFXStencilInfo> stencilInfo;
@end
