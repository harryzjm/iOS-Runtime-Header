...
- (id)_effectiveDataFromData:(id)arg1 activeOverride:(unsigned long long)arg2 canUpdateBackgroundActivity:(_Bool)arg3;
- (long long)_effectiveStyleFromStyle:(long long)arg1;
- (id)_dataFromLegacyData:(const CDStruct_e9def42b *)arg1;
- (void)_updateSemanticContentAttributeFromLegacyData:(const CDStruct_e9def42b *)arg1;
