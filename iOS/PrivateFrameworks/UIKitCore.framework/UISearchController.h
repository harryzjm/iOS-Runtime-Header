...
@class NSArray, NSString, UISearchBar, UISystemInputViewController, UITapGestureRecognizer, UIView, UIViewController, _UINavigationControllerManagedSearchPalette, _UISearchControllerDidScrollDelegate;
@protocol UISearchControllerDelegate, UISearchResultsUpdating, UIViewControllerAnimatedTransitioning;

@interface UISearchController <UIViewControllerPresenting, _UIScrollViewScrollObserver_Internal, NSCoding, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning>
{
