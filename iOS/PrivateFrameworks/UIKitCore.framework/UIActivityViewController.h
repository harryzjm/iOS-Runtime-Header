...
@class NSArray, NSExtension, NSMutableDictionary, NSOperationQueue, NSString, UIActivity, UIAlertAction, UIAlertController, UISUIActivityViewControllerConfiguration, UIViewController, _UIActivityGroupListViewController, _UIActivityHelper, _UIAlertControllerShimPresenter, _UIShareExtensionRemoteViewController;
@protocol NSCopying, UIActivityViewControllerDelegate, _UIShareExtensionService;

@interface UIActivityViewController <UIAlertControllerContaining, UIAlertControllerVisualStyleProviding, UIViewControllerRestoration, UIActionSheetPresentationControllerDelegate, _UIActivityHelperDelegate, _UIShareExtensionHost>
{
