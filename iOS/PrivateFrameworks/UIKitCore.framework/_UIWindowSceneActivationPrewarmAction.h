...
+ (id)actionWithMorphContainer:(id)arg1 alphaSource:(id)arg2 sourceIdentifier:(id)arg3 interactionIdentifier:(id)arg4 requestCenterSlot:(_Bool)arg5 requestFullscreen:(_Bool)arg6 responseHandler:(CDUnknownBlockType)arg7;
