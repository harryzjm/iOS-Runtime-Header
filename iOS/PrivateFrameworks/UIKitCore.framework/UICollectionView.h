...
- (id)_sceneActivationConfigurationForLocation:(struct CGPoint)arg1;
...
- (id)_focusPromiseRegionsInRect:(struct CGRect)arg1 inCoordinateSpace:(id)arg2 inSection:(long long)arg3;
- (id)_childFocusRegionsInRect:(struct CGRect)arg1 inCoordinateSpace:(id)arg2;
- (void)_performWhileSuppressingPromiseRegionGeneration:(CDUnknownBlockType)arg1;
...
- (void)_updatePrefetchedCellsForOrthogonalScrollingSection:(long long)arg1 withOriginalPrefetchingVector:(struct CGVector)arg2 canCompute:(_Bool)arg3 canPrefetch:(_Bool)arg4;
- (void)_orthogonalScrollView:(id)arg1 didScrollToOffset:(struct CGPoint)arg2 inSection:(long long)arg3;
...
- (void)_handlePresses:(id)arg1 selectHandler:(CDUnknownBlockType)arg2 keyHandler:(CDUnknownBlockType)arg3 defaultHandler:(CDUnknownBlockType)arg4;
...
- (_Bool)_shouldSaveContentOffsetAnchorForInvalidationContext:(id)arg1;
...
- (void)_cacheOrReuseCell:(id)arg1 forIndexPath:(id)arg2 invalidatePreferredAttributes:(_Bool)arg3 notifyDidEndDisplaying:(_Bool)arg4;
...
- (_Bool)_validateScrollingTargetIndexPath:(id)arg1;
...
- (void)_adjustContentOffsetUsingAnchorIfNecessaryWithContentInsets:(struct UIEdgeInsets)arg1;
- (void)_clearContentOffsetRestorationAnchor;
- (void)_saveContentOffsetRestorationAnchorIfNecessary;
- (_Bool)_isContentOffset:(struct CGPoint)arg1 atStartOfAxis:(unsigned long long)arg2;
...
- (_Bool)_updatePrefetchedCells:(_Bool)arg1;
- (void)_rebasePrefetchedCellIndexPathsWithMapping:(CDUnknownBlockType)arg1;
- (void)_updatePrefetchVelocityIntegratorForVisibleBounds:(struct CGRect)arg1;
...
- (void)_reorderPrefetchCandidates:(id)arg1 forPrefetchVelocity:(struct CGVector)arg2 visibleBounds:(struct CGRect)arg3;
...
- (id)_prefetchingContextForVisibleBounds:(struct CGRect)arg1 prefetchVector:(struct CGVector)arg2 prefetchRect:(struct CGRect)arg3 attributes:(id)arg4;
- (id)_computeMainPrefetchCandidatesForVisibleBounds:(struct CGRect)arg1 futureVisibleBounds:(struct CGRect)arg2 prefetchVector:(struct CGVector)arg3;
- (void)_computeMainPrefetchCandidatesForVelocity:(struct CGVector)arg1;
- (unsigned long long)_prefetchItemsForPrefetchingContext:(id)arg1;
- (_Bool)_updatePrefetchItemIfNeeded:(id)arg1 forIndexPath:(id)arg2 willDisplay:(_Bool)arg3;
...
- (_Bool)_isReorderingItemAtIndexPath:(id)arg1 includingDragAndDrop:(_Bool)arg2;
...
- (void)_configureCellForDisplay:(id)arg1 indexPath:(id)arg2 cached:(_Bool)arg3;
...
- (id)_preparedCellForItemAtIndexPath:(id)arg1 withLayoutAttributes:(id)arg2 applyAttributes:(_Bool)arg3 isFocused:(_Bool)arg4 notify:(_Bool)arg5;
...
- (_Bool)_allowsEffectiveSelectionOrCustomActionAtIndexPath:(id)arg1;
