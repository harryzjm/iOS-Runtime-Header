...
@class NSArray, NSString, UIColor, UIImage, UITabBarCustomizeView, UITabBarItem, UIView, _UITabBarAppearanceStorage, _UITabBarVisualProvider;
@protocol UITabBarDelegate;

@interface UITabBar <_UIShadowedView>
{
