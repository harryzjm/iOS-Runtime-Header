...
@class DOCConfiguration, NSArray, NSMutableArray, NSString, NSURL, UIViewController;
@protocol UIDocumentPickerDelegate;

@interface UIDocumentPickerViewController <UIDocumentBrowserViewControllerPrivateDelegate>
{
