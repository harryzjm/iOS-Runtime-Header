...
@class NSArray, NSString, UIColor, UIImage, UILayoutGuide, UITraitCollection, UIView, _UIStackedImageContainerView;

@interface UIImageView <UIAccessibilityContentSizeCategoryImageAdjusting>
{
    id _storage;
