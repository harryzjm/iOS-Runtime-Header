...
@class NSArray, NSDictionary, NSString, UIFontMetrics, UIView, _UINavigationBarLargeTitleViewLayout, _UINavigationBarTransitionContext, _UINavigationControllerRefreshControlHost;

__attribute__((visibility("hidden")))
@interface _UINavigationBarLargeTitleView <_UINavigationBarTitleViewDataSource, _UINavigationBarTransitionContextParticipant>
{
