...
- (id)description;
- (void)_runActionForLayer:(id)arg1 key:(id)arg2 view:(id)arg3 currentValueVector:(id)arg4 targetValue:(id)arg5 force:(_Bool)arg6;
- (_Bool)_decomposeActionIfPossibleForLayer:(id)arg1 key:(id)arg2 view:(id)arg3 currentValueVector:(id)arg4 targetValue:(id)arg5;
