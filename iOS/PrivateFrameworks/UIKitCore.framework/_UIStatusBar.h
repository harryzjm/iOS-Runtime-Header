...
@class NSArray, NSDictionary, NSMutableDictionary, NSString, UIAccessibilityHUDGestureManager, UIColor, UIGestureRecognizer, UIView, _UIStatusBarAction, _UIStatusBarData, _UIStatusBarDataAggregator, _UIStatusBarStyleAttributes;
