...
@interface BLJaliscoDAAPClient : NSObject <BLPurchaseDAAPServerDelegate, BUUserAccountObserving>
{
    ...
    NSPersistentHistoryToken *_currentJaliscoHistoryToken;
...
@property(retain, nonatomic) NSPersistentHistoryToken *currentJaliscoHistoryToken; // @synthesize currentJaliscoHistoryToken=_currentJaliscoHistoryToken;
