...
- (_Bool)updateItem:(id)arg1 matchingItem:(id)arg2 flags:(unsigned int)arg3 error:(id *)arg4;
- (_Bool)updateItem:(id)arg1 matchingItem:(id)arg2 error:(id *)arg3;
- (_Bool)removeItemMatchingItem:(id)arg1 flags:(unsigned int)arg2 error:(id *)arg3;
- (_Bool)removeItemMatchingItem:(id)arg1 error:(id *)arg2;
- (_Bool)addOrUpdateOrReAddItem:(id)arg1 flags:(unsigned int)arg2 logCategory:(struct LogCategory *)arg3 logLabel:(id)arg4 error:(id *)arg5;
...
- (_Bool)addItem:(id)arg1 flags:(unsigned int)arg2 error:(id *)arg3;
