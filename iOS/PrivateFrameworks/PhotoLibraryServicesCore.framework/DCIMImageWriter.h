...
+ (void)writeableDataForImage:(id)arg1 previewImage:(id)arg2 imageData:(id)arg3 imageUTIType:(id)arg4 exifProperties:(id)arg5 imageOrientation:(long long)arg6 thumbnailDataOut:(id *)arg7 imageUTITypeOut:(id *)arg8 exifPropertiesOut:(id *)arg9 isJPEGOut:(_Bool *)arg10 imageDataOut:(id *)arg11;
+ (void)writeableDataForImageData:(id)arg1 imageUTIType:(id)arg2 thumbnailDataOut:(id *)arg3 imageUTITypeOut:(id *)arg4 exifPropertiesOut:(id *)arg5 isJPEGOut:(_Bool *)arg6 imageDataOut:(id *)arg7;
+ (id)sharedDCIMWriter;
