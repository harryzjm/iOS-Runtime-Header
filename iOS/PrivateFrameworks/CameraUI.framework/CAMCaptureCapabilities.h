...
@interface CAMCaptureCapabilities : NSObject
{
    ...
    _Bool _flashMitigationSupported;
    ...
    _Bool _allowPortraitDescriptionOverlay;
    _Bool _ctmSupported;
    _Bool _useReticleStroke;
    _Bool _useCTMTransientImageWell;
    _Bool _useCTMModeSelector;
    _Bool _allowControlDrawer;
    _Bool _cinematicModeSupported;
    _Bool _backCinematicModeSupported;
    _Bool _frontCinematicModeSupported;
    ...
    _Bool _semanticStylesSupported;
    ...
    _Bool _imageAnalysisSupported;
    _Bool _imageAnalysisButtonAlwaysVisible;
    _Bool _imageAnalysisShowsInactiveTextRegions;
    ...
    _Bool _allowDynamicShutterZoom;
    ...
    _Bool __preferWideDualPortrait;
    _Bool __disablePortraitBravoDevices;
    _Bool __disableSuperBravoDevice;
    ...
    _Bool __previewAspectRatioToggleSupportedForPhotoModes;
    _Bool _hasFilteringEntitlement;
    _Bool _ctmSupportSuppressed;
    _Bool _deviceSupportsCTM;
    _Bool _cacheDeleteSupported;
...
@property(readonly, nonatomic, getter=isSemanticStylesSupported) _Bool semanticStylesSupported; // @synthesize semanticStylesSupported=_semanticStylesSupported;
...
- (_Bool)isPreviewAspectRatioToggleSupportedForMode:(long long)arg1;
...
- (double)defaultDepthEffectApertureForMode:(long long)arg1 device:(long long)arg2;
...
- (_Bool)isDepthEffectApertureSupportedForMode:(long long)arg1;
...
- (_Bool)isCinematicModeSupportedForDevice:(long long)arg1;
- (_Bool)isCinematicModeSupportedForDevicePosition:(long long)arg1;
...
- (_Bool)isAutoFPSVideoSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2 videoEncodingBehavior:(long long)arg3;
...
- (_Bool)isVariableFramerateVideoSupportedForMode:(long long)arg1 videoConfiguration:(long long)arg2 videoEncodingBehavior:(long long)arg3;
...
- (_Bool)isPortraitZoomSupportedForDevicePosition:(long long)arg1;
...
- (_Bool)isSupportedVideoConfiguration:(long long)arg1 forMode:(long long)arg2 videoEncodingBehavior:(long long)arg3;
