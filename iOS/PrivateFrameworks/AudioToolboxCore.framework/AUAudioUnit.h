...
+ (void)instantiateWithComponentDescription:(struct AudioComponentDescription)arg1 options:(unsigned int)arg2 connectionProvider:(function_852fea26)arg3 completionHandler:(CDUnknownBlockType)arg4;
