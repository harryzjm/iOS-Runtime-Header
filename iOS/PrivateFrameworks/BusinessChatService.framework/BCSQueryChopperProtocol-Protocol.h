...
- (void)queryChopperDelegate:(id <BCSLinkQueryChopperDelegate>)arg1 isBusinessRegisteredForURL:(NSURL *)arg2 forClientBundleID:(NSString *)arg3 metric:(id <BCSBusinessLinkChoppingMetric>)arg4 completion:(void (^)(_Bool, NSError *))arg5;
