...
- (void)getRegisteredChannelsForTopic:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getRegisteredChannelsForTopic:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)_dispatch_async_to_ivarQueue:(CDUnknownBlockType)arg1 shutdownBlock:(CDUnknownBlockType)arg2;
- (void)_dispatch_async_to_ivarQueue:(CDUnknownBlockType)arg1;
- (void)_dispatch_sync_to_ivarQueue:(CDUnknownBlockType)arg1 shutdownBlock:(CDUnknownBlockType)arg2;
...
- (void)_handleEvent:(id)arg1 withHandler:(CDUnknownBlockType)arg2 errorHandler:(CDUnknownBlockType)arg3;
- (void)_handleEvent:(id)arg1 withHandler:(CDUnknownBlockType)arg2;
- (void)_noteDisconnectedFromDaemonOnIvarQueue;
- (void)_asyncOnDelegateQueueWithBlock:(CDUnknownBlockType)arg1 requiresDelegate:(_Bool)arg2;
