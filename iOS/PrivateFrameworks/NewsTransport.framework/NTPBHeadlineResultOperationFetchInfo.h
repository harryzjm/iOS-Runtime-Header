...
@property(retain, nonatomic) NSString *headlineSourceIdentifier; // @synthesize headlineSourceIdentifier=_headlineSourceIdentifier;
- (void).cxx_destruct;
...
@property(readonly, nonatomic) _Bool hasHeadlineSourceIdentifier;
