...
- (_Bool)link:(id)arg1 didReceivePacket:(CDStruct_727fadec *)arg2 fromDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;
...
- (void)_enableE2E;
- (void)unregisterPlugWithName:(id)arg1 relayGroupID:(id)arg2 relaySessionID:(id)arg3;
- (void)registerPluginWithName:(id)arg1 relayGroupID:(id)arg2 relaySessionID:(id)arg3;
...
- (void)setReceivedRemoteDeviceVersion:(_Bool)arg1;
...
- (void)_updateSendStatsWithResult:(unsigned long long)arg1 bytesSent:(long long)arg2 packetsSent:(int)arg3 linkID:(BOOL)arg4 delegatedLinkID:(BOOL)arg5 token:(id)arg6 useRelay:(_Bool)arg7 isClientData:(_Bool)arg8 sendTime:(double)arg9 stunTransport:(long long)arg10;
- (_Bool)_getPacketBufferSendInfo:(CDStruct_727fadec *)arg1 channelNumber:(unsigned short *)arg2 transport:(long long *)arg3;
...
- (_Bool)_processIncomingIndicationData:(char *)arg1 length:(int)arg2 candidatePairToken:(id)arg3 arrivalTime:(double)arg4 remoteRelayLinkID:(unsigned short)arg5;
- (void)_sendCommandMessage:(long long)arg1 stunMessage:(id)arg2 options:(id)arg3 candidatePairToken:(id)arg4;
- (_Bool)_shouldSkipCommand:(long long)arg1 withCandidatePair:(id)arg2 connectionDataCounter:(int)arg3 relayInterfaceCounter:(int)arg4;
...
- (long long)_sendStunMessage:(id)arg1 sourceIfIndex:(int)arg2 source:(struct sockaddr *)arg3 destination:(struct sockaddr *)arg4 stunTransport:(long long)arg5 token:(id)arg6 linkID:(BOOL)arg7 delegatedLinkID:(BOOL)arg8 MTULimit:(int)arg9;
...
- (void)_processReallocChannelData:(CDStruct_727fadec *)arg1 channelNumber:(unsigned short)arg2 fromDeviceUniqueID:(id)arg3 cbuuid:(id)arg4 arrivalTime:(double)arg5;
...
- (_Bool)_processStunPacket:(CDStruct_727fadec *)arg1 fromDeviceUniqueID:(id)arg2 cbuuid:(id)arg3 arrivalTime:(double)arg4 headerOverhead:(unsigned long long)arg5;
