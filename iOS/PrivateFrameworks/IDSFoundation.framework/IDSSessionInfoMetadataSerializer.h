...
+ (id)_readDictionaryFromByteArray:(char *)arg1 fieldByteSize:(unsigned short)arg2 byteBuffer:(CDStruct_457e09f6 *)arg3;
+ (id)_readArrayFromByteArray:(char *)arg1 fieldByteSize:(unsigned short)arg2 byteBuffer:(CDStruct_457e09f6 *)arg3;
