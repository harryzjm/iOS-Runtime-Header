...
- (id)initWithGuid:(id)arg1 success:(_Bool)arg2 connectionType:(unsigned int)arg3 resultCode:(unsigned int)arg4 registrationError:(unsigned int)arg5 isPhoneUser:(_Bool)arg6 isDSUser:(_Bool)arg7 genericError:(id)arg8 URLError:(id)arg9 POSIXError:(id)arg10;
