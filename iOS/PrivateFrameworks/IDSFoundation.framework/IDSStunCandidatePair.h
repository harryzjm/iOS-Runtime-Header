...
- (void)_notifySessionStreamInfoReceived:(id)arg1 withParticipants:(id)arg2 lightweightParticipants:(id)arg3 sentBytes:(unsigned long long)arg4 receivedBytes:(unsigned long long)arg5 offlineRequest:(_Bool)arg6 streamInfoRequest:(_Bool)arg7 status:(unsigned int)arg8;
- (void)processSessionInfoRequestTimeout:(id)arg1;
- (_Bool)processStunErrorResponse:(id)arg1 packetBuffer:(CDStruct_727fadec *)arg2 headerOverhead:(unsigned long long)arg3;
- (_Bool)processPluginRegistrationResponse:(id)arg1;
- (_Bool)processParticipantUpdateIndication:(id)arg1 arrivalTime:(double)arg2;
- (_Bool)processDataMessageErrorIndication:(id)arg1;
- (_Bool)processSessionInfoIndication:(id)arg1 arrivalTime:(double)arg2 isLightweightParticipant:(_Bool)arg3;
- (_Bool)processInfoIndication:(id)arg1 arrivalTime:(double)arg2;
- (_Bool)processParticipantUpdateResponse:(id)arg1;
- (_Bool)processTestResponse:(id)arg1 arrivalTime:(double)arg2;
- (_Bool)processSessionInfoResponse:(id)arg1 packetBuffer:(CDStruct_727fadec *)arg2 headerOverhead:(unsigned long long)arg3 isLightweightParticipant:(_Bool)arg4;
- (_Bool)processInfoResponse:(id)arg1 packetBuffer:(CDStruct_727fadec *)arg2 headerOverhead:(unsigned long long)arg3;
...
- (void)setServerIsDegraded:(_Bool)arg1;
