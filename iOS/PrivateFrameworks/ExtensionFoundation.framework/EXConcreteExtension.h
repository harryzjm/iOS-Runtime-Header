...
- (_Bool)_beginUsingAndCreateExtensionAssertionWithRequest:(id)arg1 error:(id *)arg2;
- (void)_safelyBeginUsingWithRequest:(id)arg1 readyHandler:(CDUnknownBlockType)arg2;
- (void)_safelyBeginUsingSynchronously:(_Bool)arg1 request:(id)arg2 readyHandler:(CDUnknownBlockType)arg3;
...
- (void)_beginExtensionRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_reallyBeginExtensionRequest:(id)arg1 synchronously:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (_Bool)makeExtensionContextAndXPCConnectionForRequest:(id)arg1 error:(id *)arg2;
- (void)_reallyBeginExtensionRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
