...
@interface CKDetailsController <UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, UIViewControllerPreviewingDelegate, CKSharedAssetsControllerDelegate, CKDetailsAddGroupNameViewDelegate, FMFMapViewControllerDelegate, UITextViewDelegate, CKAttachmentCollectionManagerDelegate, CKAvatarPickerViewControllerDelegate, UIAlertViewDelegate, CKDetailsContactsManagerDelegate, CNAvatarViewDelegate, CKDetailsContactsTableViewCellDelegate, CKBusinessInfoViewDelegate, UINavigationControllerDelegate>
{
    _Bool _fmfEnabled;
...
@property(retain, nonatomic) CKAttachmentCollectionManager *attachmentCollectionManager; // @synthesize attachmentCollectionManager=_attachmentCollectionManager;
...
@property(retain, nonatomic) UIViewController<CKSharedAssetsControllerProtocol> *currentSharedAssetsViewController; // @synthesize currentSharedAssetsViewController=_currentSharedAssetsViewController;
