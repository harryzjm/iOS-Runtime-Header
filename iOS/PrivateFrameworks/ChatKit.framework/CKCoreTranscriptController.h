...
@interface CKCoreTranscriptController <CKTranscriptModelDelegate, CKTranscriptCollectionViewDelegate, CKBalloonViewDelegate, UICollectionViewDelegate, CKCoreTranscriptControllerProtocol, CKSendAnimationManagerDelegate>
{
    _Bool _initialLoad;
