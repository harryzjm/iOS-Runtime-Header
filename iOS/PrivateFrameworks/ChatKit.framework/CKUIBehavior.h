...
@interface CKUIBehavior : NSObject
{
    ...
    struct CGSize _tuConversationBalloonScreenSharingImageViewSize;
    struct CGSize _tuConversationBalloonActivityImageViewSize;
}
...
- (id)aggregateAcknowledgmentTopName:(_Bool)arg1;
- (id)aggregateAcknowledgmentMiddleName:(_Bool)arg1;
- (id)aggregateAcknowledgmentStackName2:(_Bool)arg1;
- (id)aggregateAcknowledgmentStackName3:(_Bool)arg1;
- (id)aggregateAcknowledgmentBottomTopName:(_Bool)arg1;
- (id)aggregateAcknowledgmentBottomMiddleName:(_Bool)arg1;
- (id)aggregateAcknowledgmentTopBackgroundName:(_Bool)arg1;
- (id)aggregateAcknowledgmentStackBackgroundName2:(_Bool)arg1;
- (id)aggregateAcknowledgmentStackBackgroundName3:(_Bool)arg1;
...
- (struct CGSize)previewBalloonSizeThatFits:(struct CGSize)arg1;
...
- (id)imageNamed:(id)arg1 pointSize:(double)arg2 insets:(struct UIEdgeInsets)arg3 color:(id)arg4;
