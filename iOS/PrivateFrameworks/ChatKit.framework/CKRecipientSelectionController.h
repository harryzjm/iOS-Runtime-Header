...
@interface CKRecipientSelectionController <MFComposeRecipientTextViewDelegate, CKRecipientSearchListControllerDelegate, MFGroupDetailViewControllerDelegate, CNContactPickerDelegate>
{
