...
@interface CKChatController <CKMacToolbarItemProvider, CKMacRecipientsControllerDelegate, CKStickerDetailViewControllerDelegate, UIContextMenuInteractionDelegate, CKEffectPickerViewControllerDelegate, CKThrowAnimationManagerDelegate, CKSendAnimationManagerDelegate, CKSendAnimationBalloonProvider, UIInteractionProgressObserver, QLPreviewControllerConformingDelegate, QLPreviewControllerDelegate, CKReaderViewControllerDelegate, PKAddPassesViewControllerDelegate, UIViewControllerTransitioningDelegate, UIViewControllerPreviewingDelegate, UIViewControllerPreviewingDelegate_Private, CKVideoMessageRecordingViewControllerDelegate, CKActionMenuGestureRecognizerButtonDelegate, PHPhotoLibraryChangeObserver, CNContactPickerDelegate, CKNavigationBarTitleControllerDelegate, CKMessageEntryViewDelegate, CKTrimControllerDelegate, AFContextProvider, UIGestureRecognizerDelegate, CKChatInputControllerDelegate, CKFullScreenBalloonViewControllerDelegate, CKBrowserDragControllerTranscriptDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, SGSuggestionPresenterDelegate, CKDetailsControllerDelegate, _UIClickInteractionDelegate, CKUnexpectedlyLoggedOutNotificationViewDelegate, UIPopoverPresentationControllerDelegate, UIDragInteractionDelegate, UIDropInteractionDelegate, UITextDropDelegate, UITextPasteDelegate, CKExtensionConsumer, CKFunCameraViewControllerDelegate, ILClassificationUIExtensionHostViewControllerDelegate, CKNicknameBannerViewDelegate, CKOnboardingControllerDelegate, CKNicknameUpdatesViewControllerDelegate, CKInlineReplyInteractionDelegate, CKBannerUpdatesViewDelegate, CKDetailsContactsManagerDelegate, CKNavbarCanvasViewControllerDelegate, STLockoutViewControllerDelegate>
{
    ...
    id <CKExternalEntryViewHost> _externalEntryViewHost;
    ...
    NSString *_photoGridDataSourceManagerIdentifier;
...
@property(retain, nonatomic) CKMediaObjectAssetDataSourceManager *photoGridDataSourceManager; // @synthesize photoGridDataSourceManager=_photoGridDataSourceManager;
...
@property(copy, nonatomic) NSString *photoGridDataSourceManagerIdentifier; // @synthesize photoGridDataSourceManagerIdentifier=_photoGridDataSourceManagerIdentifier;
...
- (void)scrollToMessage:(id)arg1 atSpecificMessagePartIndex:(long long)arg2 highlight:(_Bool)arg3 withInlineReplyOverlay:(_Bool)arg4;
- (void)scrollToMessage:(id)arg1 highlight:(_Bool)arg2 withInlineReplyOverlay:(_Bool)arg3;
...
- (_Bool)contextMenuInteractionIsOutsideOfVisibleBalloonCells:(id)arg1;
...
- (id)_deleteMoreActionForChatItem:(id)arg1;
...
- (id)transcriptCollectionViewController:(id)arg1 accessoriesForContextMenuWithConfiguration:(id)arg2 layoutAnchor:(CDStruct_96a80611)arg3;
...
- (_Bool)__im_ff_isInterstellarEnabled;
- (_Bool)__im_ff_translationEnabled;
- (_Bool)__im_ff_newSuggestionsBannerEnabled;
- (_Bool)__im_ff_isExpanseEnabled;
- (void)addOrRemoveExternallyHostedEntryViewIfNeeded;
- (_Bool)shouldRemoveExternallyHostedEntryView;
- (_Bool)shouldInsertExternallyHostedEntryView;
...
- (void)photosGridFullScreenBalloonViewController:(id)arg1 sendMessageHighlight:(_Bool)arg2 forChatItem:(id)arg3;
- (_Bool)photosGridFullScreenBalloonViewControllerShouldShowHightlightButton:(id)arg1 forChatItem:(id)arg2;
- (struct CGRect)photosGridFullScreenBalloonViewControllerSafeAreaLayoutFrame:(id)arg1;
- (_Bool)photosGridFullScreenBalloonViewControllerShouldShowReplyButton:(id)arg1;
...
- (void)photosGridFullScreenBalloonViewController:(id)arg1 verticallyScrollTranscriptByAmount:(double)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)photosGridFullScreenBalloonViewController:(id)arg1 willDisappearWithSendAnimation:(_Bool)arg2;
- (void)photosGridFullScreenBalloonViewController:(id)arg1 didAppearAnimated:(_Bool)arg2;
- (void)photosGridFullScreenBalloonViewController:(id)arg1 willAppearAnimated:(_Bool)arg2;
- (struct CGRect)photosGridFullScreenBalloonViewController:(id)arg1 balloonFrameForChatItem:(id)arg2;
...
- (void)_gridViewNavigationControllerForChatItem:(id)arg1 assetReference:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (id)_gridViewNavigationControllerForMomentShare:(id)arg1 chatItem:(id)arg2 tapbackManager:(id)arg3;
- (void)_gridViewNavigationControllerForMomentShareURL:(id)arg1 chatItem:(id)arg2 tapbackManager:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)updatePhotoGridWithDatasource:(id)arg1;
