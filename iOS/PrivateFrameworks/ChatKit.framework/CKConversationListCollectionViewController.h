...
- (_Bool)isThreeColumnLayoutEnabled;
...
- (void)autoDonationConversationButtonTappedForConversationWithItemIdentifier:(id)arg1 setAutoDonation:(_Bool)arg2;
- (id)_autoDonateConversationActionForItemIdentifier:(id)arg1;
...
- (_Bool)cellAtIndexPath:(id)arg1 isVisibleInCollectionView:(id)arg2;
