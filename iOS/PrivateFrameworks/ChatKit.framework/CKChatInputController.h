...
#import <ChatKit/DDMoneyActionDelegate-Protocol.h>
...
@property(nonatomic, getter=isInJellyfishDemo) _Bool inJellyfishDemo; // @synthesize inJellyfishDemo=_inJellyfishDemo;
...
- (void)messageEntryViewDidSwipeForJellyfishDemo:(id)arg1;
...
- (void)_dismissCompactSwitcherOverKeyboard:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
