...
- (id)initWithVariant:(long long)arg1 desiredStyle:(long long)arg2 traitCollection:(id)arg3 slotIdentifier:(id)arg4 forResponseOnQueue:(id)arg5 withHandler:(CDUnknownBlockType)arg6;
