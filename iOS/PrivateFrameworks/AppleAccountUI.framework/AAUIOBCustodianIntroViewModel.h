...
#import <AppleAccountUI/AAOBBulletedWelcomeControllerModelProtocol-Protocol.h>
...
@interface AAUIOBCustodianIntroViewModel : AATrustedContactsCustodianSplashScreenModel <AAUIOBWelcomeControllerViewModelProtocol, AAOBBulletedWelcomeControllerModelProtocol>
{
    UIImage *_image;
    UIView *_contentView;
