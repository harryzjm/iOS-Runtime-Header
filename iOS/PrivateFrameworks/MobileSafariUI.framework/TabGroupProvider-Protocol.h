...
- (NSArray *)tabGroupsMenuElementsWithOptions:(unsigned long long)arg1 newTabGroupName:(NSString *)arg2 URL:(NSURL *)arg3 descendantCount:(long long)arg4 isMoveAction:(_Bool)arg5 actionHandler:(void (^)(WBTabGroup *))arg6;
...
- (UISwipeActionsConfiguration *)swipeActionsConfigurationForTabGroup:(WBTabGroup *)arg1;
