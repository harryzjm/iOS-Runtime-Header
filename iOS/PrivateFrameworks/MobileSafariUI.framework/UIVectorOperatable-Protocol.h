...
#import <MobileSafariUI/NSCopying-Protocol.h>
...
- (void)integrateWithVelocity:(id <UIVectorOperatable>)arg1 target:(id <UIVectorOperatable>)arg2 intermediateTarget:(id <UIVectorOperatable>)arg3 intermediateTargetVelocity:(id <UIVectorOperatable>)arg4 parameters:(CDStruct_026d43e4)arg5 state:(CDStruct_21a1f582)arg6 delta:(double)arg7;
