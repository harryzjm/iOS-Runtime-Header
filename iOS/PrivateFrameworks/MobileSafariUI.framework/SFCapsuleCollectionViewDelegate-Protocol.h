...
@class NSArray, SFCapsuleCollectionView, UIAction, UIToolbar;
...
- (double)capsuleCollectionViewDistanceToTopEdge:(SFCapsuleCollectionView *)arg1;
...
- (NSArray *)capsuleCollectionView:(SFCapsuleCollectionView *)arg1 rectsForTapToUnminimizeBarWithDefaultRects:(NSArray *)arg2;
