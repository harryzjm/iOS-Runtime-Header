...
#import <MobileSafariUI/BookmarkFavoritesViewControllerDelegate-Protocol.h>
...
- (id)_initWithBookmarksDelegate:(id)arg1 linkPreviewProvider:(id)arg2 topBookmark:(id)arg3 skipOffset:(unsigned int)arg4 showOnlyFavorites:(_Bool)arg5 activeCollection:(id)arg6 showOnlyActiveCollection:(_Bool)arg7;
- (id)initWithBookmarksDelegate:(id)arg1 linkPreviewProvider:(id)arg2 topBookmark:(id)arg3 skipOffset:(unsigned int)arg4;
- (id)initWithBookmarksDelegate:(id)arg1 linkPreviewProvider:(id)arg2 collection:(id)arg3;
