...
@class MRUAudioModuleController, MRUConversationDetectionController, MRUListeningModeController, MRUSpatialAudioController, MRUSpatialAudioMode, MRUSystemOutputDeviceRouteController, MRUSystemVolumeController, MRUVolumeNowPlayingInfo, NSArray, NSString;
...
- (void)audioModuleController:(MRUAudioModuleController *)arg1 conversationDetectionController:(MRUConversationDetectionController *)arg2 didChangeConversationDetectionEnabled:(_Bool)arg3;
- (void)audioModuleController:(MRUAudioModuleController *)arg1 conversationDetectionController:(MRUConversationDetectionController *)arg2 didChangeConversationDetectionSupported:(_Bool)arg3;
