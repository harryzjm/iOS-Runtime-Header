...
- (id)initWithName:(id)arg1 displayName:(id)arg2 userHandle:(id)arg3 relyingPartyIdentifier:(id)arg4;
- (id)initWithName:(id)arg1 displayName:(id)arg2 userHandle:(id)arg3;
- (id)initRegistrationChoiceWithOptions:(id)arg1;
- (id)_initAsRegistrationChoice:(_Bool)arg1 withName:(id)arg2 displayName:(id)arg3 userHandle:(id)arg4 relyingPartyIdentifier:(id)arg5;
