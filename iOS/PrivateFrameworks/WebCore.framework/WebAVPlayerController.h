...
{
    struct WeakPtr<WebCore::PlaybackSessionModel, WTF::DefaultWeakPtrImpl> _delegate;
    struct WeakPtr<WebCore::PlaybackSessionInterfaceAVKit, WTF::DefaultWeakPtrImpl> _playbackSessionInterface;
...
- (void)setRate:(double)arg1 fromJavaScript:(_Bool)arg2;
@property double rate;
- (void)setDefaultPlaybackRate:(double)arg1 fromJavaScript:(_Bool)arg2;
