...
+ (id)readTimedMetadataGroupAtTime:(CDStruct_1b6d18a9)arg1 fromTrack:(id)arg2 outputSettings:(id)arg3 videoComposition:(id)arg4 error:(out id *)arg5;
+ (struct __CVBuffer *)readVideoFrameAtTime:(CDStruct_1b6d18a9)arg1 fromAsset:(id)arg2 outputSettings:(id)arg3 videoComposition:(id)arg4 auxiliaryImageType:(long long)arg5 error:(out id *)arg6;
...
+ (_Bool)isAssetUnsupportedCorruptPortraitVideo:(id)arg1;
+ (_Bool)track:(id)arg1 hasSamplesForEachSampleInTrack:(id)arg2;
+ (_Bool)isAssetUnsupportedLegacyPortraitVideo:(id)arg1;
+ (id)metadataTrackWithPortraitVideoDataInAsset:(id)arg1;
+ (_Bool)metadataTrackContainsPortraitVideoData:(id)arg1;
...
+ (_Bool)metadataTrack:(id)arg1 containsIdentifiers:(id)arg2;
+ (_Bool)metadataTrack:(id)arg1 containsIdentifier:(id)arg2;
...
+ (id)defaultVideoSettingsForAVAssetReaderWithHDR:(_Bool)arg1 forAuxiliaryImageType:(long long)arg2;
