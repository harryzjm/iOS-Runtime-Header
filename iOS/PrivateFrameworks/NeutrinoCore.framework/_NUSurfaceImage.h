...
- (void)writeTextureRegion:(id)arg1 device:(id)arg2 withBlock:(CDUnknownBlockType)arg3;
- (void)readTextureRegion:(id)arg1 device:(id)arg2 withBlock:(CDUnknownBlockType)arg3;
