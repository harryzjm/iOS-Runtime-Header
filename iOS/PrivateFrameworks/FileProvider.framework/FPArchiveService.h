...
- (id)unarchiveItemAtURL:(id)arg1 passphrases:(id)arg2 addToKeychain:(_Bool)arg3 destinationFolderURL:(id)arg4 acceptedFormats:(unsigned long long)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (id)unarchiveItemAtURL:(id)arg1 passphrases:(id)arg2 destinationFolderURL:(id)arg3 acceptedFormats:(unsigned long long)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (id)archiveItemsWithURLs:(id)arg1 passphrase:(id)arg2 addToKeychain:(_Bool)arg3 compressionFormat:(unsigned long long)arg4 destinationFolderURL:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
