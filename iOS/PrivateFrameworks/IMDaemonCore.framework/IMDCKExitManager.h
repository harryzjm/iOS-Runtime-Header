...
- (void)submitCloudKitAnalyticWithDictionary:(id)arg1 operationGroupName:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)_submitCloudKitMetricWithOperationGroupName:(id)arg1 record:(id)arg2 ignoreZoneNotFoundError:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
