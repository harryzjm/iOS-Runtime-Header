...
- (void)_fetchAttachmentZoneRecords:(id)arg1 desiredKeys:(long long)arg2 ognSuffix:(id)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_downloadAttachmentAssetsWithActivity:(id)arg1 restoringAttachments:(_Bool)arg2 retryCount:(unsigned long long)arg3 numAttachmentsDownloaded:(unsigned long long)arg4 transfers:(id)arg5 completion:(CDUnknownBlockType)arg6;
