...
- (_Bool)updateSyncedSyndicationRanges:(id)arg1 forGUID:(id)arg2;
- (void)handleMessageUpdateConflictType:(id)arg1 serverRecord:(id)arg2 localRowID:(long long)arg3;
- (_Bool)handleMessageUpdate:(id)arg1;
...
- (id)_addChatsFromCacheMisses:(id)arg1 preferExistingChats:(_Bool)arg2;
- (id)_addChatFromCacheMiss:(id)arg1 preferExistingChat:(_Bool)arg2;
...
- (id)_newestGroupChatMatchingParticipants:(id)arg1 displayName:(id)arg2 strictDisplayNameMatching:(_Bool)arg3 serviceName:(id)arg4 toIdentifier:(id)arg5;
...
- (id)_legacyExistingLoadedChatsForIDs:(id)arg1 onService:(id)arg2 displayName:(id)arg3 groupID:(id)arg4 style:(unsigned char)arg5;
...
- (id)existingChatsFilteredUsingPredicate:(id)arg1 sortedUsingLastMessageDateAscending:(_Bool)arg2 olderThan:(id)arg3 limit:(unsigned long long)arg4;
- (id)existingChatsFilteredUsingPredicate:(id)arg1 sortedUsingLastMessageDateAscending:(_Bool)arg2 limit:(unsigned long long)arg3;
