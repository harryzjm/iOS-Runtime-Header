...
- (void)_processFetchRecordChangesCompleted:(id)arg1 completion:(CDUnknownBlockType)arg2 syncType:(long long)arg3;
- (void)_kickOffWriteIfNeededForSyncType:(long long)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_updateChatUsingCKRecord:(id)arg1 onRead:(_Bool)arg2 didSucceed:(_Bool)arg3;
