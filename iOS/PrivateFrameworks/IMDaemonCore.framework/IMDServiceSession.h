...
- (_Bool)_doesMessageBodyContainALink:(id)arg1;
- (_Bool)_shouldConfigureSyndicationRangesForMessage:(id)arg1 inChat:(id)arg2;
...
- (void)autoReplier:(id)arg1 sendDeliveredQuietlyReceiptForMessages:(id)arg2 forIncomingMessageFromIDSID:(id)arg3 inChat:(id)arg4 withWillSendToDestinationsHandler:(CDUnknownBlockType)arg5;
...
- (_Bool)didReceiveMessages:(id)arg1 forChat:(id)arg2 style:(unsigned char)arg3 account:(id)arg4 fromIDSID:(id)arg5;
- (_Bool)_isActivated;
...
- (void)sendDeliveredQuietlyReceiptForMessage:(id)arg1 forIncomingMessageFromIDSID:(id)arg2 toChatGuid:(id)arg3 identifier:(id)arg4 style:(unsigned char)arg5 withWillSendToDestinationsHandler:(CDUnknownBlockType)arg6;
