...
- (_Bool)_encodePolarBlur:(int)arg1 sourceTexture:(id)arg2 destinationTexture:(id)arg3 params:(const void *)arg4 length:(unsigned long long)arg5 commandBuffer:(id)arg6;
- (id)init;
