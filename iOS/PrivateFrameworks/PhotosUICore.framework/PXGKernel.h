...
+ (CDStruct_aa0b146f)gridSizeForThreadGroupSize:(CDStruct_aa0b146f)arg1 imageSize:(CDStruct_aa0b146f)arg2;
+ (CDStruct_aa0b146f)groupSizeForImageSize:(CDStruct_aa0b146f)arg1 pipelineState:(id)arg2;
