...
- (struct PXSimpleIndexPath)lastItemIndexPathForDataSourceIdentifier:(long long)arg1;
- (struct PXSimpleIndexPath)firstItemIndexPathForDataSourceIdentifier:(long long)arg1;
