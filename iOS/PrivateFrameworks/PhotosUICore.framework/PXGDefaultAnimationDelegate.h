...
+ (void)adjustGeometry:(inout CDStruct_4f725fed *)arg1 style:(inout CDStruct_76b550e2 *)arg2 info:(inout CDStruct_9d1ebe49 *)arg3 forTextSpriteAnimatingFromAttributes:(const CDStruct_366bba6a *)arg4 toAttributes:(const CDStruct_366bba6a *)arg5 inRootLayout:(id)arg6;
+ (id)sharedInstance;
