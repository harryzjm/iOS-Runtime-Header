...
- (id)firstAncestorWithWhere:(CDUnknownBlockType)arg1;
...
- (void)_pxswizzled_viewControllerTraitCollection_viewIsAppearing:(_Bool)arg1;
...
- (_Bool)px_isDescendantOfOrPresentedByViewController:(id)arg1;
...
- (_Bool)px_dismissViewControllerIfAllowedAnimated:(_Bool)arg1 forced:(_Bool)arg2;
...
- (void)_navigateToDestination:(id)arg1 options:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;
