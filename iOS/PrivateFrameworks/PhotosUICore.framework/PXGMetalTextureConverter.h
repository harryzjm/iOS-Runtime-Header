...
@class CIContext, NSString, PXGColorProgramLibrary, PXGImageTexture, PXGMetalTextureCache;
...
- (id)_createTextureFromCIImage:(id)arg1 source:(id)arg2 options:(CDStruct_6238c8e0)arg3;
- (id)_applyAdjustment:(id)arg1 toMetalTexture:(id)arg2 options:(CDStruct_6238c8e0)arg3;
...
- (id)init;
- (id)initWithDevice:(id)arg1 destinationColorspaceName:(unsigned long long)arg2 layoutQueue:(id)arg3;
