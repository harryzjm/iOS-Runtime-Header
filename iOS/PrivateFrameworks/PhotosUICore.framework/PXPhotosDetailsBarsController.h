...
@interface PXPhotosDetailsBarsController <PXPhotosDataSourceChangeObserver, PXChangeObserver, PXActionPerformerDelegate, UIPopoverPresentationControllerDelegate>
{
    struct {
