...
+ (id)sharedInstance;
- (void).cxx_destruct;
- (id)_avAssetWithLocalMediaURL:(id)arg1 entryPoint:(id)arg2 audioMix:(id *)arg3;
...
- (id)_localMediaURLForAsset:(id)arg1 createIntermediateDirectories:(_Bool)arg2 error:(id *)arg3;
