...
- (struct CGRect)anchorViewRectForController:(id)arg1;
...
- (void)_setAllPhotosContentFilterState:(id)arg1;
...
- (_Bool)_presentOneUpForAssetReference:(id)arg1 configurationHandler:(CDUnknownBlockType)arg2;
