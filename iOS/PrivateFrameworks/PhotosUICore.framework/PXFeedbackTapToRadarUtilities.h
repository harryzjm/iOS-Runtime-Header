...
+ (id)alertControllerWithInternalReleaseAgreementAndCompletion:(CDUnknownBlockType)arg1;
+ (id)alertControllerWithPrivacyTitle:(id)arg1 message:(id)arg2 completion:(CDUnknownBlockType)arg3;
