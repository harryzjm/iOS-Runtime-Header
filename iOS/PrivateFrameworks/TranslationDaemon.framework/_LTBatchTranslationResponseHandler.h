...
@class FTMutableBatchTranslationRequest, NSLocale, NSMutableDictionary, NSString, NSURL, NSUUID, _LTDSELFBatchLog, _LTTranslationParagraph;
...
@interface _LTBatchTranslationResponseHandler : NSObject
{
    ...
    _Bool _supportsGenderDisambiguation;
    FTMutableBatchTranslationRequest *_request;
    NSLocale *_toLocale;
    _LTDSELFBatchLog *_batchLog;
...
@property(retain, nonatomic) _LTDSELFBatchLog *batchLog; // @synthesize batchLog=_batchLog;
