...
@class HMBLocalZone, HMDCameraProfile, HMDCameraRecordingBulkSendSessionInitiator, HMDCameraRecordingBulkSendSessionReader, HMDCameraRecordingSession, HMDCameraRecordingSessionNotificationTrigger, HMDCameraRecordingSessionRetryContext, HMDCameraRecordingSessionTimelineManager, HMDCameraRecordingSettingsControl, HMDCameraSignificantEventServer, HMDHAPAccessory, HMDHome, HMDService, HMFPreferences, HMFTimer, NSDate, NSDictionary, NSObject, NSString;
