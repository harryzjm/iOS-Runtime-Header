...
+ (_Bool)recordMigrationFailureWithError:(id)arg1;
+ (id)unarchiveMigratorDict:(id)arg1;
+ (id)archiveMigratorDict:(id)arg1;
+ (id)prepareDictionary:(_Bool)arg1 attempt:(unsigned int)arg2 skipKeyRoll:(_Bool)arg3 forceFailForTesting:(_Bool)arg4 migrateFromTestDirectory:(_Bool)arg5 dryRun:(_Bool)arg6;
