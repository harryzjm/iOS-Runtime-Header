...
+ (_Bool)_titleComponentsAreInSameSupersetCity:(id)arg1 graph:(id)arg2 locationHelper:(id)arg3;
+ (id)_locationStringWithDistrictsFromTitleComponents:(id)arg1 momentNodes:(id)arg2 lineBreakBehavior:(unsigned long long)arg3 allowFamilyHome:(_Bool)arg4 locationHelper:(id)arg5;
...
+ (void)generateHighlightLocationTitleForTripWithMomentNodes:(id)arg1 lineBreakBehavior:(unsigned long long)arg2 locationHelper:(id)arg3 result:(CDUnknownBlockType)arg4;
+ (void)generateLocationTitleForTripWithMomentNodes:(id)arg1 locationHelper:(id)arg2 result:(CDUnknownBlockType)arg3;
+ (_Bool)_containsAmusementParkPOIFromMomentNodes:(id)arg1;
+ (void)generateLocationTitleWithOptions:(id)arg1 locationHelper:(id)arg2 result:(CDUnknownBlockType)arg3;
