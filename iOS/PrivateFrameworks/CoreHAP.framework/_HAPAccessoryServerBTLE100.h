...
+ (id)deserializeCharacteristicReadData:(id)arg1 characteristicFormat:(unsigned long long)arg2 supportsAdditionalAuthentication:(_Bool)arg3 error:(id *)arg4;
+ (id)serializeCharacteristicWriteValue:(id)arg1 characteristicFormat:(unsigned long long)arg2 supportsAdditionalAuthentication:(_Bool)arg3 authenticationData:(id)arg4 error:(id *)arg5;
- (void).cxx_destruct;
...
- (void)_handleDisconnectionWithCompletion:(CDUnknownBlockType)arg1;
