...
- (id)initWithSocketAddress:(const struct sockaddr *)arg1 withAccessoryName:(id)arg2 maxTransmitAttempts:(unsigned long long)arg3 initialACKTimeout:(double)arg4;
