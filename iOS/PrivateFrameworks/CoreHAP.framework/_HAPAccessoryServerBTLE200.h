...
- (_Bool)_shouldIgnoreRetryDiscoveryError:(id)arg1;
...
- (void)_notifyDelegatesOfConnectionState:(_Bool)arg1 withError:(id)arg2;
...
- (_Bool)_validateGeneratedBroadcastKey:(id)arg1;
...
- (void)handleDisconnectionWithError:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (_Bool)isReadyForOperation:(long long)arg1;
...
- (void)_disconnectWithDisconnectionError:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)evaluateConnectionStateForOperation:(long long)arg1 block:(CDUnknownBlockType)arg2;
...
- (void)_enqueueRequest:(id)arg1 shouldPrioritize:(_Bool)arg2;
...
- (void)_sendRequest:(id)arg1 shouldPrioritize:(_Bool)arg2 responseHandler:(CDUnknownBlockType)arg3;
...
- (void)_readPendingDiscoveredCharacteristicTypesWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)setHasBeenDiscovered:(_Bool)arg1;
