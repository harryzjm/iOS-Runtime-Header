...
+ (void)sparseVectorWithLength:(unsigned long long)arg1 numberOfNonZeroValues:(unsigned long long)arg2 isSparseIndexInt64:(_Bool)arg3 sparseIndices:(const void *)arg4 sparseValues:(const float *)arg5 toDenseValues:(float *)arg6 withLength:(unsigned long long)arg7;
+ (id)sparseVectorWithLength:(unsigned long long)arg1 numberOfNonZeroValues:(unsigned long long)arg2 block:(CDUnknownBlockType)arg3;
...
- (void)addEndId:(long long)arg1 paddingId:(long long)arg2 withMaxVectorLength:(unsigned long long)arg3;
