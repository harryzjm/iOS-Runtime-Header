...
+ (id)groupInteractionsContainingSearchStringInDisplayName:(id)arg1 excludingInteractionUUIDs:(id)arg2 account:(id)arg3 directions:(id)arg4 bundleIds:(id)arg5 startDate:(id)arg6 store:(id)arg7 fetchLimit:(unsigned long long)arg8 offset:(unsigned long long)arg9;
...
+ (id)interactionsMatchingAnyHandlesOrDomainIds:(id)arg1 account:(id)arg2 directions:(id)arg3 bundleIds:(id)arg4 store:(id)arg5 fetchLimit:(unsigned long long)arg6 singleRecipientOnly:(_Bool)arg7;
...
+ (id)interactionsFromStore:(id)arg1 startDate:(id)arg2 tillDate:(id)arg3 withMechanisms:(id)arg4 withAccount:(id)arg5 withBundleIds:(id)arg6 withTargetBundleIds:(id)arg7 withDirections:(id)arg8 withNsUserName:(id)arg9 singleRecipient:(_Bool)arg10 fetchLimit:(unsigned long long)arg11;
