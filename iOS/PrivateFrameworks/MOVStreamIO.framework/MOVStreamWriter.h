...
@interface MOVStreamWriter : NSObject <VideoEncoderInterfaceDelegate, MOVStreamWriterStateContext, MOVStreamWriterDeprecated, MOVStreamWriterDeprecationNominates>
{
    ...
    struct map<std::string, (anonymous namespace)::StreamRecordingData, std::less<std::string>, std::allocator<std::pair<const std::string, (anonymous namespace)::StreamRecordingData>>> m_streamDataMap;
    struct vector<std::string, std::allocator<std::string>> m_orderedStreamNames;
    struct map<std::string, (anonymous namespace)::MetadataRecordingData, std::less<std::string>, std::allocator<std::pair<const std::string, (anonymous namespace)::MetadataRecordingData>>> m_metadataDataMap;
    struct vector<std::string, std::allocator<std::string>> m_orderedMetadataStreamNames;
    struct map<std::string, std::map<std::string, (anonymous namespace)::MetadataRecordingData>, std::less<std::string>, std::allocator<std::pair<const std::string, std::map<std::string, (anonymous namespace)::MetadataRecordingData>>>> m_associatedMetadataDataMap;
    struct map<std::string, CMTime, std::less<std::string>, std::allocator<std::pair<const std::string, CMTime>>> m_lastPtsForStream;
...
- (void)asyncWriteAssociatedMetadata:(id)arg1 metadataKey:(basic_string_05660eb3)arg2 associatedStreamKey:(basic_string_05660eb3)arg3;
...
- (void)newSampleReady:(struct opaqueCMSampleBuffer *)arg1 metadata:(id)arg2 presentationTime:(CDStruct_1b6d18a9)arg3 streamKey:(basic_string_05660eb3)arg4 streamId:(id)arg5 isAudioSample:(_Bool)arg6;
...
- (_Bool)marksOutputTracksAsEnabledForStream:(basic_string_05660eb3)arg1;
- (int)attachmentSerializationModeForStream:(basic_string_05660eb3)arg1 withDefaultMode:(int)arg2;
...
- (id)getTrackMetadataForExactBytesPerRow:(id)arg1 fromMap:(void *)arg2;
...
- (int)attachmentSerializationModeForStream:(basic_string_05660eb3)arg1 withDefaultMode:(int)arg2 fromMap:(void *)arg3;
- (_Bool)marksOutputTracksAsEnabledForStream:(basic_string_05660eb3)arg1 fromMap:(void *)arg2;
...
- (_Bool)isReadyForMoreDataForStreamId:(id)arg1 fromMap:(void *)arg2;
