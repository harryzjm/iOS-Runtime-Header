...
@class NSArray, NSDate, NSDictionary, NSSet, NSString, NSURL, NSUUID, TUConversation, TUConversationActivity, TUConversationActivitySession, TUConversationLink, TUConversationMember;
...
- (void)requestScreenShareFromMember:(TUConversationMember *)arg1 conversation:(TUConversation *)arg2;
