...
@interface WBSHistoryServiceDatabase : NSObject <WBSSQLiteDatabaseDelegate, WBSHistoryServiceDatabaseProtocol>
{
    ...
    unordered_map_86398ced _temporaryIDToItem;
    unordered_map_86398ced _visitForTemporaryID;
...
- (unordered_map_86398ced)_recomputeLatestVisitsForItems:(const void *)arg1 error:(id *)arg2;
