...
@interface WBSCompletionQuery : NSObject <NSCopying>
{
    ...
    time_point_ee75d146 _timestamp;
    NSString *_searchSuggestionProviderIdentifier;
    duration_15f873c1 _searchSuggestionProviderLatency;
    duration_15f873c1 _parsecLatency;
...
- (id)_initWithQueryString:(id)arg1 queryID:(long long)arg2 timestamp:(time_point_ee75d146)arg3 indexInFeedbackArray:(unsigned long long)arg4 triggerEvent:(unsigned long long)arg5;
- (id)init;
