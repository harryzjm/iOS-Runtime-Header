...
@interface SBStatusBarStyleOverridesAssertionManager : NSObject <NSXPCListenerDelegate, SBAppStatusBarAssertionManagerObserver, SBStatusBarStyleOverridesAssertionServer, BSDescriptionProviding>
{
    ...
    unsigned long long _exclusiveStatusBarStyleOverrides;
...
- (void)_updateAppSceneSettingsForForegroundAppsAndPostAddedStyleOverrides:(unsigned long long)arg1 removedStyleOverrides:(unsigned long long)arg2;
- (void)_invalidateAssertionsWithIdentifiers:(id)arg1 forClientConnection:(id)arg2;
- (unsigned long long)_internalQueue_removeAssertionByStyleOverrides:(id)arg1;
- (unsigned long long)_internalQueue_addAssertionByStyleOverrides:(id)arg1;
...
- (_Bool)handleTapForStatusBarStyleOverride:(unsigned long long)arg1;
- (id)_internalQueue_coordinatorClientForConnection:(id)arg1;
- (id)_internalQueue_coordinatorClientForStyleOverrides:(unsigned long long)arg1;
