...
@interface SBMainStatusBarStateProvider <UIStatusBarStateObserver>
{
    ...
    _Bool _itemIsDisabled[44];
    _Bool _itemWasDisabled[44];
    NSCountedSet *_itemDisabledRequests[44];
...
- (void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const CDStruct_e9def42b *)arg2 withActions:(int)arg3;
