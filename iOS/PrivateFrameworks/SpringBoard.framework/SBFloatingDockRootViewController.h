...
@interface SBFloatingDockRootViewController : SBFTouchPassThroughViewController <SBFloatingDockViewControllerDelegate, UIGestureRecognizerDelegate, SBIconViewQuerying, SBIconLocationPresenting>
{
    ...
    _Bool _contentEligibleForAsynchronousRendering;
...
- (_Bool)isDefaultLibraryContainerViewControllerForegroundForFloatingDockViewController:(id)arg1;
- (id)libraryContainerViewControllerForFloatingDockViewController:(id)arg1;
- (_Bool)isFloatingDockViewControllerPresentedOverTransitioningSwitcherContent:(id)arg1;
- (_Bool)isFloatingDockViewControllerPresentedOverApplication:(id)arg1;
- (_Bool)isFloatingDockViewControllerPresentedOverTransitioningAppToAppContent:(id)arg1;
...
- (void)floatingDockViewController:(id)arg1 didCompleteTransitionWithLibraryToPresented:(_Bool)arg2;
- (void)floatingDockViewController:(id)arg1 willPerformTransitionWithLibraryToPresented:(_Bool)arg2;
...
- (void)setLibraryPodIconEnabled:(_Bool)arg1;
