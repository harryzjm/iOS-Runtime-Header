...
@interface SBElasticHUDSettings : PTSettings
{
    ...
    _Bool _requiresTickHapticMitigations;
    _Bool _rampTickHapticIntensity;
    _Bool _displayBrightnessKeyCommandsEnabled;
    _Bool _keyboardBrightnessKeyCommandsEnabled;
    ...
    unsigned long long _tickHapticSkipInterval;
}
