...
- (int)exponentialMovingAverageFilter:(id)arg1 inDisplacement:(id)arg2 inDisparityPrev:(id)arg3 inDisparity:(id)arg4 outDisparityFiltered:(id)arg5 updateCoefficient:disparityBias: /* Error: Ran out of types for this method. */;
