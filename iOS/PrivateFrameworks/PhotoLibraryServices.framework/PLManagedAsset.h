...
@class CLLocation, NSArray, NSData, NSDate, NSDictionary, NSError, NSManagedObject, NSManagedObjectID, NSNumber, NSObject, NSOrderedSet, NSSet, NSString, NSURL, PLAdditionalAssetAttributes, PLCloudFeedAssetsEntry, PLCloudMaster, PLFaceCrop, PLMoment, UIImage;
@protocol NSCopying, PLCloudSharedAlbumProtocol, PLPTPTransferableAdditionalAssetAttributes, PLPTPTransferableSidecarFile;

@interface PLManagedAsset <PLPTPTransferableAsset, PLSyncableAsset, UIActivityItemSource, PLMomentAssetData_Private, _PLImageLoadingAsset>
{
...
- (_Bool)_hasBecomeNonVisibleToMemoriesAndPersons:(id)arg1;
...
- (id)cplFullRecord;
- (id)_generateVideoResourcesFromURL:(id)arg1 withIdentifier:(id)arg2 forMaster:(_Bool)arg3;
- (id)_generatePosterFrameResourcesFromVideoURL:(id)arg1 withIdentifier:(id)arg2 forMaster:(_Bool)arg3;
- (id)_createJPEGResourcesFromFullSizePath:(id)arg1 withItemIdentifier:(id)arg2 forMaster:(_Bool)arg3 forResourceTypes:(id)arg4;
...
- (_Bool)needToAddVideoComplementResourceForMaster;
