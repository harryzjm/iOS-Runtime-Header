...
+ (id)_insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 mainFileMetadata:(id)arg3 savedAssetType:(short)arg4 bundleScope:(unsigned short)arg5 uuid:(id)arg6 replacementUUID:(id)arg7 imageSource:(struct CGImageSource **)arg8 imageData:(id *)arg9 isPlaceholder:(_Bool)arg10 deleteFileOnFailure:(_Bool)arg11;
...
+ (id)insertAssetIntoPhotoLibrary:(id)arg1 mainFileURL:(id)arg2 mainFileMetadata:(id)arg3 savedAssetType:(short)arg4 bundleScope:(unsigned short)arg5 uuid:(id)arg6 replacementUUID:(id)arg7 imageSource:(struct CGImageSource **)arg8 imageData:(id *)arg9 isPlaceholder:(_Bool)arg10 deleteFileOnFailure:(_Bool)arg11;
...
+ (unsigned long long)totalSizeOfUnpushedOriginalsInPhotoLibrary:(id)arg1 outMasterList:(id)arg2 isInitialUpload:(_Bool)arg3;
...
+ (_Bool)createAssetResourcesForPlaceholderAsset:(id)arg1 withSourceAsset:(id)arg2 shouldBakeInAdjustments:(_Bool)arg3 shouldFlattenLivePhoto:(_Bool)arg4 placeholderResourceURLToSourceResourceURLMap:(id)arg5 photoLibrary:(id)arg6;
+ (_Bool)createMasterForPlaceholderAsset:(id)arg1 withSourceAsset:(id)arg2 shouldBakeInAdjustments:(_Bool)arg3 shouldFlattenLivePhoto:(_Bool)arg4 placeholderResourceURLToSourceResourceURLMap:(id)arg5 photoLibrary:(id)arg6;
+ (_Bool)createMomentShareAssetsForMomentShare:(id)arg1 batchedSourceAssetsToCopy:(id)arg2 creationRequestSourceAssetsCMMAssetsMap:(id)arg3 adjustmentBakeInOptionsDictionary:(id)arg4 metadataCopyOptionsDictionary:(id)arg5 keySourceAssetIdentifier:(id)arg6 clientConnection:(id)arg7 library:(id)arg8 error:(id *)arg9;
...
+ (_Bool)shouldPerformServerCopyWithSourceAsset:(id)arg1 copyingFromMomentShare:(_Bool)arg2 photoLibrary:(id)arg3;
+ (_Bool)shouldPerformServerCopyOnPlaceholderAsset:(id)arg1 photoLibrary:(id)arg2;
+ (void)performTransactionOnSyndicationLibraryWithSyndicationIdentifier:(id)arg1 block:(CDUnknownBlockType)arg2;
...
+ (id)predicateForSyndicatedAssetIdentifiers:(id)arg1 includeRejected:(_Bool)arg2;
...
+ (id)_syndicationAssetForSearchableItem:(id)arg1 inLibrary:(id)arg2 createIfNeeded:(_Bool)arg3 didCreate:(_Bool *)arg4 error:(id *)arg5;
...
+ (id)fetchResourcesForAssetWithObjectID:(id)arg1 inContext:(id)arg2 versions:(id)arg3 includeVirtualResources:(_Bool)arg4 allowDerivatives:(_Bool)arg5 excludeDynamicCPLResources:(_Bool)arg6 additionalPredicate:(id)arg7 relationshipKeyPathsForPrefetching:(id)arg8 error:(id *)arg9;
+ (void)enumerateImageRequestHintData:(id)arg1 assetWidth:(long long)arg2 assetHeight:(long long)arg3 libraryID:(id)arg4 startingOffset:(long long)arg5 assetID:(id)arg6 block:(CDUnknownBlockType)arg7;
...
- (_Bool)_hasScreenshotMetadataWithMetadata:(id)arg1;
...
- (_Bool)updateExtendedAttributesWithError:(id *)arg1;
- (id)extendedAttributesCreateIfNeeded:(_Bool)arg1;
...
- (_Bool)updatePlaybackVariationAndStyleFromOriginalMetadata:(id)arg1;
...
- (_Bool)setTimeExifTimestampStringFromMetadata:(id)arg1;
- (_Bool)setCameraCaptureDeviceFromMetadata:(id)arg1;
- (_Bool)_setHDRTypeFromMetadata:(id)arg1;
...
- (_Bool)setAttributesFromMainFileURL:(id)arg1 mainFileMetadata:(id)arg2 savedAssetType:(short)arg3 bundleScope:(unsigned short)arg4 isPlaceholder:(_Bool)arg5 placeholderFileURL:(id)arg6 imageSource:(struct CGImageSource **)arg7 imageData:(id *)arg8;
...
- (_Bool)_updateKindSubtypeIfScreenshotWithCheckTask:(CDUnknownBlockType)arg1;
- (_Bool)updateKindSubtypeIfScreenshotWithMetadata:(id)arg1;
...
- (void)_appendSceneClassificationsToAsset:(id)arg1 sceneTaxonomy:(id)arg2;
...
- (void)getSearchIndexContents:(id)arg1 graphData:(id)arg2 dateFormatter:(id)arg3 keywords:(id)arg4 synonymsDictionaries:(id)arg5 sceneTaxonomy:(id)arg6 filename:(id)arg7;
...
- (void)_removeLocalFileForResource:(id)arg1 allowDCIMPath:(_Bool)arg2;
...
- (id)sidecarFileMatchingContentType:(id)arg1 requireExactMatch:(_Bool)arg2 requireSort:(_Bool)arg3;
...
- (unsigned long long)masterResourceTypeForAdjustedAssetResourceType:(unsigned long long)arg1 flattenLivePhoto:(_Bool)arg2;
...
- (void)setWasGuestAsset:(_Bool)arg1;
- (void)purgeSyndicationResources;
- (_Bool)shouldPurgeSyndicationResourcesWithChangedValues:(id)arg1;
- (void)setConversationAlbumWithConversationID:(id)arg1;
- (void)_updateIMCoreSyndicationForIdentifier:(id)arg1 hide:(_Bool)arg2;
- (void)_updateSyndicationState:(unsigned short)arg1 enabled:(_Bool)arg2 logPrefix:(id)arg3;
...
- (void)_updateSyndicationStateWithSavedToLibrary:(_Bool)arg1;
- (void)updateMatchingAssetFromSyndicationLibraryWithSavedToLibrary:(_Bool)arg1;
...
- (_Bool)resetGuestAssetPromotion:(id *)arg1;
- (_Bool)promoteToGuestAsset:(id *)arg1;
- (id)syndicationOriginalVideoComplementResource;
- (id)syndicationOriginalResource;
- (id)syndicationResourceURLForResourceType:(unsigned int)arg1 version:(unsigned int)arg2 recipeID:(unsigned int)arg3 utiString:(id)arg4;
- (_Bool)becomeSyndicationLivePhotoWithVideoComplementContentType:(id)arg1;
