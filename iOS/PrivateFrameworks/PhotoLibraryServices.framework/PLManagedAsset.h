...
@interface PLManagedAsset <PLPTPTransferableAsset, PLSyncableAsset, PLValidatesResourceModel, PLCloudDeletable, PLMomentAssetData, _PLImageLoadingAsset, _PLThumbnailLoadingAsset, PLDeletableManagedObject, PLAssetDateDescriptor>
{
...
- (void)generateThumbnailsWithImageSource:(struct CGImageSource *)arg1 imageData:(id)arg2 metadata:(id)arg3 allowMediumPreview:(_Bool)arg4 forceSRGBConversion:(_Bool)arg5 outSmallThumbnail:(id *)arg6 outLargeThumbnail:(id *)arg7;
...
- (_Bool)resetBestKeyFrameTimeAndDeleteKeyFrameResource;
