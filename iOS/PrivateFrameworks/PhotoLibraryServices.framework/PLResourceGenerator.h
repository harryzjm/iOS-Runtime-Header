...
+ (id)expectedLocalResourceRecipesForAssetWithLibraryID:(id)arg1 versions:(id)arg2 assetHasAdjustments:(_Bool)arg3 assetIsRAWOrRawPlugJPEGWithRawOnTop:(_Bool)arg4 assetWidth:(long long)arg5 assetHeight:(long long)arg6 assetKind:(short)arg7 assetkindSubtype:(short)arg8 deferredProcessingNeeded:(unsigned short)arg9 videoDeferredProcessingNeeded:(unsigned short)arg10;
