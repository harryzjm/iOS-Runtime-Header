...
@interface CHRecognizer : NSObject <CHRecognizing>
{
    ...
    map_f81ed60d _cachedResults;
    map_0bf4b13c _characterIDMap;
}
...
- (set_f63680ae)_correctedDelayedStrokeIDs:(const void *)arg1 inDrawing:(id)arg2 segmentationPoints:(id)arg3 correctedSegmentationPoints:(id *)arg4;
...
- (id)_tokenizedTextResultFromTextDecodingResult:(id)arg1 options:(id)arg2 strokeEndings:(vector_5c2ed87a)arg3 drawing:(id)arg4;
...
- (basic_string_05660eb3)_stringForCode:(unsigned int)arg1;
- (void)_addEdgesFromCandidates:(vector_c76aa67f)arg1 toEdges:(void *)arg2 referenceEdge:(const void *)arg3 network:(void *)arg4 consumedSegmentCount:(long long)arg5 delayedSegmentIDs:(vector_5c2ed87a)arg6 numSubstrokes:(long long)arg7;
- (double)_candidateLatticePruningThresholdForEdgeType:(_Bool)arg1;
- (struct CGRect)_computeLocalFrameWithLeftBounds:(struct CGRect)arg1 rightBounds:(struct CGRect)arg2 delayedStrokeDrawingsLocalBounds:(void *)arg3 delayedStrokeDrawings:(id)arg4;
- (struct Network)_candidateNetworkFromSegmentationNetwork:(void *)arg1 segmentGroup:(id)arg2 drawing:(id)arg3 boundsAtNode:(void *)arg4 matchingStrokeRange:(struct _NSRange)arg5 sortedSegmentIndexes:(vector_5c2ed87a)arg6 shouldCancel:(CDUnknownBlockType)arg7;
- (long long)_classifyEdgeDrawingsFromContexts:(id)arg1 allEdges:(void *)arg2 segmentationNetwork:(void *)arg3 candidateNetwork:(void *)arg4 cachedEdgeSet:(void *)arg5 completeDrawing:(id)arg6 allowSmallerFinalBatch:(_Bool)arg7 shouldCancel:(CDUnknownBlockType)arg8;
...
- (vector_5c2ed87a)_sortedIndexesForSegmentGroup:(id)arg1 drawing:(id)arg2;
...
- (id)tokenizedTextResultForRomanSingleWordLatticePaths:(const void *)arg1 history:(id)arg2 activeHistoryRange:(struct _NSRange)arg3 startNode:(long long)arg4 segmentGroup:(id)arg5;
...
- (id)tokenizedTextResultForRomanMultiWordsLatticePaths:(const void *)arg1 maximumResultCount:(unsigned long long)arg2 history:(id)arg3 activeHistoryRange:(struct _NSRange)arg4 startNode:(long long)arg5 segmentGroup:(id)arg6 precedingSpaceBehavior:(long long)arg7;
- (id)tokenizedTextResultForRomanNoSpaceLatticePaths:(const void *)arg1 maximumResultCount:(unsigned long long)arg2 activeHistoryRange:(struct _NSRange)arg3 precedingSpaceBehavior:(long long)arg4 totalStrokeCount:(long long)arg5 totalSubstrokeCount:(long long)arg6;
- (id)tokenizedTextResultForRomanLatticePaths:(const void *)arg1 history:(id)arg2 activeHistoryRange:(struct _NSRange)arg3 isMultiWordsPath:(_Bool)arg4 isNoSpacePath:(_Bool)arg5 maximumPathCount:(unsigned long long)arg6 startNode:(long long)arg7 segmentGroup:(id)arg8 precedingSpaceBehavior:(long long)arg9 totalStrokeCount:(long long)arg10 totalSubstrokeCount:(long long)arg11;
...
- (vector_ce83c556)completionsForCandidate:(id)arg1 candidateContext:(id)arg2 prefix:(id)arg3 option:(unsigned long long)arg4;
- (vector_ce83c556)completionsForCandidate:(id)arg1 prefix:(id)arg2 option:(unsigned long long)arg3;
- (void)candidateAccepted:(void *)arg1;
- (void)candidatesCleared;
- (void)_updateLanguageModel:(void *)arg1;
