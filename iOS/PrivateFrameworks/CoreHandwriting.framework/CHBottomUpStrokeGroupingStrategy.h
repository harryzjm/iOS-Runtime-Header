...
+ (vector_f91331c9)_boundingBoxesOfStrokesInGroup:(id)arg1 rotatedAroundPoint:(struct CGPoint)arg2 byAngle:(double)arg3;
...
- (double)_strokeGroupConfidenceForSortedSubstrokes:(id)arg1 writingDirectionSortedStrokeIdentifiers:(id)arg2 localStrokeWritingOrientations:(const void *)arg3 averageWritingOrientation:(struct CGVector)arg4 averageStrokeDeviation:(struct CGVector)arg5;
...
- (vector_48b48a27)flippedCenters:(const void *)arg1 ofSubstrokes:(id)arg2 maxStrokesGap:(long long)arg3 begnning:(_Bool)arg4;
...
- (struct CGRect)_normalizedBoundsForWritingDirectionSortedStrokes:(id)arg1 strokeWritingOrientations:(const void *)arg2 firstStrokeDeviation:(struct CGVector)arg3 originalDrawing:(id *)arg4 rotatedSortedStrokes:(void *)arg5;
