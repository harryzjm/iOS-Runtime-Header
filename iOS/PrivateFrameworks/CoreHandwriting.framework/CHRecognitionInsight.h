...
- (void)recordDelayedStrokeProbabilities:(const void *)arg1;
- (void)recordCharBoundaryProbabilities:(const void *)arg1;
- (void)recordSpaceProbabilities:(const void *)arg1;
