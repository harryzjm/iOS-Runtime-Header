...
@class NSDictionary, NSString, OFUIViewController, UIPanGestureRecognizer, UITapGestureRecognizer, _OFViewControllerTransitionContext;
@protocol OFPageViewControllerDataSource, OFPageViewControllerDelegate;

@interface OFPageViewController <UIGestureRecognizerDelegate>
{
