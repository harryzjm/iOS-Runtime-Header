...
@interface AVTResourceLocator : NSObject
{
    ...
    NSURL *_contactsWidgetResourcesURL;
...
- (id)pathForContactsWidgetResource:(id)arg1 ofType:(id)arg2 inDirectory:(id)arg3;
- (id)pathForContactsWidgetResource:(id)arg1 ofType:(id)arg2;
- (id)urlForContactsWidgetResourceAtPath:(id)arg1;
