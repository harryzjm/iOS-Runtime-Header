...
@interface SiriPresentationViewController : UIViewController <SASStateChangeListener, AFUISiriLanguageDelegate, AFUISiriViewControllerDelegate, AFUISiriViewControllerDataSource, AFUISiriSetupViewControllerDelegate, SiriPresentation>
{
    ...
    struct os_unfair_lock_s _presentationStateProcessingLock;
...
- (void)_punchout:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)openURL:(id)arg1 bundleId:(id)arg2 inPlace:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
...
- (void)_logDismissalToPowerLogWithReason:(unsigned long long)arg1;
...
- (_Bool)_shouldHandleNewRequestWithOptions:(id)arg1 currentRequest:(id)arg2;
- (_Bool)_shouldRequestPresentationForState:(long long)arg1 forNewRequest:(id)arg2 currentRequest:(id)arg3;
...
- (void)_updateAnnouncementRequestsPermittedWhilePresentationActive:(_Bool)arg1;
- (void)_requestPresentationWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;
