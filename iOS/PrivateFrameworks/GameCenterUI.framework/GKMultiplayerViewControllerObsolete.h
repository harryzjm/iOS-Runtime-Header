...
@interface GKMultiplayerViewControllerObsolete <GKDashboardMultiplayerPickerDelegateObsolete, GKMultiplayerCustomInviteMessageViewControllerDelegate, GKMultiplayerDataSourceDelegateObsolete>
{
    ...
    _TtC12GameCenterUI31GKMultiplayerFooterViewObsolete *_footerView;
    _TtC12GameCenterUI37GKMultiplayerButtonHeaderViewObsolete *_buttonHeaderView;
    GKDashboardMultiplayerPickerViewControllerObsolete *_playerPickerViewController;
