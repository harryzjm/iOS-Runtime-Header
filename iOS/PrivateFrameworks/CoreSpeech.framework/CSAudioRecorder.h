...
- (void)setMixWithOthersForStream:(unsigned long long)arg1;
- (void)setDuckOthersForStream:(unsigned long long)arg1;
...
- (_Bool)_startAudioStreamForAudioInjectionWithAVVCContext:(id)arg1;
