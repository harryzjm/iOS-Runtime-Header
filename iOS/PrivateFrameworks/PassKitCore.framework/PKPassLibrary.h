...
- (void)_getGroupsControllerSnapshotWithOptions:(id)arg1 synchronously:(_Bool)arg2 retries:(unsigned long long)arg3 handler:(CDUnknownBlockType)arg4;
...
- (id)backupMetadata;
- (void)configurePushProvisioningConfiguration:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)canAddSecureElementPassWithConfiguration:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)serviceProviderDataForSecureElementPass:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)setSortingState:(long long)arg1 forObjectWithUniqueID:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;
...
- (void)enableExpressForPassWithPassTypeIdentifier:(id)arg1 serialNumber:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)fetchAppletSubCredentialForPassTypeIdentifier:(id)arg1 serialNumber:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)fetchTransactionKeyForPassTypeIdentifier:(id)arg1 serialNumber:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)generateTransactionKeyWithReaderIdentifier:(id)arg1 readerPublicKey:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)replaceUnsignedPassAtURL:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (void)addUnsignedPassesAtURLs:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
- (void)addPassesContainer:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (void)containsPassWithPassTypeIdentifier:(id)arg1 serialNumber:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (_Bool)containsPass:(id)arg1;
- (void)getGroupsControllerSnapshotWithOptions:(id)arg1 synchronously:(_Bool)arg2 handler:(CDUnknownBlockType)arg3;
...
- (_Bool)hasSecureElementPassesOfType:(long long)arg1;
- (_Bool)isRemovingPassesOfType:(unsigned long long)arg1;
- (void)shouldHomePresentAddPassFlow:(CDUnknownBlockType)arg1;
