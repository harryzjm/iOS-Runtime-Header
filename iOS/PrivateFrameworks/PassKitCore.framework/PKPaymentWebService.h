...
- (void)_deviceDataIncludingMetadataFields:(unsigned long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (unsigned long long)serviceProviderAugmentSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (unsigned long long)serviceProviderNonceWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (unsigned long long)_performRewrapRequest:(id)arg1 serviceURL:(id)arg2 responseHandler:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;
- (unsigned long long)completeSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (unsigned long long)rewrapInAppPaymentWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (unsigned long long)augmentSessionWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (unsigned long long)_nonceWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (unsigned long long)inAppPaymentNonceWithRequest:(id)arg1 serviceURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (unsigned long long)retrieveMerchantTokensWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (unsigned long long)deleteForRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (unsigned long long)virtualCardSecurityCodeActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (unsigned long long)augmentedProductWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;
