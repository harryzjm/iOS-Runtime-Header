...
- (void)archivedTokenForDiscoveryAnalyticsSubjectWithCompletion:(CDUnknownBlockType)arg1;
- (void)setArchivedTokenForDiscoveryAnalyticsSubject:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)removedAllDiscoveryItems;
- (void)completedDiscoveryItemCTAWithCompletion:(CDUnknownBlockType)arg1;
- (void)tappedDiscoveryItemWithIdentifier:(id)arg1 callToAction:(id)arg2 cardSize:(long long)arg3;
- (void)dismissedDiscoveryItemWithIdentifier:(id)arg1 callToActionIdentifier:(id)arg2 cardSize:(long long)arg3;
- (void)expandedDiscoveryItemWithIdentifier:(id)arg1 callToActionIdentifier:(id)arg2 afterSwipingToCard:(_Bool)arg3 multipleStoryCardsAvailable:(_Bool)arg4 cardSize:(long long)arg5;
- (void)displayedDiscoveryItemWithIdentifier:(id)arg1 isWelcomeCard:(_Bool)arg2 afterSwipingToCard:(_Bool)arg3 multipleStoryCardsAvailable:(_Bool)arg4;
- (void)displayedDiscoveryEngagementMessageWithIdentifier:(id)arg1;
- (void)discoveryLaunchedWithReferralSource:(unsigned long long)arg1 identifier:(id)arg2;
...
- (void)manifestAllowsMiniCardsWithCompletion:(CDUnknownBlockType)arg1;
