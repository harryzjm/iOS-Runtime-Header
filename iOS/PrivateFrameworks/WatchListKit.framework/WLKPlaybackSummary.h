...
- (_Bool)_compareOptionalTemporalValue:(id)arg1 with:(id)arg2 fuzzy:(_Bool)arg3;
...
- (_Bool)isEquivalentToSummaryExcludingTimestamp:(id)arg1;
- (_Bool)isEquivalentToSummaryExcludingCursor:(id)arg1;
