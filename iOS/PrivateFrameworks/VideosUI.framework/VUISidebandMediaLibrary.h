...
- (id)_tvSeriesForAdamID:(id)arg1 createIfNeeded:(_Bool)arg2 wasCreated:(_Bool *)arg3;
- (id)_tvSeriesForCanonicalID:(id)arg1 createIfNeeded:(_Bool)arg2 wasCreated:(_Bool *)arg3;
- (id)_tvSeasonForAdamID:(id)arg1 createIfNeeded:(_Bool)arg2 wasCreated:(_Bool *)arg3;
- (id)_tvSeasonForCanonicalID:(id)arg1 createIfNeeded:(_Bool)arg2 wasCreated:(_Bool *)arg3;
- (id)_tvEpisodeForAdamID:(id)arg1 createIfNeeded:(_Bool)arg2 wasCreated:(_Bool *)arg3;
- (id)_movieForAdamID:(id)arg1 createIfNeeded:(_Bool)arg2 wasCreated:(_Bool *)arg3;
...
- (id)videosWithExpiredDownloadsUsingMainThreadContext:(_Bool)arg1;
- (id)videosWithDownloadStates:(id)arg1 entitlementTypes:(id)arg2 useMainThreadContext:(_Bool)arg3;
- (id)videosWithDownloadState:(long long)arg1 entitlementTypes:(id)arg2 useMainThreadContext:(_Bool)arg3;
...
- (id)videoForAdamID:(id)arg1 useMainThreadContext:(_Bool)arg2;
