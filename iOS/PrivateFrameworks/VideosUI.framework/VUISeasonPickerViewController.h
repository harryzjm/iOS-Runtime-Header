...
@class NSArray, NSObject, NSString, VUILibraryFetchControllerViewController, VUISeasonPickerCollectionViewCell, _VUISeasonPickerView;
@protocol VUIMediaEntityIdentifier;

__attribute__((visibility("hidden")))
@interface VUISeasonPickerViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, VUIMediaEntitiesFetchControllerDelegate>
{
