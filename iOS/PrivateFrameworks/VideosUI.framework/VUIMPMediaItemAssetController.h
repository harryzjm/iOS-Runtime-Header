...
- (void)_onProcessingQueue_updateStateWithStatus:(unsigned long long)arg1 downloadState:(id)arg2 supportsPausing:(_Bool)arg3 supportsCancellation:(_Bool)arg4 notify:(_Bool)arg5;
