...
- (id)_transformBaseMessage:(id)arg1 mailboxScope:(id)arg2 duplicateInfo:(id)arg3 loaderBlock:(CDUnknownBlockType)arg4;
- (id)transformPersistedMessages:(id)arg1 mailboxScope:(id)arg2;
- (id)transformBaseMessage:(id)arg1 mailboxScope:(id)arg2 loaderBlock:(CDUnknownBlockType)arg3;
