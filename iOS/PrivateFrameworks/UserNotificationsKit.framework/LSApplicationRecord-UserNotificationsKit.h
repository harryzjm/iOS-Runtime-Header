...
+ (void)_unkit_enumerateRecordsWithOptions:(unsigned long long)arg1 block:(CDUnknownBlockType)arg2;
+ (id)unkit_applicationRecordIfEligibleToDeliverNotificationsForBundleIdentifier:(id)arg1;
+ (void)unkit_enumerateApplicationRecordsEligibleToDeliverNotifications:(CDUnknownBlockType)arg1;
