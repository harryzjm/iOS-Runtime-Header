...
@interface SearchUIResultTableViewController <SearchUITableHeaderViewDelegate, SKStoreProductViewControllerDelegatePrivate, _MKPlaceViewControllerFeedbackDelegate, UIGestureRecognizerDelegate>
{
    NSArray *_sections;
