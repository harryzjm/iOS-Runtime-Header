...
- (void)_sendCommand:(unsigned int)arg1 path:(id)arg2 options:(id)arg3 queue:(id)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)sendCommand:(unsigned int)arg1 withOptions:(id)arg2 toEndpoint:(id)arg3 toDestination:(id)arg4 completion:(CDUnknownBlockType)arg5;
