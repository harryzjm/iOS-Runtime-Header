...
- (void)addConclusion:(id)arg1 space:(id)arg2 type:(struct TSCH3DShaderType)arg3 format:(id)arg4 arguments:(char *)arg5;
...
- (void)addOutcome:(id)arg1 space:(id)arg2 type:(struct TSCH3DShaderType)arg3 format:(id)arg4 arguments:(char *)arg5;
...
- (void)addResolution:(id)arg1 space:(id)arg2 type:(struct TSCH3DShaderType)arg3 format:(id)arg4 arguments:(char *)arg5;
...
- (void)addStatement:(id)arg1 space:(id)arg2 type:(struct TSCH3DShaderType)arg3 format:(id)arg4 arguments:(char *)arg5;
...
- (void)addTemporary:(id)arg1 space:(id)arg2 type:(struct TSCH3DShaderType)arg3 format:(id)arg4 arguments:(char *)arg5;
...
- (void)addDeclaration:(id)arg1 space:(id)arg2 type:(struct TSCH3DShaderType)arg3 format:(id)arg4 arguments:(char *)arg5;
...
- (void)addToSection:(id)arg1 variable:(id)arg2 space:(id)arg3 type:(struct TSCH3DShaderType)arg4 format:(id)arg5 arguments:(char *)arg6;
