...
- (id)initWithAddress:(const void *)arg1 toIndex:(int)arg2;
- (id)initWithAddress:(const void *)arg1 toIndex:(int)arg2 objectCount:(int)arg3 objectCounterSpace:(int)arg4;
- (id)initWithAddress:(const void *)arg1 toIndex:(int)arg2 noop:(_Bool)arg3 objectCount:(int)arg4 objectCounterSpace:(int)arg5;
