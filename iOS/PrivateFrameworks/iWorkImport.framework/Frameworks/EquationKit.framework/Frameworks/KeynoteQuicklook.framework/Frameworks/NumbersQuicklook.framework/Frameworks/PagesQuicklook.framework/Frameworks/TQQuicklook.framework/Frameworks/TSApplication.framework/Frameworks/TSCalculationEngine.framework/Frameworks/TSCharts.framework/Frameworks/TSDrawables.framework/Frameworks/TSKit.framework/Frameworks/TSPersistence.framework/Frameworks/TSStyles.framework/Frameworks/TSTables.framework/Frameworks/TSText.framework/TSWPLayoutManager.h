...
@class NSString, TSWPCTTypesetterCache, TSWPDirtyRangeArray, TSWPMutableDirtyRangeArray, TSWPStorage, _TtC6TSText16TSWPTopicNumbers;
...
@interface TSWPLayoutManager : NSObject <TSWPStorageObserver, TSKChangeSourceObserver, TSWPStyleProviding>
{
    ...
    _TtC6TSText16TSWPTopicNumbers *_topicNumbers;
}
...
- (void).cxx_destruct;
@property(readonly, nonatomic) _TtC6TSText16TSWPTopicNumbers *topicNumbers; // @synthesize topicNumbers=_topicNumbers;
...
- (void)inflateTarget:(id)arg1 fromHints:(id)arg2 childHint:(id)arg3 anchoredDrawablePositions:(id)arg4 footnoteLayoutRange:(struct _NSRange)arg5;
- (void)deflateTarget:(id)arg1 intoHints:(inout id)arg2 childHints:(inout id)arg3 anchoredDrawablePositions:(id *)arg4 startingPartitionedAttachments:(out id *)arg5 topicNumberHints:(out id *)arg6 layoutState:(void *)arg7;
- (void *)layoutStateForLayoutWithHint:(id)arg1 firstTarget:(id)arg2;
- (void *)layoutStateForLayoutAfterHint:(id)arg1 firstTarget:(id)arg2 childHint:(id)arg3;
