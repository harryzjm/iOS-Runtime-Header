...
- (id)p_barResourceCacheItemAtIndex:(void *)arg1;
...
- (_Bool)beveledAtIndex:(void *)arg1;
- (void)setBeveledAtIndex:(void *)arg1;
- (void)setMaxValueForSeries:(long long)arg1 value:(float)arg2;
- (struct BarElementInfo *)elementInfoAtIndex:(void *)arg1;
- (struct BarElementInfo)barElementInfoAtIndex:(void *)arg1;
- (void)setElementInfo:(const struct BarElementInfo *)arg1 atIndex:(void *)arg2;
