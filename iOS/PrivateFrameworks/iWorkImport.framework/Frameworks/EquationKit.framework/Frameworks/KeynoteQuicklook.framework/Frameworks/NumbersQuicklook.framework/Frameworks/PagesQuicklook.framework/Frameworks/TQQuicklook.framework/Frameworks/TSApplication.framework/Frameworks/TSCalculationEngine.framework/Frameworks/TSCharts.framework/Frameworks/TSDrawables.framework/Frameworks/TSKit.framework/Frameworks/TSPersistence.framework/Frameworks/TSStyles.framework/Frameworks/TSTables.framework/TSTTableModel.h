...
+ (long long)dateGroupingTypeForMinMaxDatePair:(id)arg1;
...
- (void)setCellsConcurrently:(id)arg1 ignoreFormula:(_Bool)arg2 clearImportWarnings:(_Bool)arg3 formulaReplacer:(id)arg4;
...
- (int)getValue:(out struct TSCEValue *)arg1 atBaseCellCoord:(struct TSUModelCellCoord)arg2 fetchRichTextAttributesIfPlainText:(_Bool)arg3 skipPendingWrites:(_Bool)arg4;
...
- (int)insertRowsAtIndex:(struct TSUModelRowIndex)arg1 uids:(const void *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4 unsetFilterHidingAction:(_Bool)arg5;
- (int)insertColumnsAtIndex:(struct TSUModelColumnIndex)arg1 uids:(const void *)arg2 metadatas:(id)arg3 tableArea:(unsigned long long)arg4;
- (int)insertRowsInBaseRange:(struct _NSRange)arg1 uids:(const void *)arg2 metadata:(id)arg3 unsetFilterHidingAction:(_Bool)arg4;
...
- (id)defaultTextStyleForBaseCellCoord:(struct TSUModelCellCoord)arg1 useSoftDefault:(_Bool)arg2 outSource:(out unsigned long long *)arg3;
...
- (id)defaultCellStyleForBaseCellCoord:(struct TSUModelCellCoord)arg1 useSoftDefault:(_Bool)arg2 outSource:(out unsigned long long *)arg3;
...
- (unsigned char)cellValueTypeAtBaseCellCoord:(struct TSUModelCellCoord)arg1;
...
- (void)setIsRegisteredWithCalcEngine:(_Bool)arg1;
...
- (unsigned char)pivotDataCellValueTypeForColumn:(struct TSUModelColumnIndex)arg1;
- (void)copyPivotDetailDataFromSourceModel:(id)arg1 inSourceRegion:(id)arg2 columnMapping:(id)arg3 rowMapping:(id)arg4;
- (_Bool)hasUsefulPivotDataInSourceBodyTract:(id)arg1;
- (void)p_updateMergesAndCellsAsPivotDataWithSourceModel:(id)arg1 sourceRegion:(id)arg2 sourceBodyRegion:(id)arg3;
- (void)updateMergesAndCellsAsPivotDataWithSourceModel:(id)arg1;
- (void)resetForPivotingWithRowUids:(const void *)arg1 columnUids:(const void *)arg2 numberOfHeaderRows:(struct TSUModelRowIndex)arg3 numberOfHeaderColumns:(struct TSUModelColumnIndex)arg4;
- (void)p_upgradeDefaultCellStylesForStrokeSidecar;
- (void)dealloc;
- (id)initAsPivotDataWithContext:(id)arg1 tableInfo:(id)arg2 sourceModel:(id)arg3 sourceBody:(id)arg4 sourceHeader:(id)arg5;
...
- (id)initWithContext:(id)arg1 rowUids:(const void *)arg2 columnUids:(const void *)arg3 styles:(id)arg4 stylePreset:(id)arg5 tableInfo:(id)arg6;
...
- (id)mutableIndexesForUIDs:(const void *)arg1 isRows:(_Bool)arg2;
- (TSKUIDStructVectorTemplate_de88e035)UIDsForIndexes:(id)arg1 isRows:(_Bool)arg2;
...
- (TSKUIDStructVectorTemplate_de88e035)columnUIDs;
...
- (TSKUIDStructVectorTemplate_de88e035)rowUIDs;
...
- (int)linkToCalcEngine:(id)arg1 ownerKind:(unsigned short)arg2;
- (int)registerWithCalcEngine:(id)arg1 ownerKind:(unsigned short)arg2;
- (int)registerWithCalcEngine:(id)arg1 ownerKind:(unsigned short)arg2 linkOnly:(_Bool)arg3;
