...
- (void)notifyICloudTeardownObserversWithReason:(unsigned long long)arg1;
...
- (id)customFormatList;
- (void)enqueueTableIDRemappingCommandsForAddedDrawables:(id)arg1 andCallBlock:(CDUnknownBlockType)arg2;
