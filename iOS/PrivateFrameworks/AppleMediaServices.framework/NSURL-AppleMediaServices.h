...
- (id)ams_URLByReplacingQueryItems:(id)arg1 withEncodedParameters:(_Bool)arg2;
...
- (id)ams_URLByAppendingQueryItems:(id)arg1 preservingQueryEncoding:(_Bool)arg2;
- (id)ams_URLByAppendingQueryParameters:(id)arg1 preservingQueryEncoding:(_Bool)arg2;
