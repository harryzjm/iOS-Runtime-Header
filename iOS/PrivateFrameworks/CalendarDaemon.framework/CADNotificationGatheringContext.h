...
- (double)endDateOfLastOccurrenceInCacheForEvent:(void *)arg1 database:(struct CalDatabase *)arg2 cacheRange:(id *)arg3;
- (double)expirationTimestampForRecurrence:(void *)arg1 event:(void *)arg2 database:(struct CalDatabase *)arg3;
- (double)expirationTimestampForEvent:(void *)arg1 withInitialOccurrenceDate:(double)arg2 database:(struct CalDatabase *)arg3;
- (double)expirationTimestampForEvent:(void *)arg1 database:(struct CalDatabase *)arg2;
- (_Bool)isEventTimeSensitiveForFocus:(void *)arg1;
- (id)nearestProposedTimeForEvent:(void *)arg1;
- (_Bool)eventHasNewProposedTime:(void *)arg1;
- (_Bool)shouldSkipNotificationForCalendar:(void *)arg1;
- (_Bool)shouldSkipNotificationForStore:(void *)arg1;
