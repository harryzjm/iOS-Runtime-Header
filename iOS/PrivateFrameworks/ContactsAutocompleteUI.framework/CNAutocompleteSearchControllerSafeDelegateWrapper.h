...
+ (id)log;
- (void).cxx_destruct;
@property(retain, nonatomic) id <CNAutocompleteSearchControllerInternalDelegate> delegate; // @synthesize delegate=_delegate;
...
- (_Bool)searchController:(id)arg1 imageDataForRecipient:(id)arg2 imageUpdateBlock:(CDUnknownBlockType)arg3;
- (_Bool)searchController:(id)arg1 supplementalGroupsForSearchQuery:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)searchController:(id)arg1 textViewDidChangeSize:(struct CGSize)arg2;
- (void)searchController:(id)arg1 textViewWillChangeSize:(struct CGSize)arg2;
