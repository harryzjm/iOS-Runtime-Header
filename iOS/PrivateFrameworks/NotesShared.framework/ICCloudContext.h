...
- (void)fetchDatabaseChangesOperation:(id)arg1 finishedWithServerChangeToken:(id)arg2 accountID:(id)arg3 error:(id)arg4 completionHandler:(CDUnknownBlockType)arg5 context:(id)arg6;
...
- (void)handleCloudKitNotification:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)handleRemoteNotificationWithUserInfo:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_injestFetchedRecord:(id)arg1 forAccountID:(id)arg2 forceMerge:(_Bool)arg3 context:(id)arg4;
- (void)injestFetchedRecord:(id)arg1 forAccountID:(id)arg2 forceMerge:(_Bool)arg3 context:(id)arg4;
...
- (void)_syncWithReason:(id)arg1 uploadUnsyncedChanges:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
- (void)syncWithReason:(id)arg1 uploadUnsyncedChanges:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;
