...
@class SBAccessibilityDefaults, SBAnalyticsDefaults, SBAppIconForceTouchDefaults, SBAppSwitcherDefaults, SBApplicationDefaults, SBBiometricAuthenticationDefaults, SBBootDefaults, SBCameraHardwareButtonDefaults, SBDemoDefaults, SBFloatingDockDefaults, SBGestureDefaults, SBHardwareDefaults, SBHomeScreenDefaults, SBIconDefaults, SBIdleTimerDefaults, SBInCallPresentationDefaults, SBLockScreenDefaults, SBMiscellaneousDefaults, SBMultiUserDefaults, SBNotificationCenterDefaults, SBNotificationDefaults, SBPIPDefaults, SBPowerDefaults, SBRecentDisplayItemsDefaults, SBRotationDefaults, SBSOSDefaults, SBScreenshotDefaults, SBSecurityDefaults, SBSetupDefaults, SBSoftwareUpdateDefaults, SBSoundDefaults, SBStateDumpDefaults, SBStatusBarDefaults, SBSystemNotesDefaults, SBTestingDefaults, SBThermalDefaults, SBTraitsArbiterDefaults, SBUsageDefaults, SBVoiceControlDefaults, SBWallpaperDefaults, SBWorkspaceDefaults;
...
@interface SBLocalDefaults
{
    ...
    SBTraitsArbiterDefaults *_lazy_traitsArbiterDefaults;
    ...
    SBScreenshotDefaults *_lazy_screenshotDefaults;
    SBSystemNotesDefaults *_lazy_systemNotesDefaults;
}

- (void).cxx_destruct;
- (void)migrateAndRemoveOldDefaults;
@property(readonly, retain, nonatomic) SBSystemNotesDefaults *systemNotesDefaults;
@property(readonly, retain, nonatomic) SBScreenshotDefaults *screenshotDefaults;
