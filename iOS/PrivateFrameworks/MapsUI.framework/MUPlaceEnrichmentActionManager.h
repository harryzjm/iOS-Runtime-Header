...
@class MKMapItem, MUAMSResultProvider, MUPlaceActionManager, MUPlaceDataAvailability, MUPresentationOptions, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
@protocol MUExternalActionHandling, MUPlaceCallToActionSectionControllerDelegate, MUPlaceEnrichmentDataProvider, MUPlaceEnrichmentSectionAnalyticsDelegate;
...
- (id)initWithPlaceActionManager:(id)arg1 mapItem:(id)arg2 dataAvailability:(id)arg3 amsResultProvider:(id)arg4 callToActionDelegate:(id)arg5 externalActionHandler:(id)arg6 analyticsDelegate:(id)arg7 onActionUpdate:(CDUnknownBlockType)arg8;
