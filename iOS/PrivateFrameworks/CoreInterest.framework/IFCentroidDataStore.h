...
@interface IFCentroidDataStore <IFCentroidStoreInternal, IFCentroidStore>
{
}
...
- (void)_setCentroidFeature:(id)arg1 score:(double)arg2 inTransaction:(_Bool)arg3;
- (id)centroidWithScaling:(id)arg1;
- (id)centroid;
- (unsigned long long)_centroidLength;
- (void)enumerateStateWithBlock:(CDUnknownBlockType)arg1;
- (void)_addCentroidFeature:(id)arg1 score:(double)arg2 vectorIndex:(long long)arg3 inTransaction:(_Bool)arg4;
...
- (unsigned long long)_documentCountContainsFeatureLike:(id)arg1 inTransaction:(_Bool)arg2;
...
- (_Bool)_addFeatureVector:(id)arg1;
