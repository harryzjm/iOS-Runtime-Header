...
- (void)p_finishMetalRenderInContext:(struct CGContext *)arg1 orDirectly:(id)arg2 pathVertexData:(void *)arg3 parameterized:(_Bool)arg4 shouldReverseDrawOrder:(_Bool)arg5 withLayoutOptions:(id)arg6;
