...
- (void)storeDataForPruning:(shared_ptr_619761a4)arg1 prob:(float)arg2;
...
- (void)processBlobNoRotation:(const void *)arg1 tex:(id)arg2 doBGRA2RGBA:(_Bool)arg3;
...
- (shared_ptr_891d523c)boxBlobForScale:(int)arg1;
- (shared_ptr_891d523c)probBlobForScale:(int)arg1;
- (int)getNumScales;
- (void)retryLoadingCaffeNet:(void *)arg1 name:(id)arg2 weights:(id)arg3 context:(shared_ptr_ae8b808b)arg4 cp:(int)arg5;
