...
@interface OSACrashReport <OSAConcreteReport>
{
    unsigned int _task;
...
- (id)initWithTask:(unsigned int)arg1 exceptionType:(int)arg2 thread:(unsigned int)arg3 threadStateFlavor:(int)arg4 threadState:(unsigned int [1296])arg5 threadStateCount:(unsigned int)arg6;
