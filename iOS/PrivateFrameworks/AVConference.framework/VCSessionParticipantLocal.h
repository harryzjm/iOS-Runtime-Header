...
+ (_Bool)updateUplinkStreamsForPeerSubscribedStreams:(id)arg1 streamGroup:(id)arg2 uplinkBandwidthAllocator:(id)arg3;
+ (_Bool)updateBandwidthAllocator:(id)arg1 activeStream:(id)arg2 peerSubscribedStreams:(id)arg3 streamGroup:(id)arg4;
...
- (id)newStreamInfoWithAudioStreamWithConfiguration:(id)arg1 idsDestination:(id)arg2 isMultiway:(_Bool)arg3 streamGroupID:(unsigned int)arg4;
- (id)newVideoStreamWithConfig:(id)arg1 groupID:(unsigned int)arg2;
- (_Bool)shouldEnableUplinkRetransmissionForStreamGroupID:(unsigned int)arg1;
...
- (_Bool)isRemotePresentationLarge:(struct CGRect)arg1;
...
- (_Bool)setupOneToOneVideoStreamWithConfig:(id)arg1 streamGroupID:(unsigned int)arg2;
...
- (_Bool)initializeVideoCodecFeatureBitfieldForLocalConfig:(id)arg1;
- (id)featureListString:(id)arg1 removingPayload:(int)arg2 andPayload:(int)arg3;
- (_Bool)initializeOneToOneStreamGroup:(id)arg1 forLocalConfig:(id)arg2;
...
- (id)newStreamInfoWithAudioStreamWithConfiguration:(id)arg1 streamToken:(long long)arg2 isMultiway:(_Bool)arg3 streamGroupID:(unsigned int)arg4;
...
- (_Bool)isOneToOneStreamGroup:(unsigned int)arg1;
- (_Bool)remoteParticipantsSupportStreamGroupID:(unsigned int)arg1;
- (_Bool)wolfParticipantSupportsStreamGroupID:(unsigned int)arg1;
- (_Bool)webParticipantSupportsStreamGroupID:(unsigned int)arg1;
- (_Bool)nativeParticipantSupportsStreamGroupID:(unsigned int)arg1;
...
- (struct tagVCAudioIOConfiguration)audioIOConfigWithDeviceRole:(int)arg1 operatingMode:(int)arg2;
...
- (_Bool)reconfigureAudioIOForVideoEnabled:(_Bool)arg1 error:(id *)arg2;
