...
- (void)processRTCPPSFBStatistics:(struct tagVCStatisticsMessage)arg1;
...
- (void)reset;
- (void)checkForRedundancyFreeze:(struct tagVCStatisticsMessage)arg1;
- (void)stateFrozen:(struct tagVCStatisticsMessage)arg1;
- (void)stateRunning:(struct tagVCStatisticsMessage)arg1;
