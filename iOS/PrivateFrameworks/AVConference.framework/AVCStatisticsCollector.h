...
- (void)addMostBurstyLossInfo:(CDStruct_c0785916 *)arg1;
- (void)addRoundTripTimeInfo:(CDStruct_c0785916 *)arg1;
- (void)addActualBitrateInfo:(CDStruct_c0785916 *)arg1;
- (void)addPacketLossInfo:(CDStruct_c0785916 *)arg1;
- (void)computeOWRDEstimation:(CDStruct_c0785916 *)arg1;
- (void)computeBWEstimation:(CDStruct_c0785916 *)arg1;
- (void)updateLocalEstimatedBandwidthWithArrivalTime:(double)arg1;
- (void)updateLocalEstimatedBandwidth;
- (void)recordRemoteEstimatedBandwidthForLargeFrameInfo:(CDStruct_c0785916 *)arg1;
- (void)updateMaxLocalBurstyLoss:(unsigned int)arg1 isAudio:(_Bool)arg2;
- (void)updatePacketReceivedCount:(CDStruct_c0785916 *)arg1;
- (void)computeOtherStatistics:(CDStruct_c0785916 *)arg1;
- (void)addStatisticsHistory:(CDStruct_c0785916 *)arg1;
- (void)addEntriesFromStatistics:(CDStruct_c0785916)arg1;
- (void)updateStatisticChangeHandlerDictionaryCache;
- (void)processVCStatisticsInternal:(CDStruct_c0785916)arg1;
- (CDStruct_c0785916)getVCStatisticsWithType:(int)arg1 time:(double)arg2;
- (_Bool)shouldProcessAtTime:(double)arg1;
- (void)drainAndProcessVCStatistics:(CDStruct_c0785916)arg1;
