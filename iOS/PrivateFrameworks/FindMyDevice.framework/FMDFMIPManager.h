...
- (void)stopLocationMonitoringWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)startLocationMonitoringWithOptions:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)stopLocationMonitoringWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)startLocationMonitoringWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)clearOfflineFindingInfoWithCompletion:(CDUnknownBlockType)arg1;
- (void)fetchOfflineFindingInfoWithCompletion:(CDUnknownBlockType)arg1;
- (void)storeOfflineFindingInfo:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)activationLockInfoFromDeviceWithCompletion:(CDUnknownBlockType)arg1;
- (void)activationLockInfoWithCompletion:(CDUnknownBlockType)arg1;
...
- (void)pairingCheckWith:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)registerDeviceForPairingLock:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)getConnectedAccessoriesDiscoveryIds:(CDUnknownBlockType)arg1;
- (void)setPhoneNumber:(id)arg1 toAccessoryWithDiscoveryId:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removeAccessoryWithDiscoveryId:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)init;
- (void)clearMaskedAppleIDWithCompletion:(CDUnknownBlockType)arg1;
- (void)updateMaskedAppleIDWith:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)activationLockVersionWithCompletion:(CDUnknownBlockType)arg1;
- (void)removeNotificationWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;
