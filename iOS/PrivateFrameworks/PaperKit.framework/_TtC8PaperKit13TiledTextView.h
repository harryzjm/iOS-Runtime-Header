...
- (void)selectionInteraction:(id)arg1 renderPreviewForElements:(id)arg2 inContext:(struct CGContext *)arg3 withConfig:(id)arg4 inAttachment:(id)arg5;
...
- (void)selectionInteractionDidPaste:(id)arg1 inAttachment:(id)arg2;
- (id)selectionInteraction:(id)arg1 pasteboardRepresentationsForElements:(id)arg2 inAttachment:(id)arg3;
...
- (struct CGRect)selectionInteraction:(id)arg1 frameForElement:(id)arg2 inAttachment:(id)arg3;
