...
+ (void)buildLookupResultForPlaceWithPhotoCategories:(id)arg1 mapItemIdentifier:(id)arg2 originalRange:(struct _NSRange)arg3 completion:(CDUnknownBlockType)arg4;
+ (void)buildVendorLookupResultForPlaceWithCaptionedPhotos:(id)arg1 mapItemIdentifier:(id)arg2 originalRange:(struct _NSRange)arg3 completion:(CDUnknownBlockType)arg4;
- (void).cxx_destruct;
...
- (id)initWithPhotos:(id)arg1 totalPhotoCount:(unsigned long long)arg2 mapItemItemIdentifier:(id)arg3 originalRange:(struct _NSRange)arg4;
