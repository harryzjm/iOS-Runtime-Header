...
@interface VUIImageView : UIControl
{
    ...
    CDUnknownBlockType _shadowPathUpdater;
    ...
    struct _VUICornerRadii _shadowRadii;
}
...
- (void)setImageProxy:(id)arg1 clearingExisting:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
