...
- (_Bool)checkIfObjectIsStaticWithBoundingBox:(struct CGRect)arg1 motionDetection:(id)arg2 eventType:(Class)arg3;
...
- (_Bool)containsCornersOfRect:(struct CGRect)arg1 withInsetPercentage:(float)arg2;
