...
+ (struct CGRect)imposeMinSizeFor:(struct CGRect)arg1 withOriginalSize:(struct CGSize)arg2 minCrop:(struct CGSize)arg3;
...
+ (id)flattenedImageFromImage:(id)arg1 context:(id)arg2 error:(id *)arg3;
