...
- (_Bool)setNeedsHighPowerBudgeting:(_Bool)arg1 error:(id *)arg2;
...
- (_Bool)muteSessionInput:(_Bool)arg1 error:(id *)arg2;
...
- (_Bool)setSupportsMultichannelContent:(_Bool)arg1 error:(id *)arg2;
- (id)pickedRoute;
- (id)currentRoute;
...
- (_Bool)setHostProcessAttribution:(id)arg1 error:(id *)arg2;
...
- (_Bool)setIsExpanseMediaSession:(_Bool)arg1 error:(id *)arg2;
...
- (_Bool)setPrefersToAcquireHWControlFromOtherSessions:(_Bool)arg1 error:(id *)arg2;
