...
- (void)drawMarkedTextIndicatorAtPoint:(struct CGPoint)arg1 context:(struct CGContext *)arg2;
- (void)drawMarkedTextIndicatorAtPoint:(struct CGPoint)arg1 graphicsContext:(id)arg2;
- (void)_drawMarkedTextBackground:(id)arg1 inTextRange:(id)arg2 atOrigin:(struct CGPoint)arg3 graphicsContext:(id)arg4;
...
- (void)_enumerateTextAttachmentFramesInCharacterRange:(struct _NSRange)arg1 usingBlock:(CDUnknownBlockType)arg2;
- (void)drawAtPoint:(struct CGPoint)arg1 graphicsContext:(id)arg2;
- (void)_setColor:(id)arg1 inGraphicsContext:(id)arg2;
- (void)_setCurrentGraphicsContext:(id)arg1 duringBlock:(CDUnknownBlockType)arg2;
