...
+ (void)readFromData:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
+ (void)readFromURL:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
