...
- (id)initWithQueryID:(unsigned long long)arg1 applicationIdentifier:(id)arg2 uiScale:(double)arg3 location:(id)arg4 imageURL:(id)arg5 referralURL:(id)arg6 imageType:(long long)arg7 featureIdentifier:(id)arg8 preferredMetalDevice:(id)arg9;
