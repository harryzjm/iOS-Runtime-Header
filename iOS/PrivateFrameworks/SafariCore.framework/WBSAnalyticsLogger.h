...
- (void)didShowPasswordGenerationPromptWithPasswordAccepted:(_Bool)arg1;
...
- (void)didOpenNewTabWithURLWithTrigger:(long long)arg1 isExternalLink:(_Bool)arg2 tabCollectionViewType:(long long)arg3;
...
- (void)didDismissCompletionListWithItemAccepted:(_Bool)arg1 goKeyTapped:(_Bool)arg2 unifiedFieldContentType:(long long)arg3;
...
- (void)didDetectPossibleUserTrackingInHostApp:(id)arg1 urlHasIDFA:(_Bool)arg2 urlHasQueryString:(_Bool)arg3 userInteracted:(_Bool)arg4 viewControllerIsHidden:(_Bool)arg5;
...
- (void)reportOverlayStatusBarIsEnabled:(_Bool)arg1;
- (void)reportShowStandaloneTabBarPreference:(_Bool)arg1;
- (void)reportShowFullURLInSmartSearchFieldPreference:(_Bool)arg1;
...
- (void)reportCustomizationSyncEnablement:(_Bool)arg1;
- (void)reportStartPageBackgroundImageVisible:(_Bool)arg1;
- (void)reportStartPageSectionVisibility:(long long)arg1 visible:(_Bool)arg2;
- (void)didChangeStartPageSectionVisibility:(id)arg1 visible:(_Bool)arg2;
