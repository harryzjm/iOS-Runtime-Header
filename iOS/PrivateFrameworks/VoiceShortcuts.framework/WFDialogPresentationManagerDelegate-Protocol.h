...
@class NSArray, NSData, NSString, WFDialogPresentationManager, WFDialogRequest, WFDialogResponse, WFWorkflowReference, WFWorkflowRunningContext;
...
- (void)presentationManager:(WFDialogPresentationManager *)arg1 updateStateData:(NSData *)arg2 forAccessResourceWithIdentifier:(NSString *)arg3 context:(WFWorkflowRunningContext *)arg4 reference:(WFWorkflowReference *)arg5;
- (void)presentationManager:(WFDialogPresentationManager *)arg1 dismissPresentedContentWithCompletionHandler:(void (^)(void))arg2;
@end
