...
- (void)validateVettingToken:(id)arg1 vettingEmail:(id)arg2 vettingPhone:(id)arg3 container:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
...
- (void)iCloudAuthTokenWithContainer:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)iCloudAuthTokenWithContainer:(id)arg1 error:(id *)arg2;
- (void)renewiCloudAuthTokenWithReason:(id)arg1 shouldForce:(_Bool)arg2 container:(id)arg3 failedToken:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (id)_lockedCloudKitAuthTokenWithContainer:(id)arg1 error:(id *)arg2;
- (void)cloudKitAuthTokenWithContainer:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (id)cloudKitAuthTokenWithContainer:(id)arg1 error:(id *)arg2;
- (void)renewCloudKitAuthTokenWithReason:(id)arg1 shouldForce:(_Bool)arg2 container:(id)arg3 failedToken:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;
- (void)_lockedRenewTokenWithReason:(id)arg1 shouldForce:(_Bool)arg2 container:(id)arg3 tokenFetchBlock:(CDUnknownBlockType)arg4 completionHandler:(CDUnknownBlockType)arg5;
