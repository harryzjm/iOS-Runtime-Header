...
- (_Bool)isShelfSwitcherVisibleWithServerInstance:(id)arg1;
- (_Bool)isAppSwitcherPeekingWithServerInstance:(id)arg1;
...
- (_Bool)isStatusBarNativeFocusableWithServerInstance:(id)arg1 includingNonDismissableElements:(_Bool)arg2;
...
- (_Bool)isLongLookNotificationVisibleWithServerInstance:(id)arg1;
