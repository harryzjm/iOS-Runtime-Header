...
@class NSArray, NSString, RTBBDataProvider, RTDefaultsManager, RTGeoRouteStore, RTLearnedLocationManager, RTLocationStore, RTMapAccess, RTMetricManager, RTMotionActivityManager, RTPersistenceManager, RTPlatform, RTReachabilityManager;
