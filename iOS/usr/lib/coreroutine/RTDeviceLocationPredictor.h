...
@class NSArray, NSDate, NSMutableArray, NSObject, NSString, RTDataProtectionManager, RTDefaultsManager, RTEventManager, RTLearnedLocationManager, RTLocationManager, RTMapsSupportManager, RTMetricManager, RTNextPredictedLocationsOfInterestCache, RTPlatform, RTVehicleLocationProvider;
@protocol OS_dispatch_source;

@interface RTDeviceLocationPredictor <RTNextPredictedLocationsOfInterestCacheDelegate, RTPurgable>
{
