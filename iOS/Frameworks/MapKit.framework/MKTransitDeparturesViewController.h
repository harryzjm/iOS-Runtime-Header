...
@interface MKTransitDeparturesViewController <_MKTransitConnectionCellDelegate, MKTransitDeparturesCellDelegate, MKDynamicTransitUIContainer, MKStackingViewControllerPreferredSizeUse, _MKInfoCardChildViewControllerAnalyticsDelegate, MKModuleViewControllerProtocol>
{
