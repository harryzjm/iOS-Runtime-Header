...
@interface MKMapView : UIView <MKLocationManagerObserver, MKOverlayContainerViewDelegate, MKMapGestureControllerDelegate, UIGestureRecognizerDelegate, MKVariableDelayTapRecognizerDelegate, VKMapViewDelegate, VKMapViewCameraDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, GEOLogContextDelegate, MKRotationFilterDelegate, GEOConfigChangeListenerDelegate, GEOResourceManifestTileGroupObserver, MKAnnotationContainerViewDelegate, NSCoding>
{
    ...
    CDStruct_0b8f182b _cartographicConfiguration;
...
- (void)_setCartographicConfiguration:(CDStruct_0b8f182b)arg1 animated:(_Bool)arg2;
- (void)_setCartographicConfiguration:(CDStruct_0b8f182b)arg1 onInit:(_Bool)arg2 animated:(_Bool)arg3;
...
- (id)_initWithFrame:(struct CGRect)arg1 gestureRecognizerHostView:(id)arg2 showsAttribution:(_Bool)arg3 showsAppleLogo:(_Bool)arg4 allowsAntialiasing:(_Bool)arg5;
- (id)_commonInitFromIB:(_Bool)arg1 gestureRecognizerHostView:(id)arg2 locationManager:(id)arg3 showsAttribution:(_Bool)arg4 showsAppleLogo:(_Bool)arg5 allowsAntialiasing:(_Bool)arg6;
...
- (id)vk_mapLayer;
- (CDStruct_02837cd9)overlayContainerVisibleMapRect:(id)arg1;
...
- (_Bool)_shouldUpdateSelectedRouteFromRoutes:(id)arg1 selectedRouteIndex:(unsigned long long)arg2;
