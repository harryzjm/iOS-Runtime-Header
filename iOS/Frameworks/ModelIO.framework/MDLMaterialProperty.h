...
+ (CDStruct_14d5dc5e)_decodeMatrixPropertyWithCoder:(id)arg1 forKey:(id)arg2;
+ (MISSING_TYPE *)_decodeVectorWithCoder:(id)arg1 forKey:(id)arg2;
- (void).cxx_destruct;
...
- (void)_encodeVector:(id)arg1 withCoder:(id)arg2 forKey: /* Error: Ran out of types for this method. */;
