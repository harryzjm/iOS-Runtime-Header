...
- (double)minHeight;
- (void)didFinishUsing;
- (id)initWithContact:(id)arg1 frame:(struct CGRect)arg2 shouldAllowImageDrops:(_Bool)arg3 showingNavBar:(_Bool)arg4 monogramOnly:(_Bool)arg5 delegate:(id)arg6;
