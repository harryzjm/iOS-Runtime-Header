...
- (id)renderedLikenessesForContacts:(id)arg1 withBadges:(id)arg2 scope:(id)arg3 placeholder:(_Bool)arg4 workScheduler:(id)arg5;
...
- (id)renderAvatarsForContacts:(id)arg1 withBadges:(id)arg2 scope:(id)arg3 placeholder:(_Bool)arg4 workScheduler:(id)arg5 imageHandler:(CDUnknownBlockType)arg6;
- (id)avatarImageForContacts:(id)arg1 withBadges:(id)arg2 scope:(id)arg3;
- (id)avatarImageForContacts:(id)arg1 scope:(id)arg2;
- (id)renderAvatarsForContacts:(id)arg1 withBadges:(id)arg2 scope:(id)arg3 includePlaceholder:(_Bool)arg4 imageHandler:(CDUnknownBlockType)arg5;
- (id)renderAvatarsForContacts:(id)arg1 scope:(id)arg2 includePlaceholder:(_Bool)arg3 imageHandler:(CDUnknownBlockType)arg4;
- (id)renderAvatarsForContacts:(id)arg1 withBadges:(id)arg2 scope:(id)arg3 imageHandler:(CDUnknownBlockType)arg4;
