...
- (void)sessionManagerForContext:(id)arg1 clientType:(long long)arg2 completion:(CDUnknownBlockType)arg3;
- (id)sessionForContext:(id)arg1 clientType:(long long)arg2 error:(id *)arg3;
- (void)sessionForContext:(id)arg1 clientType:(long long)arg2 completion:(CDUnknownBlockType)arg3;
