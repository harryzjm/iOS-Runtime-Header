...
- (void)_quietlySetCanUseNetworkResourcesForLiveStreamingWhilePaused:(_Bool)arg1;
...
- (_Bool)_usesMinimalLatencyForVideoCompositionRendering;
- (void)_quietlySetUsesMinimalLatencyForVideoCompositionRendering:(_Bool)arg1;
...
- (void)_quietlySetReversesMoreVideoFramesInMemory:(_Bool)arg1;
- (_Bool)reversesMoreVideoFramesInMemory;
- (void)setBlendsVideoFrames:(_Bool)arg1;
- (void)_quietlySetBlendsVideoFrames:(_Bool)arg1;
