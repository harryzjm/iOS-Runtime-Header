...
+ (id)checkAvailabilityForPairedOwnerInformationControlPointMessages:(id)arg1 messageName:(basic_string_05660eb3)arg2;
...
- (void)fetchTxPowerFromDevice:(id)arg1 asOwner:(_Bool)arg2;
