...
- (void)dealloc;
- (id)init;
- (void)_countNonDefaultSessionSets:(CDUnknownBlockType)arg1;
...
- (void)_statisticsDatabaseColumnsForTable:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
- (void)_isRelationshipOnlyInDatabaseOnce:(id)arg1 thirdParty:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
