...
@interface WKWebView : UIView <UIScrollViewDelegate, UIResponderStandardEditActions>
{
    ...
    optional_34114161 _resolutionForShareSheetImmediateCompletionForTesting;
    ...
    struct unique_ptr<WebKit::ViewGestureController, std::default_delete<WebKit::ViewGestureController>> _gestureController;
    ...
    struct CGRect _animatedResizeOldBounds;
    ...
    optional_abdb4e36 _scrollOffsetToRestore;
    RectEdges_0629eaa8 _obscuredInsetsWhenSaved;
    optional_abdb4e36 _unobscuredCenterToRestore;
...
+ (_Bool)_willUpgradeToHTTPS:(id)arg1;
...
- (void)setCameraCaptureState:(long long)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)setMicrophoneCaptureState:(long long)arg1 completionHandler:(CDUnknownBlockType)arg2;
@property(readonly, nonatomic) long long microphoneCaptureState;
@property(readonly, nonatomic) long long cameraCaptureState;
- (void)requestMediaPlaybackStateWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)requestMediaPlaybackState:(CDUnknownBlockType)arg1;
- (void)setAllMediaPlaybackSuspended:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)suspendAllMediaPlayback:(CDUnknownBlockType)arg1;
- (void)resumeAllMediaPlayback:(CDUnknownBlockType)arg1;
- (void)pauseAllMediaPlaybackWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)pauseAllMediaPlayback:(CDUnknownBlockType)arg1;
- (void)closeAllMediaPresentationsWithCompletionHandler:(CDUnknownBlockType)arg1;
- (void)closeAllMediaPresentations:(CDUnknownBlockType)arg1;
...
- (void)_getPDFFirstPageSizeInFrame:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
...
@property(readonly, nonatomic) _Bool _needsSiteSpecificViewportQuirks;
...
- (void)_resumePage:(CDUnknownBlockType)arg1;
- (void)_suspendPage:(CDUnknownBlockType)arg1;
- (void)_didLoadNonAppInitiatedRequest:(CDUnknownBlockType)arg1;
- (void)_didLoadAppInitiatedRequest:(CDUnknownBlockType)arg1;
...
- (void)_addAppHighlightInNewGroup:(_Bool)arg1 originatedInApp:(_Bool)arg2;
...
- (id)_formDelegate;
- (void)_createMediaSessionCoordinatorForTesting:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_clearAppPrivacyReportTestingData:(CDUnknownBlockType)arg1;
- (void)_appPrivacyReportTestingData:(CDUnknownBlockType)arg1;
- (void)_lastNavigationWasAppInitiated:(CDUnknownBlockType)arg1;
- (void)_dismissContactPickerWithContacts:(id)arg1;
- (void)_didDismissContactPicker;
- (void)_didPresentContactPicker;
- (void)_didDismissContextMenu;
- (void)_didShowContextMenu;
- (void)_setPrivateClickMeasurementAttributionTokenSignatureURLForTesting:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_setPrivateClickMeasurementAttributionTokenPublicKeyURLForTesting:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)_setPrivateClickMeasurementAttributionReportURLsForTesting:(id)arg1 destinationURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (float)_adjustScrollRectToAvoidHighlightOverlay:(struct FloatRect)arg1;
...
- (void)_restorePageStateToUnobscuredCenter:(optional_abdb4e36)arg1 scale:(double)arg2;
- (void)_restorePageScrollPosition:(optional_abdb4e36)arg1 scrollOrigin:(struct FloatPoint)arg2 previousObscuredInset:(RectEdges_0629eaa8)arg3 scale:(double)arg4;
- (void)_couldNotRestorePageState;
- (void)_layerTreeCommitComplete;
- (void)_didCommitLayerTree:(const void *)arg1;
- (_Bool)_restoreScrollAndZoomStateForTransaction:(const void *)arg1;
...
- (void)_setHasCustomContentView:(_Bool)arg1 loadedMIMEType:(const void *)arg2;
...
- (void)_setUIEventAttributionForTesting:(id)arg1 withNonce:(id)arg2;
...
- (void)_didTapAtPoint:(struct CGPoint)arg1 withResult:(long long)arg2;
