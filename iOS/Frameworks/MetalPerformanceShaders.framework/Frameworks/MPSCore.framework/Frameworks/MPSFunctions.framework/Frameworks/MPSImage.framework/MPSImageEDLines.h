...
- (void)encodeToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceTexture:(id)arg3 destinationTexture:(id)arg4 endpointBuffer:(id)arg5 endpointOffset:(unsigned long long)arg6;
- (void)encodeInternalToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceTexture:(id)arg3 destinationTexture:(id)arg4 endpointBuffer:(id)arg5 endpointOffset:(unsigned long long)arg6 inputExtent:(CDStruct_1e3be3a8)arg7;
- (void)dealloc;
