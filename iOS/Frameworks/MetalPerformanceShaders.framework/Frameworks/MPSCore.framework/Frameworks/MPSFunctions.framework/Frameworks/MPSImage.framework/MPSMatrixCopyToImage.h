...
- (void)encodeBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceMatrix:(id)arg3 destinationImages:(id)arg4;
...
- (void)encodeToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceMatrix:(id)arg3 destinationImage:(id)arg4;
