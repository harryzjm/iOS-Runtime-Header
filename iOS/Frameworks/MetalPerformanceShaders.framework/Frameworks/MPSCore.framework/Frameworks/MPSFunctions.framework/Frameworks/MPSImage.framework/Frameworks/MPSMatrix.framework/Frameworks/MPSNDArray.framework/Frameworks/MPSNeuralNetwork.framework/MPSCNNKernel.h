...
- (void)encodeInternalBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImages:(id)arg3 inStates:(id)arg4 destinationImages:(id)arg5 clipRect:(CDStruct_1e3be3a8)arg6;
- (id)encodeBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImages:(id)arg3 destinationStates:(id *)arg4 destinationStateIsTemporary:(_Bool)arg5;
...
- (id)encodeBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImages:(id)arg3 sourceStates:(id)arg4 destinationStates:(id *)arg5 destinationStateIsTemporary:(_Bool)arg6;
...
- (void)encodeInternalToCommputeEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImage:(id)arg3 inState:(id)arg4 destinationImage:(id)arg5 subBatchIndex:(unsigned long long)arg6 batchSize:(unsigned long long)arg7 clipRect:(CDStruct_1e3be3a8)arg8 shouldHandleCompoundImageNatively:(_Bool)arg9;
...
- (id)encodeToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImage:(id)arg3 destinationState:(id *)arg4 destinationStateIsTemporary:(_Bool)arg5;
...
- (id)encodeToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImage:(id)arg3 sourceState:(id)arg4 destinationState:(id *)arg5 destinationStateIsTemporary:(_Bool)arg6;
