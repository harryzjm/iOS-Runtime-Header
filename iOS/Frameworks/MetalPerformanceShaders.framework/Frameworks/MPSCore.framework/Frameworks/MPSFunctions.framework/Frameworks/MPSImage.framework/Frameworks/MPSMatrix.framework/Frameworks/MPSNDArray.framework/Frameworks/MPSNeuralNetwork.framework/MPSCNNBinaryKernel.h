...
- (void)encodeInternalBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 primaryImages:(id)arg3 secondaryImages:(id)arg4 inStates:(id)arg5 destinationImages:(id)arg6 clipRect:(CDStruct_1e3be3a8)arg7;
...
- (id)encodeBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 primaryImages:(id)arg3 secondaryImages:(id)arg4 destinationStates:(id *)arg5 destinationStateIsTemporary:(_Bool)arg6;
...
- (void)encodeInternalToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 primaryImage:(id)arg3 secondaryImage:(id)arg4 inState:(id)arg5 destinationImage:(id)arg6 subBatchIndex:(unsigned long long)arg7 batchSize:(unsigned long long)arg8 clipRect:(CDStruct_1e3be3a8)arg9;
...
- (id)encodeToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 primaryImage:(id)arg3 secondaryImage:(id)arg4 destinationState:(id *)arg5 destinationStateIsTemporary:(_Bool)arg6;
