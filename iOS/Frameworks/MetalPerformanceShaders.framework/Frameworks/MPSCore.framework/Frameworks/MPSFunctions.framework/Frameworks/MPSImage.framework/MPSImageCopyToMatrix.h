...
- (void)encodeBatchToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImages:(id)arg3 destinationMatrix:(id)arg4;
...
- (void)encodeToCommandEncoder:(id)arg1 commandBuffer:(id)arg2 sourceImage:(id)arg3 destinationMatrix:(id)arg4;
