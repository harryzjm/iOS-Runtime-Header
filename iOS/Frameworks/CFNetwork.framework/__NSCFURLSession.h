...
@class ConnectionContextManager, NSDictionary, NSMutableDictionary, NSMutableSet, NSObject, NSString, NSURLSession, NSURLSessionConfiguration, NSUUID, __CFN_SessionMetrics;
@protocol OS_dispatch_queue;

@interface __NSCFURLSession <__NSURLSessionTaskGroupForConfiguration>
{
