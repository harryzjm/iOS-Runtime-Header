...
- (_Bool)_createLowResMaskFromLowResImage:(struct __CVBuffer *)arg1 outMaskPixelBuffer:(struct __CVBuffer **)arg2 outInstanceMaskPixelBuffer:(struct __CVBuffer **)arg3 outNumComponents:(unsigned long long *)arg4 outConfidenceScore:(float *)arg5 error:(id *)arg6;
- (_Bool)_filterUsingConnectedComponentsFromSegmentation:(CDStruct_0a65202a *)arg1 outInstanceMask:(struct __CVBuffer **)arg2 numComponents:(unsigned long long *)arg3;
