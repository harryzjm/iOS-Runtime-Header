...
+ (id)classifyImageWithDescriptors:(const void *)arg1 usingImageClassifier:(void *)arg2 andMinConfidenceForClassification:(float)arg3 outputDebugDictionary:(id)arg4 options:(id)arg5 metalContext:(id)arg6 error:(id *)arg7;
