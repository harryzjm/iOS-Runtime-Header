...
- (id <MTLBuffer>)newBufferForDataKind:(unsigned char)arg1 positionSource:(struct __C3DMeshSource *)arg2 normalSource:(struct __C3DMeshSource *)arg3 positionDataType:(short)arg4 normalDataType:(short)arg5 forStageInputOutputDescriptor:(_Bool)arg6 outStride:(unsigned long long *)arg7 outPositionOffset:(unsigned long long *)arg8 outNormalOffset:(unsigned long long *)arg9;
- (id <MTLBuffer>)newBufferForDataKind:(unsigned char)arg1 meshSource:(struct __C3DMeshSource *)arg2 dataType:(short)arg3 forStageInputOutputDescriptor:(_Bool)arg4 outStride:(unsigned long long *)arg5;
