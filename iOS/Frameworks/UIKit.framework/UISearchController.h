...
@class NSString, UISearchBar, UISystemInputViewController, UITapGestureRecognizer, UIView, UIViewController, _UINavigationControllerManagedSearchPalette, _UISearchControllerDidScrollDelegate;
