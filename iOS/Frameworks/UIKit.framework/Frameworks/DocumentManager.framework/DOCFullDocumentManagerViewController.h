...
@interface DOCFullDocumentManagerViewController <DOCSourceViewControllerDelegate, DOCDocumentBrowserDelegate, UISearchBarDelegate, UINavigationControllerDelegate>
{
