...
@class NSArray, NSString, UIAccessibilityHUDGestureManager, UIColor, UIView, _UIToolbarVisualProvider;
@protocol UIToolbarDelegate;

@interface UIToolbar <UIAccessibilityHUDGestureHosting, _UIBarPositioningInternal, UIGestureRecognizerDelegatePrivate, UIBarPositioning>
{
