...
@interface UIKeyboardCandidateInlineFloatingView <UIKeyboardCandidateList, UIKeyboardCandidateListDelegate, UIKeyboardCandidateGridCollectionViewControllerDelegate>
{
    _Bool _reducedWidth;
    int _position;
