...
@class NSDictionary, NSIndexSet, NSString, UIColor, UIImage, UIInputContextHistory, UITextInputTraits, UITextInteractionAssistant, UITextPosition, UITextRange, UIView;
