...
- (unsigned char)getGyroCalibrationDatabaseBiasFit:(CDStruct_1ec9dfc5 *)arg1 atTemperature:(float)arg2;
...
- (unsigned char)getLocationForBundleID:(struct __CFString *)arg1 orBundlePath:(struct __CFString *)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(CDStruct_7cf4616f *)arg5;
