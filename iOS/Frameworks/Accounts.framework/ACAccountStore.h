...
- (_Bool)triggerKeychainMigrationIfNecessary:(id *)arg1;
- (void)removeAccountFromPairedDevice:(id)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;
- (void)removeAccountFromPairedDevice:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
...
- (void)notifyRemoteDevicesOfUpdatedCredentials:(id)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)notifyRemoteDevicesOfModifiedAccount:(id)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)allAccountTypes;
- (id)allDataclasses;
- (void)accountsOnPairedDeviceWithAccountTypes:(id)arg1 withOptions:(id)arg2 completion:(CDUnknownBlockType)arg3;
