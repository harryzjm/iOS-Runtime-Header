...
- (void)connectWhbCBPeripheral:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)activateWhbCnxForCBPeripheral:(id)arg1 infoDict:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)retrieveConnectedPeripheralsWithServices:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)retrieveState;
- (void)retrievePeripheralsWithIdentifiers:(id)arg1 completion:(CDUnknownBlockType)arg2;
