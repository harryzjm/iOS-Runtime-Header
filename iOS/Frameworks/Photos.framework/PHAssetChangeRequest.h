...
@interface PHAssetChangeRequest <PHUpdateChangeRequest>
{
    ...
    _Bool _didSetSyndicationIdentifierOnMomentSharedAsset;
...
+ (_Bool)performBatchExpungeAndWaitWithAssets:(id)arg1 deleteOptions:(id)arg2 photoLibrary:(id)arg3 error:(id *)arg4;
+ (void)performBatchExpungeWithAssets:(id)arg1 deleteOptions:(id)arg2 photoLibrary:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;
