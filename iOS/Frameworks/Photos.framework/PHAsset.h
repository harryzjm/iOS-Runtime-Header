...
+ (id)_requestCuratedAssetInAssetCollection:(id)arg1 referenceAsset:(id)arg2 referencePersons:(id)arg3 fetchOptions:(id)arg4 onlyKey:(_Bool)arg5;
...
+ (id)fetchSyndicatedAssetsWithOptions:(id)arg1 includeRejected:(_Bool)arg2;
+ (id)fetchSyndicatedAssetsWithOptions:(id)arg1;
+ (id)fetchAssetsWithSyndicationIdentifiers:(id)arg1 options:(id)arg2 includeRejected:(_Bool)arg3;
