...
- (id)initWithDetails:(id)arg1 installIccid:(id)arg2 sourceIccid:(id)arg3 unusableIccid:(id)arg4 phoneNumber:(id)arg5 mcc:(id)arg6 mnc:(id)arg7 gid1:(id)arg8 gid2:(id)arg9 smdp:(id)arg10 useDS:(_Bool)arg11 esim:(_Bool)arg12;
