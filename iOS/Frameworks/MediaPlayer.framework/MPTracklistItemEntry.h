...
#import <MediaPlayer/MPTracklistEnumerationItem-Protocol.h>

@class NSMutableArray, NSString;

@interface MPTracklistItemEntry <MPTracklistEnumerationItem>
{
...
@property(nonatomic) __weak MPTracklistItemEntry *rootEntry; // @synthesize rootEntry=_rootEntry;
@property(readonly, nonatomic) NSString *itemIdentifier; // @synthesize itemIdentifier=_itemIdentifier;
- (void).cxx_destruct;
- (long long)_generationNumber;
- (id)newClonedEntry;
@property(readonly, nonatomic) MPTracklistItemEntry *latestUserClone;
